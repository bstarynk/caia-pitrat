...
{int V1=0,N=0,V2=0,V51=0,V49=0,V19=0,V6=0,V15=0,V5=0,V4=0,V7=0,V11=0,X=0,V43=0,I=0,V52=0,II=0,JJ=0,Q=0,NT=0,V61=0,V64=0,V68=0,V55=0,V54=0,V56=0,V59=0,V58=0,V72=0,V73=0,V74=0,V76=0,V77=0,V60=0,V81=0;
int Y,UR;
...
Y=pile[v[22]]; UR=pile[v[22]+1]; v[22]+=2; 
...
if((V61!=0)) goto l10;
if((V60<3)) goto l16;
l10:pile[v[22]]=27; pile[WZ1]=10635; pile[WZ2]=0; pile[WZ3]=jvj+3; 
(*f[291])( );     /*INTERP4(27,10635,0,jvj+3)*/
...
(*f[32])( );if(v[102]) goto l1;     /*FNDO0(268,jvj+1,jvj+2)*/
V51=x[jvj+2];
V49=V51;
goto l8;
