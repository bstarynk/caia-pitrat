...
(*f[1975])( );if(v[102]) goto l1;     /*FNDCND0(688,V,V3)*/
V3=pile[WZ2]; 
...
pile[v[22]]=jvj+6; pile[WZ1]=3938; pile[WZ2]=246; pile[WZ3]=jvj+7; 
(*f[189])( );     /*TRI4(jvj+6,3938,246,jvj+7)*/
pile[v[22]]=jvj+7; pile[WZ1]=20505; pile[WZ2]=218; pile[WZ3]=jvj+8; 
(*f[58])( );     /*TRI3(jvj+7,20505,218,jvj+8)*/
