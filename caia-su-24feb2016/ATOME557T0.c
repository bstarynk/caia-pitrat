...
(*f[1948])( );if(v[102]) goto l3;     /*FNDOND0(498,V,jvj+5)*/
...
(*f[1029])( );     /*DIFFAPP0(jvj+8,jvj+3,jvj+9)*/
...
pile[v[22]]=jvj+12; pile[WZ1]=3791; pile[WZ2]=246; pile[WZ3]=jvj+13; 
(*f[189])( );     /*TRI4(jvj+12,3791,246,jvj+13)*/
...
(*f[1753])( );     /*LIER1(jvj+10,489,V,jvj+8)*/
goto l2;
}
