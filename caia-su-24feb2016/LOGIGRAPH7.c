...
{int S=0,I=0,V7=0,V25=0,V5=0,SS=0,V10=0,V27=0,V8=0,V14=0,V30=0,V15=0,V31=0,V34=0,V16=0,V32=0,V21=0,V13=0,NK=0,MA=0,MB=0,V36=0,V35=0,NT=0,V23=0,V4=0,V3=0,N=0,V24=0,V38=0,K=0,V20=0,V18=0,V22=0,V19=0,V37=0;
int H,V,MV;
int NNNE;
...
l3:pile[v[22]]=S; pile[WZ1]=I; pile[WZ2]=(-1859); 
(*f[203])( );if(v[102]) goto l2;     /*FTAB0(S,I,(-1859),V7)*/
V7=pile[WZ3]; 
...
V31=V18-1;
V15=V31;
l12:pile[v[22]]=V21; pile[WZ1]=I; pile[WZ2]=(-1859); 
(*f[203])( );if(v[102]) goto l22;     /*FTAB0(V21,I,(-1859),V13)*/
V13=pile[WZ3]; 
NK=V13;
V16=incon;
if((K==V24)) goto l11;
...
MA++;
goto l14;
l6:pile[v[22]]=SS; pile[WZ1]=I; pile[WZ2]=(-1859); 
(*f[203])( );if(v[102]) goto l5;     /*FTAB0(SS,I,(-1859),V10)*/
V10=pile[WZ3]; 
...
l17:I++;
goto l16;
l18:pile[v[22]]=1; pile[WZ1]=I; pile[WZ2]=(-1859); 
(*f[203])( );if(v[102]) goto l17;     /*FTAB0(1,I,(-1859),V4)*/
V4=pile[WZ3]; 
if((V4<=0)) goto l17;
pile[v[22]]=I; pile[WZ1]=(-1859); 
(*f[3979])( );if(v[102]) goto l17;     /*LONGUEUR0(I,(-1859),V3)*/
V3=pile[WZ2]; 
N=V3;
V24=N-1;
V38=I*MV;
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-757); pile[WZ4]=jvj+25; 
(*f[270])( );     /*QUADRI7(100,21,140,(-757),jvj+25)*/
