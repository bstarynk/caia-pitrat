...
(*f[201])( );if(v[102]) goto l4;     /*FCOEFF0(J,(-630),V7)*/
V7=pile[WZ2]; 
x[jvj+2]=0 ;z[jvj+2]=0;
pile[WZ1]=(-8615); 
(*f[3979])( );if(v[102]) goto l6;     /*LONGUEUR0(J,(-8615),V5)*/
V5=pile[WZ2]; 
I=1;
l1:if((I>V5)) goto l6;
pile[v[22]]=I; pile[WZ1]=J; pile[WZ2]=(-8615); 
(*f[203])( );if(v[102]) goto l2;     /*FTAB0(I,J,(-8615),V6)*/
V6=pile[WZ3]; 
