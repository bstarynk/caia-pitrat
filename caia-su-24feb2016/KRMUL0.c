...
{int I=0,V19=0,V8=0,V7=0,J=0,V21=0,V12=0,V11=0,K=0,V23=0,V16=0,V15=0;
int NC;
int NNNE;
...
(*f[1006])( );if(v[102]) goto l2;     /*POWER0(V19,10,V8)*/
V8=pile[WZ2]; 
pile[v[22]]=I; pile[WZ1]=1; pile[WZ2]=(-598); 
(*f[202])( );if(v[102]) goto l2;     /*FMATRICE0(I,1,(-598),V7)*/
V7=pile[WZ3]; 
...
pile[WZ1]=89; pile[WZ2]=162; pile[WZ3]=V7; pile[WZ4]=jvj+18; 
(*f[272])( );     /*QUADRI9(100,89,162,V7,jvj+18)*/
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V8; pile[WZ4]=jvj+15; 
...
(*f[1006])( );if(v[102]) goto l5;     /*POWER0(V21,10,V12)*/
V12=pile[WZ2]; 
pile[v[22]]=J; pile[WZ1]=2; pile[WZ2]=(-598); 
(*f[202])( );if(v[102]) goto l5;     /*FMATRICE0(J,2,(-598),V11)*/
V11=pile[WZ3]; 
...
pile[WZ1]=89; pile[WZ2]=162; pile[WZ3]=V11; pile[WZ4]=jvj+24; 
(*f[272])( );     /*QUADRI9(100,89,162,V11,jvj+24)*/
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V12; pile[WZ4]=jvj+21; 
(*f[192])( );     /*QUADRI4(100,41,130,V12,jvj+21)*/
...
goto l4;
l9:V23=NC-K;
pile[v[22]]=V23; pile[WZ1]=10; 
(*f[1006])( );if(v[102]) goto l8;     /*POWER0(V23,10,V16)*/
V16=pile[WZ2]; 
pile[v[22]]=K; pile[WZ1]=3; pile[WZ2]=(-598); 
(*f[202])( );if(v[102]) goto l8;     /*FMATRICE0(K,3,(-598),V15)*/
V15=pile[WZ3]; 
...
pile[WZ1]=89; pile[WZ2]=162; pile[WZ3]=V15; pile[WZ4]=jvj+30; 
(*f[272])( );     /*QUADRI9(100,89,162,V15,jvj+30)*/
