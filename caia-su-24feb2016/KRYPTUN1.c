...
l3:if((K>=J)) goto l2;
pile[v[22]]=K; pile[WZ1]=I; pile[WZ2]=(-598); 
(*f[202])( );if(v[102]) goto l2;     /*FMATRICE0(K,I,(-598),V3)*/
V3=pile[WZ3]; 
if((V3!=42)) goto l7;
l2:K++;
l1:if((K<=NC)) goto l3;
...
pile[WZ1]=89; pile[WZ2]=162; pile[WZ3]=V2; pile[WZ4]=jvj+11; 
(*f[272])( );     /*QUADRI9(100,89,162,V2,jvj+11)*/
...
l6:J=1;
goto l5;
l8:pile[v[22]]=J; pile[WZ1]=I; pile[WZ2]=(-598); 
(*f[202])( );if(v[102]) goto l7;     /*FMATRICE0(J,I,(-598),V2)*/
V2=pile[WZ3]; 
if((V2==42)) goto l7;
K=1;
goto l1;
