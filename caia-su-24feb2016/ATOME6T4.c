...
(*f[26])( );if(v[102]) goto l6;     /*FNDC0(998,DY,L)*/
L=pile[WZ2]; 
x[jvj+7]=incon;
if((L==1)) goto l1;
if((L<2)) goto l6;
...
l7:pile[v[22]]=101; pile[WZ1]=DY; pile[WZ2]=110; pile[WZ3]=(-639); pile[WZ4]=jvj+12; 
(*f[270])( );     /*QUADRI7(101,DY,110,(-639),jvj+12)*/
...
pile[v[22]]=jvj+9; pile[WZ1]=3125; pile[WZ2]=246; pile[WZ3]=jvj+10; 
(*f[189])( );     /*TRI4(jvj+9,3125,246,jvj+10)*/
