...
HIST=pile[v[22]]; K=pile[v[22]+1]; v[22]+=2; 
WZ5=v[22]+5; WZ4=v[22]+4; WZ3=v[22]+3; WZ2=v[22]+2; WZ1=v[22]+1; 
pile[v[22]]=68; pile[WZ1]=158; pile[WZ2]=K; 
(*f[54])( );     /*TRI1(68,158,K)*/
x[jvj+23]=vo[14];z[jvj+23]=vz[14];
pile[v[22]]=1201; pile[WZ1]=jvj+23; pile[WZ2]=jvj+24; 
(*f[32])( );if(v[102]) goto l14;     /*FNDO0(1201,jvj+23,jvj+24)*/
if((x[jvj+24]==206)) goto l8;
l14:x[jvj+19]=vo[16];z[jvj+19]=vz[16];
pile[v[22]]=498; pile[WZ1]=jvj+19; pile[WZ2]=jvj+20; 
(*f[32])( );if(v[102]) goto l76;     /*FNDO0(498,jvj+19,jvj+20)*/
pile[v[22]]=509; pile[WZ1]=jvj+20; pile[WZ2]=jvj+21; 
(*f[33])( );     /*FNDE0(509,jvj+20,jvj+21)*/
if((x[jvj+21]!=0)) goto l76;
pile[v[22]]=477; pile[WZ2]=jvj+22; 
(*f[33])( );     /*FNDE0(477,jvj+20,jvj+22)*/
if((x[jvj+22]==0)) goto l8;
l76:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=2; return;
l3:x[jvj+3]=s[x[jvj+8]] ;z[jvj+3]=(x[jvj+3]<=sepcte) ? x[jvj+3] : z[jvj+8];
if((v[244]<=0)) goto l5;
pile[v[22]]=1348; pile[WZ1]=jvj+3; pile[WZ2]=jvj+6; 
(*f[32])( );if(v[102]) goto l5;     /*FNDO0(1348,jvj+3,jvj+6)*/
if((x[jvj+6]==68)) goto l4;
l5:pile[v[22]]=480; pile[WZ1]=jvj+3; pile[WZ2]=jvj+9; 
(*f[33])( );     /*FNDE0(480,jvj+3,jvj+9)*/
x[jvj+114]=x[jvj+9] ;z[jvj+114]=z[jvj+9];
l6:if((x[jvj+114]<=0)) goto l4;
x[jvj+4]=s[x[jvj+114]] ;z[jvj+4]=(x[jvj+4]<=sepcte) ? x[jvj+4] : z[jvj+114];
pile[v[22]]=489; pile[WZ1]=jvj+4; pile[WZ2]=jvj+10; 
(*f[33])( );     /*FNDE0(489,jvj+4,jvj+10)*/
for(i=x[jvj+10],V19=0;i>0;i=t[i],V19++)  ;
pile[v[22]]=473; pile[WZ1]=jvj+3; 
(*f[26])( );if(v[102]) goto l1;     /*FNDC0(473,jvj+3,V21)*/
V21=pile[WZ2]; 
if((V19<V21)) goto l76;
l1:pile[v[22]]=365; pile[WZ1]=jvj+4; pile[WZ2]=jvj+5; 
(*f[33])( );     /*FNDE0(365,jvj+4,jvj+5)*/
for(i=x[jvj+5],V22=0;i>0;i=t[i],V22++)  ;
if((V22>V19)) goto l76;
...
goto l41;
l8:x[jvj+15]=vo[16];z[jvj+15]=vz[16];
pile[v[22]]=454; pile[WZ1]=jvj+15; pile[WZ2]=jvj+16; 
(*f[33])( );     /*FNDE0(454,jvj+15,jvj+16)*/
...
goto l2;
l10:x[jvj+11]=s[x[jvj+16]] ;z[jvj+11]=(x[jvj+11]<=sepcte) ? x[jvj+11] : z[jvj+16];
if((v[244]<=0)) goto l12;
pile[v[22]]=1348; pile[WZ1]=jvj+11; pile[WZ2]=jvj+14; 
(*f[32])( );if(v[102]) goto l12;     /*FNDO0(1348,jvj+11,jvj+14)*/
if((x[jvj+14]==68)) goto l11;
l12:pile[v[22]]=481; pile[WZ1]=jvj+11; pile[WZ2]=jvj+17; 
(*f[33])( );     /*FNDE0(481,jvj+11,jvj+17)*/
x[jvj+115]=x[jvj+17] ;z[jvj+115]=z[jvj+17];
l13:if((x[jvj+115]<=0)) goto l11;
x[jvj+12]=s[x[jvj+115]] ;z[jvj+12]=(x[jvj+12]<=sepcte) ? x[jvj+12] : z[jvj+115];
pile[v[22]]=489; pile[WZ1]=jvj+12; pile[WZ2]=jvj+18; 
(*f[33])( );     /*FNDE0(489,jvj+12,jvj+18)*/
for(i=x[jvj+18],V28=0;i>0;i=t[i],V28++)  ;
pile[v[22]]=750; pile[WZ1]=jvj+11; 
(*f[26])( );if(v[102]) goto l7;     /*FNDC0(750,jvj+11,V30)*/
V30=pile[WZ2]; 
if((V28<V30)) goto l76;
l7:pile[v[22]]=365; pile[WZ1]=jvj+12; pile[WZ2]=jvj+13; 
(*f[33])( );     /*FNDE0(365,jvj+12,jvj+13)*/
for(i=x[jvj+13],V31=0;i>0;i=t[i],V31++)  ;
if((V31>V28)) goto l76;
...
l26:x[jvj+28]=x[jvj+116] ;z[jvj+28]=z[jvj+116];
pile[v[22]]=101; pile[WZ1]=jvj+28; pile[WZ2]=jvj+35; 
(*f[32])( );if(v[102]) goto l21;     /*FNDO0(101,jvj+28,jvj+35)*/
if((x[jvj+35]!=134)) goto l21;
pile[WZ1]=jvj+40; pile[WZ2]=110; pile[WZ3]=(-7085); pile[WZ4]=jvj+36; 
(*f[270])( );     /*QUADRI7(101,jvj+40,110,(-7085),jvj+36)*/
pile[v[22]]=HIST; pile[WZ1]=159; pile[WZ2]=jvj+36; 
(*f[36])( );     /*PLUSC0(HIST,159,jvj+36)*/
(*f[1559])( );     /*CONTRADICTION0(HIST)*/
l21:if((x[jvj+28]!=250)) goto l18;
V122=x[jvj+40];
...
pile[v[22]]=V121; 
(*f[40])( );     /*SLG0(V121)*/
pile[v[22]]=1271; pile[WZ1]=158; pile[WZ2]=jvj+37; 
(*f[54])( );     /*TRI1(1271,158,jvj+37)*/
pile[v[22]]=jvj+37; 
(*f[605])( );     /*MONITEUR0(jvj+37)*/
l18:pile[v[22]]=101; pile[WZ1]=jvj+28; pile[WZ2]=jvj+29; 
(*f[32])( );if(v[102]) goto l19;     /*FNDO0(101,jvj+28,jvj+29)*/
if((x[jvj+29]==135)) goto l25;
l19:pile[v[22]]=111; pile[WZ1]=jvj+28; pile[WZ2]=jvj+32; 
(*f[32])( );if(v[102]) goto l20;     /*FNDO0(111,jvj+28,jvj+32)*/
pile[v[22]]=101; pile[WZ1]=jvj+32; pile[WZ2]=jvj+33; 
(*f[32])( );if(v[102]) goto l20;     /*FNDO0(101,jvj+32,jvj+33)*/
if((x[jvj+33]==25)) goto l22;
l20:pile[v[22]]=jvj+28; pile[WZ1]=jvj+34; 
(*f[887])( );     /*VARND0(jvj+28,jvj+34)*/
for(i=x[jvj+34],V48=0;i>0;i=t[i],V48++)  ;
if((V48!=1)) goto l22;
...
(*f[32])( );if(v[102]) goto l25;     /*FNDO0(498,jvj+30,jvj+31)*/
pile[v[22]]=473; pile[WZ1]=jvj+31; 
(*f[26])( );if(v[102]) goto l25;     /*FNDC0(473,jvj+31,V49)*/
V49=pile[WZ2]; 
if((V49==1)) goto l22;
...
goto l26;
l22:pile[v[22]]=K; pile[WZ1]=158; pile[WZ2]=1374; 
(*f[35])( );     /*CHGC1(K,158,1374)*/
goto l25;
l24:x[jvj+40]=s[x[jvj+39]] ;z[jvj+40]=(x[jvj+40]<=sepcte) ? x[jvj+40] : z[jvj+39];
pile[v[22]]=jvj+40; pile[WZ1]=jvj+25; 
(*f[255])( );     /*COPEXP0(jvj+40,jvj+25)*/
x[jvj+116]=incon;
if((v[244]!=0)) goto l15;
pile[v[22]]=jvj+25; pile[WZ1]=jvj+26; 
(*f[799])( );if(v[102]) goto l15;     /*NORME0(jvj+25,jvj+26)*/
x[jvj+127]=x[jvj+26] ;z[jvj+127]=z[jvj+26];
x[jvj+116]=x[jvj+127] ;z[jvj+116]=z[jvj+127];
l15:if((v[244]<=0)) goto l16;
pile[v[22]]=jvj+25; pile[WZ1]=jvj+27; 
(*f[965])( );if(v[102]) goto l16;     /*NORM0(jvj+25,jvj+27)*/
x[jvj+128]=x[jvj+27] ;z[jvj+128]=z[jvj+27];
...
pile[v[22]]=HIST; 
(*f[1559])( );     /*CONTRADICTION0(HIST)*/
pile[v[22]]=K; pile[WZ1]=158; pile[WZ2]=472; 
(*f[35])( );     /*CHGC1(K,158,472)*/
...
pile[v[22]]=HIST; 
(*f[1559])( );     /*CONTRADICTION0(HIST)*/
pile[v[22]]=K; pile[WZ1]=158; pile[WZ2]=688; 
(*f[35])( );     /*CHGC1(K,158,688)*/
...
l47:pile[v[22]]=HIST; 
(*f[1559])( );     /*CONTRADICTION0(HIST)*/
pile[v[22]]=K; pile[WZ1]=158; pile[WZ2]=923; 
(*f[35])( );     /*CHGC1(K,158,923)*/
goto l46;
...
pile[v[22]]=HIST; 
(*f[1559])( );     /*CONTRADICTION0(HIST)*/
pile[v[22]]=K; pile[WZ1]=158; pile[WZ2]=766; 
(*f[35])( );     /*CHGC1(K,158,766)*/
...
if((V105!=0)) goto l62;
if((V104<3)) goto l64;
l62:pile[v[22]]=589; pile[WZ1]=10450; pile[WZ2]=1; pile[WZ3]=(-10446); pile[WZ4]=jvj+85; pile[WZ5]=(-625); pile[v[22]+6]=V10; pile[v[22]+7]=(-756); pile[v[22]+8]=NM; pile[v[22]+9]=jvj+94; 
(*f[1059])( );     /*INTERP11(589,10450,1,(-10446),jvj+85,(-625),V10,(-756),NM,jvj+94)*/
if((x[jvj+94]==135)) goto l63;
l70:pile[v[22]]=HIST; 
(*f[1559])( );     /*CONTRADICTION0(HIST)*/
pile[v[22]]=K; pile[WZ1]=158; pile[WZ2]=462; 
(*f[35])( );     /*CHGC1(K,158,462)*/
l69:x[jvj+97]=t[x[jvj+97]];
l67:if((x[jvj+97]>0)) goto l68;
pile[v[22]]=158; pile[WZ1]=K; pile[WZ2]=jvj+109; 
(*f[32])( );if(v[102]) goto l75;     /*FNDO0(158,K,jvj+109)*/
...
l74:pile[v[22]]=HIST; 
(*f[1559])( );     /*CONTRADICTION0(HIST)*/
pile[v[22]]=K; pile[WZ1]=158; pile[WZ2]=336; 
(*f[35])( );     /*CHGC1(K,158,336)*/
goto l73;
l75:pile[v[22]]=158; pile[WZ1]=K; pile[WZ2]=jvj+113; 
(*f[32])( );if(v[102]) goto l76;     /*FNDO0(158,K,jvj+113)*/
