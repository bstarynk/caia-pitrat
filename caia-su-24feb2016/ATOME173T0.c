...
{int V31=0,V3=0,V16=0,V29=0,V32=0,V23=0,I=0,V5=0,M=0;
int R;
int WZ1,WZ2,WZ3,WZ4;
int jvj;
jvj=v[0];
v[0]+=28;
x[jvj+1]=20173;z[jvj+1]=(-100);
if(v[0]>99700) (*f[6])( );
if(v[90]==3555&&v[97]==0) {
...
for(i=x[jvj+6],V16=0;i>0;i=t[i],V16++)  ;
if((V16!=2)) goto l7;
pile[v[22]]=103; pile[WZ1]=R; pile[WZ2]=jvj+7; 
(*f[32])( );if(v[102]) goto l7;     /*FNDO0(103,R,jvj+7)*/
pile[v[22]]=130; pile[WZ1]=jvj+7; 
(*f[26])( );if(v[102]) goto l7;     /*FNDC0(130,jvj+7,V29)*/
V29=pile[WZ2]; 
if((V29!=0)) goto l7;
...
(*f[26])( );if(v[102]) goto l5;     /*FNDC0(130,jvj+18,V23)*/
V23=pile[WZ2]; 
I=V23;
V5=(-I);
V3=incon;
...
pile[v[22]]=jvj+22; pile[WZ1]=3555; pile[WZ2]=246; pile[WZ3]=jvj+23; 
(*f[189])( );     /*TRI4(jvj+22,3555,246,jvj+23)*/
pile[v[22]]=jvj+23; pile[WZ1]=20173; pile[WZ2]=218; pile[WZ3]=jvj+24; 
(*f[58])( );     /*TRI3(jvj+23,20173,218,jvj+24)*/
...
pile[v[22]]=jvj+19; pile[WZ1]=164; pile[WZ2]=jvj+20; pile[WZ3]=M; 
(*f[2056])( );     /*VAUT0(jvj+19,164,jvj+20,M)*/
