...
jvj=v[0];
v[0]+=23;
x[jvj+1]=26208;z[jvj+1]=(-100);
if(v[0]>99700) (*f[6])( );
if(v[90]==2883&&v[97]==0) {
(*f[4])( ); x[jvj+1]=incon;v[0]=jvj;return;
}
A=pile[v[22]]; B=pile[v[22]+1]; N=pile[v[22]+2]; NNNE=pile[v[22]+3]; v[22]+=4; 
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-659); pile[WZ4]=jvj+21; 
(*f[270])( );     /*QUADRI7(100,21,140,(-659),jvj+21)*/
