...
X=pile[v[22]]; S=pile[v[22]+1]; E=pile[v[22]+2]; v[22]+=3; 
WZ2=v[22]+2; WZ1=v[22]+1; 
x[jvj+11]=0 ;z[jvj+11]=0;
x[E]=x[jvj+11] ;z[E]=z[jvj+11];
...
x[jvj+13]=x[jvj+7] ;z[jvj+13]=z[jvj+7];
goto l5;
l6:x[jvj+1]=s[x[jvj+13]] ;z[jvj+1]=(x[jvj+1]<=sepcte) ? x[jvj+1] : z[jvj+13];
x[jvj+8]=incon;
