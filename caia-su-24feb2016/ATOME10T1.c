...
{int V21=0,V1=0,V22=0,V19=0,L=0,F=0,M=0;
int D;
int WZ1,WZ2,WZ3,WZ4,WZ5;
int jvj;
jvj=v[0];
v[0]+=23;
x[jvj+1]=20010;z[jvj+1]=(-100);
...
(*f[26])( );if(v[102]) goto l5;     /*FNDC0(130,jvj+10,V19)*/
V19=pile[WZ2]; 
L=V19;
...
(*f[32])( );if(v[102]) goto l5;     /*FNDO0(102,jvj+8,jvj+13)*/
...
pile[v[22]]=jvj+20; pile[WZ1]=3272; pile[WZ2]=246; pile[WZ3]=jvj+21; 
(*f[189])( );     /*TRI4(jvj+20,3272,246,jvj+21)*/
pile[v[22]]=158; pile[WZ1]=1; pile[WZ2]=218; pile[WZ3]=20010; pile[WZ4]=jvj+21; pile[WZ5]=jvj+18; 
(*f[269])( );     /*QUADRI6(158,1,218,20010,jvj+21,jvj+18)*/
pile[v[22]]=jvj+18; pile[WZ1]=159; pile[WZ2]=jvj+22; 
(*f[36])( );     /*PLUSC0(jvj+18,159,jvj+22)*/
pile[WZ2]=jvj+23; 
(*f[36])( );     /*PLUSC0(jvj+18,159,jvj+23)*/
pile[WZ1]=164; pile[WZ2]=D; pile[WZ3]=M; 
(*f[2056])( );     /*VAUT0(jvj+18,164,D,M)*/
goto l5;
