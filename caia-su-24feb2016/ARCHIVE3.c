...
{int V10=0,M=0,R=0,V12=0,P=0,N=0,V3=0,K=0,V18=0,V17=0,V15=0,V26=0,V=0,V29=0,V37=0,V36=0,V32=0,V34=0,V33=0,V31=0,V7=0,V8=0,V9=0,V23=0,V21=0;
int T,HIST,A,B;
int WZ1,WZ2;
int jvj;
jvj=v[0];
...
T=pile[v[22]]; HIST=pile[v[22]+1]; A=pile[v[22]+2]; B=pile[v[22]+3]; v[22]+=4; 
