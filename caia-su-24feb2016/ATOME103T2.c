...
(*f[1975])( );if(v[102]) goto l2;     /*FNDCND0(280,jvj+4,V3)*/
V3=pile[WZ2]; 
pile[v[22]]=jvj+5; 
...
(*f[1975])( );if(v[102]) goto l4;     /*FNDCND0(280,jvj+14,V7)*/
V7=pile[WZ2]; 
if((V7<=0)) goto l4;
...
pile[v[22]]=jvj+17; pile[WZ1]=3509; pile[WZ2]=246; pile[WZ3]=jvj+18; 
(*f[189])( );     /*TRI4(jvj+17,3509,246,jvj+18)*/
