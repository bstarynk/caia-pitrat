...
{int V1=0;
int ZZG,ZZBL,ZZN,OS1,O1,OS2,O2,SS1,S1;
int RES;
...
ZZG=pile[v[22]]; ZZBL=pile[v[22]+1]; ZZN=pile[v[22]+2]; OS1=pile[v[22]+3]; O1=pile[v[22]+4]; OS2=pile[v[22]+5]; O2=pile[v[22]+6]; SS1=pile[v[22]+7]; S1=pile[v[22]+8]; RES=pile[v[22]+9]; v[22]+=10; 
...
pile[v[22]]=jvj+12; pile[WZ1]=S1; pile[WZ2]=163; pile[WZ3]=jvj+13; 
(*f[631])( );     /*TRI16(jvj+12,S1,163,jvj+13)*/
pile[v[22]]=140; pile[WZ1]=SS1; pile[WZ2]=158; pile[WZ3]=96; pile[WZ4]=jvj+13; pile[WZ5]=jvj+4; 
(*f[48])( );     /*QUADRI1(140,SS1,158,96,jvj+13,jvj+4)*/
