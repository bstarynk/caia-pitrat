...
{int V6=0,V7=0,V26=0,V25=0,V28=0,V1=0,V27=0;
int R;
...
l10:pile[v[22]]=101; pile[WZ1]=R; pile[WZ2]=110; pile[WZ3]=(-601); pile[WZ4]=jvj+20; 
...
(*f[26])( );if(v[102]) goto l7;     /*FNDC0(870,jvj+12,V7)*/
V7=pile[WZ2]; 
if((V7!=2)) goto l7;
...
goto l11;
l14:V27=s[V28];
for(a=x[jvj+15];a>0;a=t[a]) if(s[a]==V27) goto l13;
l12:V1=134;
goto l8;
}
