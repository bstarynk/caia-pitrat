...
if((V2>4)) goto l1;
pile[v[22]]=1101; 
(*f[26])( );if(v[102]) goto l1;     /*FNDC0(1101,R,V4)*/
V4=pile[WZ2]; 
if((V4<=1)) goto l1;
...
pile[v[22]]=jvj+10; pile[WZ1]=3619; pile[WZ2]=246; pile[WZ3]=jvj+11; 
(*f[189])( );     /*TRI4(jvj+10,3619,246,jvj+11)*/
pile[v[22]]=jvj+11; pile[WZ1]=20124; pile[WZ2]=218; pile[WZ3]=jvj+12; 
(*f[58])( );     /*TRI3(jvj+11,20124,218,jvj+12)*/
