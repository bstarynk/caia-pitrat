...
{int I=0,V2=0,V5=0,V3=0,V6=0,V7=0,V8=0,XI=0,YI=0,V10=0,V9=0;
int N,M,P;
int NNNE;
...
l1:pile[v[22]]=I; pile[WZ1]=(-596); 
(*f[201])( );if(v[102]) goto l2;     /*FCOEFF0(I,(-596),V2)*/
V2=pile[WZ2]; 
V5=XI+V2;
if((V5>N)) goto l9;
l2:pile[v[22]]=I; pile[WZ1]=(-606); 
(*f[201])( );if(v[102]) goto l8;     /*FCOEFF0(I,(-606),V3)*/
V3=pile[WZ2]; 
V6=YI+V3;
if((V6>M)) goto l9;
l8:YI++;
