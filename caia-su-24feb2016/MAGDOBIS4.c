...
{int J=0,V7=0,V8=0,K=0,V2=0,XX=0,V9=0,V3=0,YY=0,V10=0,V12=0,V11=0,I=0,V4=0,V5=0;
int NNNE;
...
V8=J/4;
K=0;
l3:pile[v[22]]=K; pile[WZ1]=(-7562); 
(*f[201])( );if(v[102]) goto l2;     /*FCOEFF0(K,(-7562),V2)*/
V2=pile[WZ2]; 
XX=V2;
V9=V7+XX;
if((V9<0)) goto l2;
if((V9>3)) goto l2;
pile[WZ1]=(-7563); 
(*f[201])( );if(v[102]) goto l2;     /*FCOEFF0(K,(-7563),V3)*/
V3=pile[WZ2]; 
YY=V3;
V10=V8+YY;
if((V10<0)) goto l2;
...
V11=V9+V12;
I=0;
l5:pile[v[22]]=1; pile[WZ1]=I; pile[WZ2]=(-630); 
(*f[203])( );if(v[102]) goto l4;     /*FTAB0(1,I,(-630),V4)*/
V4=pile[WZ3]; 
pile[v[22]]=2; 
(*f[203])( );if(v[102]) goto l4;     /*FTAB0(2,I,(-630),V5)*/
V5=pile[WZ3]; 
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-2863); pile[WZ4]=jvj+21; 
(*f[270])( );     /*QUADRI7(100,21,140,(-2863),jvj+21)*/
...
pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=48; pile[WZ4]=jvj+24; 
(*f[181])( );     /*QUADRI2(100,20,101,48,jvj+24)*/
pile[WZ3]=25; pile[WZ4]=jvj+27; 
(*f[181])( );     /*QUADRI2(100,20,101,25,jvj+27)*/
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-2041); pile[WZ4]=jvj+32; 
(*f[270])( );     /*QUADRI7(100,21,140,(-2041),jvj+32)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=J; pile[WZ4]=jvj+34; 
(*f[192])( );     /*QUADRI4(100,41,130,J,jvj+34)*/
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V4; pile[WZ4]=jvj+29; 
(*f[192])( );     /*QUADRI4(100,41,130,V4,jvj+29)*/
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-2041); pile[WZ4]=jvj+40; 
(*f[270])( );     /*QUADRI7(100,21,140,(-2041),jvj+40)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V11; pile[WZ4]=jvj+42; 
(*f[192])( );     /*QUADRI4(100,41,130,V11,jvj+42)*/
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V5; pile[WZ4]=jvj+37; 
(*f[192])( );     /*QUADRI4(100,41,130,V5,jvj+37)*/
...
pile[v[22]]=100; pile[WZ1]=22; pile[WZ2]=102; pile[WZ3]=jvj+39; pile[WZ4]=jvj+38; pile[WZ5]=jvj+26; 
(*f[269])( );     /*QUADRI6(100,22,102,jvj+39,jvj+38,jvj+26)*/
