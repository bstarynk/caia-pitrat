...
H=pile[v[22]]; S=pile[v[22]+1]; W=pile[v[22]+2]; NNNE=pile[v[22]+3]; v[22]+=4; 
...
pile[v[22]]=100; pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=S; pile[WZ4]=jvj+12; 
(*f[192])( );     /*QUADRI4(100,41,130,S,jvj+12)*/
...
l3:pile[v[22]]=100; pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-6773); pile[WZ4]=jvj+7; 
(*f[270])( );     /*QUADRI7(100,21,140,(-6773),jvj+7)*/
