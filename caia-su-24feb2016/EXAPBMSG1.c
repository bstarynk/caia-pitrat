...
{int V2=0,V1=0,V16=0,N=0,V3=0,V17=0,V=0,V6=0,V5=0,V20=0,D=0,V13=0,V12=0,V21=0,V10=0,V9=0,V22=0,C=0,V14=0,V18=0,A=0,V7=0,V183=0,V158=0,V161=0,V160=0,V165=0,V164=0,V163=0,V332=0,V170=0,V173=0,V336=0,V335=0,V337=0,V339=0,V340=0,V341=0;
int G,M,MM,T,Z;
int WZ1,WZ2,WZ3;
int jvj;
jvj=v[0];
...
G=pile[v[22]]; M=pile[v[22]+1]; MM=pile[v[22]+2]; T=pile[v[22]+3]; Z=pile[v[22]+4]; v[22]+=5; 
...
l8:x[jvj+5]=x[jvj+13] ;z[jvj+5]=z[jvj+13];
...
l14:V7=V5;
goto l18;
l19:pile[v[22]]=135; pile[WZ1]=0; pile[WZ2]=Z; 
(*f[42])( );     /*SRA1(135,0,Z,V158)*/
V158=pile[WZ3]; 
l23:pile[v[22]]=41; pile[WZ1]=V163; pile[WZ2]=V158; 
...
l25:if((x[jvj+8]>0)) goto l26;
l29:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=5; return;
l20:pile[v[22]]=V161; pile[WZ1]=83; 
(*f[38])( );     /*SPC0(V161,83,V160)*/
V160=pile[WZ2]; 
goto l24;
l21:pile[v[22]]=V165; pile[WZ1]=83; 
(*f[38])( );     /*SPC0(V165,83,V164)*/
V164=pile[WZ2]; 
l28:pile[v[22]]=V164; 
(*f[40])( );     /*SLG0(V164)*/
l27:x[jvj+8]=t[x[jvj+8]];
goto l25;
l22:for(i=x[G],V163=0;i>0;i=t[i],V163++)  ;
V158=incon;
if((x[Z]!=250)) goto l19;
V158=0;
goto l23;
l26:x[jvj+9]=s[x[jvj+8]] ;z[jvj+9]=(x[jvj+9]<=sepcte) ? x[jvj+9] : z[jvj+8];
pile[v[22]]=109; pile[WZ1]=jvj+9; pile[WZ2]=jvj+10; 
(*f[32])( );if(v[102]) goto l27;     /*FNDO0(109,jvj+9,jvj+10)*/
