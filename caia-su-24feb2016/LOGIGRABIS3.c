...
l1:V2=incon;
pile[v[22]]=1; pile[WZ1]=I; pile[WZ2]=(-1859); 
(*f[203])( );if(v[102]) goto l2;     /*FTAB0(1,I,(-1859),V4)*/
V4=pile[WZ3]; 
if((V4!=0)) goto l2;
V2=0;
l5:V10=I*MV;
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-733); pile[WZ4]=jvj+9; 
(*f[270])( );     /*QUADRI7(100,21,140,(-733),jvj+9)*/
...
J++;
goto l6;
l2:pile[v[22]]=I; pile[WZ1]=(-1859); 
(*f[3979])( );if(v[102]) goto l4;     /*LONGUEUR0(I,(-1859),V3)*/
V3=pile[WZ2]; 
V8=V3+1;
V2=V8;
goto l5;
