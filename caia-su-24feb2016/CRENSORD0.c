...
ND=pile[v[22]]; UR=pile[v[22]+1]; NR=pile[v[22]+2]; F=pile[v[22]+3]; X=pile[v[22]+4]; v[22]+=5; 
...
pile[v[22]]=F; pile[WZ1]=jvj+32; 
(*f[434])( );if(v[102]) goto l25;     /*EXPPB1(F,jvj+32)*/
pile[v[22]]=1484; pile[WZ1]=854; 
...
l66:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=5; return;
l56:V84=ND;
