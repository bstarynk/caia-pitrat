...
R=pile[v[22]]; NX=pile[v[22]+1]; ZX=pile[v[22]+2]; RK=pile[v[22]+3]; v[22]+=4; 
...
l2:RES=V4;
v[45]=0;
x[jvj+5]=RES ;z[jvj+5]=(RES<=sepcte) ? RES : 0;
x[RK]=x[jvj+5] ;z[RK]=z[jvj+5];
l3:x[jvj+4]=vo[14];z[jvj+4]=vz[14];
pile[v[22]]=258; pile[WZ1]=jvj+4; 
(*f[71])( );     /*ENLV0(258,jvj+4)*/
if(x[RK]!=incon) goto l4;
v[0]=jvj; v[22]-=4; v[102]=1;return;
l1:V4=178;
goto l2;
l4:v[0]=jvj; v[22]-=4; v[102]=0;return;
}
