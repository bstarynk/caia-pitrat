...
{int V47=0,V35=0,V4=0,K=0,V9=0,V14=0,V22=0,V21=0,V25=0,V46=0,V45=0,V26=0,V28=0,V27=0,R=0,DX=0,V37=0,V38=0,V19=0,V33=0,V1=0,V56=0,V57=0,V59=0,V58=0,V61=0,V63=0,V65=0;
int FF;
int E;
int WZ1,WZ2,WZ3,WZ4;
int jvj;
...
FF=pile[v[22]]; E=pile[v[22]+1]; v[22]+=2; 
...
l40:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=2; v[102]=0;return;
...
(*f[44])( );if(v[102]) goto l44;     /*FNDC1(163,jvj+15,V25)*/
V25=pile[WZ2]; 
if((V25==(-7141))) goto l18;
l44:pile[v[22]]=498; pile[WZ1]=jvj+15; pile[WZ2]=jvj+30; 
...
if((V45!=V37)) goto l22;
pile[v[22]]=163; 
(*f[44])( );if(v[102]) goto l45;     /*FNDC1(163,jvj+19,V46)*/
V46=pile[WZ2]; 
if((V46==(-7141))) goto l22;
l45:pile[v[22]]=498; pile[WZ1]=jvj+19; pile[WZ2]=jvj+31; 
...
l39:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=2; v[102]=1;return;
