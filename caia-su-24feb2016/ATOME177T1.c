...
{int V4=0,V9=0,V25=0,V3=0,V29=0;
int R;
int WZ1,WZ2,WZ3,WZ4;
int jvj;
jvj=v[0];
...
pile[v[22]]=R; pile[WZ1]=jvj+12; pile[WZ3]=jvj+13; 
(*f[45])( );if(v[102]) goto l2;     /*FNDZ0(R,jvj+12,V25,jvj+13)*/
V25=pile[WZ2]; 
...
pile[v[22]]=jvj+18; pile[WZ1]=3655; pile[WZ2]=246; pile[WZ3]=jvj+19; 
(*f[189])( );     /*TRI4(jvj+18,3655,246,jvj+19)*/
pile[v[22]]=jvj+19; pile[WZ1]=20177; pile[WZ2]=218; pile[WZ3]=jvj+20; 
(*f[58])( );     /*TRI3(jvj+19,20177,218,jvj+20)*/
