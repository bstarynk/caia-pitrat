...
pile[v[22]]=jvj+2; 
(*f[1161])( );if(v[102]) goto l3;     /*INF0(jvj+2,V3)*/
V3=pile[WZ1]; 
...
pile[v[22]]=jvj+8; 
(*f[1161])( );if(v[102]) goto l20;     /*INF0(jvj+8,V76)*/
V76=pile[WZ1]; 
if((V76<0)) goto l20;
x[jvj+24]=t[x[jvj+24]];
...
pile[v[22]]=jvj+9; 
(*f[1161])( );if(v[102]) goto l10;     /*INF0(jvj+9,V79)*/
V79=pile[WZ1]; 
...
pile[v[22]]=jvj+15; 
(*f[1160])( );if(v[102]) goto l20;     /*SUP0(jvj+15,V14)*/
V14=pile[WZ1]; 
V24=(-V14);
R=V24;
goto l23;
...
(*f[1160])( );if(v[102]) goto l31;     /*SUP0(jvj+17,V59)*/
V59=pile[WZ1]; 
...
(*f[1161])( );if(v[102]) goto l16;     /*INF0(jvj+17,V41)*/
V41=pile[WZ1]; 
...
(*f[1161])( );if(v[102]) goto l20;     /*INF0(jvj+16,V96)*/
V96=pile[WZ1]; 
...
(*f[1161])( );if(v[102]) goto l20;     /*INF0(jvj+19,V95)*/
V95=pile[WZ1]; 
