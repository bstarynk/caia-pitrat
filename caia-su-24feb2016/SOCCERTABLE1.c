...
V11=N*J;
V10=I+V11;
pile[v[22]]=100; pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-595); pile[WZ4]=jvj+7; 
(*f[270])( );     /*QUADRI7(100,21,140,(-595),jvj+7)*/
...
l5:I++;
goto l4;
l6:pile[v[22]]=I; pile[WZ1]=(-596); 
(*f[201])( );if(v[102]) goto l5;     /*FCOEFF0(I,(-596),V5)*/
V5=pile[WZ2]; 
x[jvj+2]=0 ;z[jvj+2]=0;
J=0;
goto l1;
