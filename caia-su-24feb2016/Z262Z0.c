...
x[BRRR]=x[jvj+11] ;z[BRRR]=z[jvj+11];
...
if(x[jvj+3]!=651&&x[jvj+3]!=650) goto l1;
...
l1:x[jvj+12]=w[x[jvj+1]][9];
l2:if((x[jvj+12]>0)) goto l3;
x[jvj+13]=w[x[jvj+1]][8];
l5:if((x[jvj+13]<=0)) goto l8;
...
(*f[1813])( );     /*Z262Z1(jvj+7,BRRR)*/
l4:x[jvj+12]=t[x[jvj+12]];
goto l2;
l7:x[jvj+10]=s[x[jvj+14]] ;z[jvj+10]=(x[jvj+10]<=sepcte) ? x[jvj+10] : z[jvj+14];
pile[v[22]]=jvj+10; pile[WZ1]=BRRR; 
(*f[1813])( );     /*Z262Z1(jvj+10,BRRR)*/
x[jvj+14]=t[x[jvj+14]];
goto l6;
