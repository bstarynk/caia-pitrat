...
{int V1=0,V6=0,V9=0,V4=0,V5=0,V7=0,V8=0,V10=0,V13=0,V12=0,V14=0,V15=0;
int BL,N,S;
int WZ1,WZ2,WZ3;
int jvj;
jvj=v[0];
...
BL=pile[v[22]]; N=pile[v[22]+1]; S=pile[v[22]+2]; v[22]+=3; 
...
pile[v[22]]=V12; 
(*f[40])( );     /*SLG0(V12)*/
l1:pile[v[22]]=0; pile[WZ1]=S; 
(*f[37])( );     /*SRA0(0,S,V14)*/
V14=pile[WZ2]; 
pile[v[22]]=41; pile[WZ1]=N; pile[WZ2]=V14; 
(*f[39])( );     /*SDX0(41,N,V14,V15)*/
V15=pile[WZ3]; 
pile[v[22]]=V15; 
(*f[40])( );     /*SLG0(V15)*/
