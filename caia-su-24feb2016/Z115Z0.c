...
pile[v[22]]=jvj+4; pile[WZ1]=130; pile[WZ2]=1; 
(*f[186])( );     /*BTC0(jvj+4,130,1)*/
...
(*f[2223])( );     /*Z115Z1(jvj+6,jvj+4)*/
l4:x[jvj+10]=t[x[jvj+10]];
goto l2;
l7:x[jvj+9]=s[x[jvj+12]] ;z[jvj+9]=(x[jvj+9]<=sepcte) ? x[jvj+9] : z[jvj+12];
pile[v[22]]=jvj+9; pile[WZ1]=jvj+4; 
(*f[2223])( );     /*Z115Z1(jvj+9,jvj+4)*/
x[jvj+12]=t[x[jvj+12]];
goto l6;
l8:pile[v[22]]=130; pile[WZ1]=jvj+4; 
(*f[26])( );if(v[102]) goto l9;     /*FNDC0(130,jvj+4,BRRR)*/
BRRR=pile[WZ2]; 
