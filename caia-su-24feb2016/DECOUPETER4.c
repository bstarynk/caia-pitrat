...
{int I=0,V4=0,V5=0,V10=0,J=0,V2=0,V3=0,V9=0,V6=0,V7=0,V13=0,V12=0,V11=0,V15=0,V14=0,YI=0,V18=0,V17=0;
int N,M,P;
int NNNE;
...
l2:J++;
goto l1;
l4:pile[v[22]]=I; pile[WZ1]=(-596); 
(*f[201])( );if(v[102]) goto l8;     /*FCOEFF0(I,(-596),V6)*/
V6=pile[WZ2]; 
pile[WZ1]=(-606); 
(*f[201])( );if(v[102]) goto l8;     /*FCOEFF0(I,(-606),V7)*/
V7=pile[WZ2]; 
V13=N+1;
V12=V13-V6;
V11=V12/2;
