...
{int I=0,V12=0,V6=0,J=0,V14=0,V9=0;
int N;
int NNNE;
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-624); pile[WZ4]=jvj+33; 
(*f[270])( );     /*QUADRI7(100,21,140,(-624),jvj+33)*/
...
pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=485; pile[WZ4]=jvj+36; 
...
pile[v[22]]=jvj+38; pile[WZ1]=22; pile[WZ2]=100; pile[WZ3]=jvj+32; 
(*f[58])( );     /*TRI3(jvj+38,22,100,jvj+32)*/
...
(*f[1006])( );if(v[102]) goto l5;     /*POWER0(V14,10,V9)*/
V9=pile[WZ2]; 
