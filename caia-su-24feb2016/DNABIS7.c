...
l3:pile[v[22]]=5; pile[WZ1]=I; pile[WZ2]=(-612); 
(*f[203])( );if(v[102]) goto l2;     /*FTAB0(5,I,(-612),V2)*/
V2=pile[WZ3]; 
pile[v[22]]=100; pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=25; pile[WZ4]=jvj+4; 
(*f[181])( );     /*QUADRI2(100,20,101,25,jvj+4)*/
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-697); pile[WZ4]=jvj+9; 
(*f[270])( );     /*QUADRI7(100,21,140,(-697),jvj+9)*/
