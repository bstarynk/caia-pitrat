...
(*f[32])( );if(v[102]) goto l2;     /*FNDO0(jvj+10,NNNI,jvj+11)*/
...
pile[v[22]]=101; pile[WZ1]=NNNI; pile[WZ2]=110; pile[WZ3]=(-11593); pile[WZ4]=jvj+18; 
(*f[270])( );     /*QUADRI7(101,NNNI,110,(-11593),jvj+18)*/
...
pile[v[22]]=jvj+15; pile[WZ1]=3883; pile[WZ2]=246; pile[WZ3]=jvj+16; 
(*f[189])( );     /*TRI4(jvj+15,3883,246,jvj+16)*/
pile[v[22]]=jvj+16; pile[WZ1]=20535; pile[WZ2]=218; pile[WZ3]=jvj+17; 
(*f[58])( );     /*TRI3(jvj+16,20535,218,jvj+17)*/
