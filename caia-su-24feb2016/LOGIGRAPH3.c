...
{int V4=0,V5=0,J=0,V2=0,L=0,V7=0,V6=0;
int H,V;
int NNNE;
...
l2:J++;
goto l1;
l3:pile[v[22]]=1; pile[WZ1]=J; pile[WZ2]=(-1859); 
(*f[203])( );if(v[102]) goto l2;     /*FTAB0(1,J,(-1859),V2)*/
V2=pile[WZ3]; 
if((V2!=0)) goto l2;
L=0;
l4:if((L>V5)) goto l2;
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V6; pile[WZ4]=jvj+11; 
(*f[192])( );     /*QUADRI4(100,41,130,V6,jvj+11)*/
