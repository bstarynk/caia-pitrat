...
{int I=0,V3=0,V5=0,V4=0,V7=0,V6=0;
int NNNE;
int WZ1,WZ2,WZ3,WZ4,WZ5;
int jvj;
jvj=v[0];
v[0]+=22;
x[jvj+1]=26124;z[jvj+1]=(-100);
if(v[0]>99700) (*f[6])( );
if(v[90]==2502&&v[97]==0) {
...
V7=I+6;
V6=V7%12;
pile[v[22]]=100; pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=625; pile[WZ4]=jvj+6; 
(*f[181])( );     /*QUADRI2(100,20,101,625,jvj+6)*/
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-1544); pile[WZ4]=jvj+11; 
...
pile[v[22]]=100; pile[WZ1]=484; pile[WZ2]=102; pile[WZ3]=jvj+13; pile[WZ4]=jvj+12; pile[WZ5]=jvj+10; 
(*f[269])( );     /*QUADRI6(100,484,102,jvj+13,jvj+12,jvj+10)*/
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V4; pile[WZ4]=jvj+19; 
(*f[192])( );     /*QUADRI4(100,41,130,V4,jvj+19)*/
pile[v[22]]=jvj+17; pile[WZ1]=111; pile[WZ2]=jvj+18; 
(*f[54])( );     /*TRI1(jvj+17,111,jvj+18)*/
pile[v[22]]=100; pile[WZ1]=484; pile[WZ2]=102; pile[WZ3]=jvj+19; pile[WZ4]=jvj+18; pile[WZ5]=jvj+15; 
(*f[269])( );     /*QUADRI6(100,484,102,jvj+19,jvj+18,jvj+15)*/
...
pile[WZ1]=22; pile[WZ2]=111; pile[WZ3]=jvj+14; pile[WZ4]=jvj+8; 
(*f[181])( );     /*QUADRI2(100,22,111,jvj+14,jvj+8)*/
pile[v[22]]=jvj+8; pile[WZ1]=107; pile[WZ2]=jvj+15; 
(*f[36])( );     /*PLUSC0(jvj+8,107,jvj+15)*/
pile[WZ2]=jvj+16; 
(*f[36])( );     /*PLUSC0(jvj+8,107,jvj+16)*/
pile[v[22]]=100; pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=10; pile[WZ4]=jvj+4; 
(*f[192])( );     /*QUADRI4(100,41,130,10,jvj+4)*/
pile[v[22]]=jvj+4; pile[WZ1]=160; pile[WZ2]=jvj+5; 
(*f[54])( );     /*TRI1(jvj+4,160,jvj+5)*/
pile[v[22]]=jvj+5; pile[WZ1]=jvj+6; pile[WZ2]=111; pile[WZ3]=jvj+7; 
(*f[58])( );     /*TRI3(jvj+5,jvj+6,111,jvj+7)*/
