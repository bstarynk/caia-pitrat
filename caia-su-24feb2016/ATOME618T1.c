...
(*f[32])( );if(v[102]) goto l1;     /*FNDO0(111,NNNI,jvj+4)*/
...
(*f[32])( );if(v[102]) goto l1;     /*FNDO0(103,NNNI,jvj+7)*/
pile[v[22]]=101; pile[WZ2]=110; pile[WZ3]=(-11593); pile[WZ4]=jvj+13; 
(*f[270])( );     /*QUADRI7(101,NNNI,110,(-11593),jvj+13)*/
...
pile[v[22]]=jvj+10; pile[WZ1]=3925; pile[WZ2]=246; pile[WZ3]=jvj+11; 
(*f[189])( );     /*TRI4(jvj+10,3925,246,jvj+11)*/
pile[v[22]]=jvj+11; pile[WZ1]=20618; pile[WZ2]=218; pile[WZ3]=jvj+12; 
(*f[58])( );     /*TRI3(jvj+11,20618,218,jvj+12)*/
