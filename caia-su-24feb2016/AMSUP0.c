...
(*f[3888])( );if(v[102]) goto l11;     /*SUPB0(jvj+10,jvj+11)*/
pile[v[22]]=130; 
...
pile[v[22]]=jvj+29; pile[WZ1]=V18; pile[WZ2]=164; pile[WZ3]=jvj+30; 
(*f[3989])( );if(v[102]) goto l36;     /*SETVAL0(jvj+29,V18,164,jvj+30)*/
...
(*f[3888])( );if(v[102]) goto l36;     /*SUPB0(jvj+27,jvj+28)*/
pile[v[22]]=130; 
...
(*f[3896])( );if(v[102]) goto l31;     /*SUPBV0(B,jvj+33,jvj+34)*/
...
(*f[3896])( );if(v[102]) goto l35;     /*SUPBV0(B,jvj+39,jvj+40)*/
