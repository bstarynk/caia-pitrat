...
l3:pile[v[22]]=I; pile[WZ1]=(-606); 
(*f[201])( );if(v[102]) goto l2;     /*FCOEFF0(I,(-606),V2)*/
V2=pile[WZ2]; 
pile[WZ1]=(-596); 
(*f[201])( );if(v[102]) goto l2;     /*FCOEFF0(I,(-596),V3)*/
V3=pile[WZ2]; 
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-8802); pile[WZ4]=jvj+12; 
(*f[270])( );     /*QUADRI7(100,21,140,(-8802),jvj+12)*/
...
pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=486; pile[WZ4]=jvj+15; 
(*f[181])( );     /*QUADRI2(100,20,101,486,jvj+15)*/
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-8806); pile[WZ4]=jvj+18; 
(*f[270])( );     /*QUADRI7(100,21,140,(-8806),jvj+18)*/
...
pile[WZ1]=22; pile[WZ2]=111; pile[WZ3]=jvj+15; pile[WZ4]=jvj+11; 
(*f[181])( );     /*QUADRI2(100,22,111,jvj+15,jvj+11)*/
pile[v[22]]=jvj+11; pile[WZ1]=107; pile[WZ2]=jvj+16; 
(*f[36])( );     /*PLUSC0(jvj+11,107,jvj+16)*/
pile[WZ2]=jvj+17; 
(*f[36])( );     /*PLUSC0(jvj+11,107,jvj+17)*/
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-8801); pile[WZ4]=jvj+25; 
(*f[270])( );     /*QUADRI7(100,21,140,(-8801),jvj+25)*/
...
pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=486; pile[WZ4]=jvj+28; 
(*f[181])( );     /*QUADRI2(100,20,101,486,jvj+28)*/
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-8806); pile[WZ4]=jvj+31; 
(*f[270])( );     /*QUADRI7(100,21,140,(-8806),jvj+31)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=I; pile[WZ4]=jvj+33; 
(*f[192])( );     /*QUADRI4(100,41,130,I,jvj+33)*/
pile[v[22]]=jvj+31; pile[WZ1]=111; pile[WZ2]=jvj+32; 
(*f[54])( );     /*TRI1(jvj+31,111,jvj+32)*/
pile[v[22]]=100; pile[WZ1]=484; pile[WZ2]=102; pile[WZ3]=jvj+33; pile[WZ4]=jvj+32; pile[WZ5]=jvj+29; 
(*f[269])( );     /*QUADRI6(100,484,102,jvj+33,jvj+32,jvj+29)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V3; pile[WZ4]=jvj+30; 
(*f[192])( );     /*QUADRI4(100,41,130,V3,jvj+30)*/
pile[WZ1]=22; pile[WZ2]=111; pile[WZ3]=jvj+28; pile[WZ4]=jvj+23; 
(*f[181])( );     /*QUADRI2(100,22,111,jvj+28,jvj+23)*/
pile[v[22]]=jvj+23; pile[WZ1]=107; pile[WZ2]=jvj+29; 
(*f[36])( );     /*PLUSC0(jvj+23,107,jvj+29)*/
pile[WZ2]=jvj+30; 
(*f[36])( );     /*PLUSC0(jvj+23,107,jvj+30)*/
pile[v[22]]=100; pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V2; pile[WZ4]=jvj+24; 
(*f[192])( );     /*QUADRI4(100,41,130,V2,jvj+24)*/
