...
pile[v[22]]=750; pile[WZ1]=V; 
(*f[1975])( );if(v[102]) goto l3;     /*FNDCND0(750,V,V4)*/
V4=pile[WZ2]; 
pile[v[22]]=365; pile[WZ2]=jvj+2; 
(*f[1969])( );     /*FNDEND0(365,V,jvj+2)*/
for(i=x[jvj+2],V2=0;i>0;i=t[i],V2++)  ;
if((V2!=V4)) goto l3;
x[jvj+3]=vo[14];z[jvj+3]=vz[14];
pile[v[22]]=642; pile[WZ1]=jvj+3; 
(*f[26])( );if(v[102]) goto l3;     /*FNDC0(642,jvj+3,V7)*/
V7=pile[WZ2]; 
pile[v[22]]=489; pile[WZ1]=V; pile[WZ2]=jvj+4; 
(*f[1969])( );     /*FNDEND0(489,V,jvj+4)*/
...
(*f[1029])( );     /*DIFFAPP0(jvj+5,jvj+4,jvj+6)*/
if((x[jvj+6]==135)) goto l4;
l2:x[jvj+2]=t[x[jvj+2]];
goto l1;
l3:x[jvj+1]=incon; v[0]=jvj; v[22]-=1; return;
l4:pile[v[22]]=101; pile[WZ1]=V; pile[WZ2]=110; pile[WZ3]=(-611); pile[WZ4]=jvj+12; 
(*f[270])( );     /*QUADRI7(101,V,110,(-611),jvj+12)*/
...
pile[v[22]]=jvj+9; pile[WZ1]=3957; pile[WZ2]=246; pile[WZ3]=jvj+10; 
(*f[189])( );     /*TRI4(jvj+9,3957,246,jvj+10)*/
pile[v[22]]=jvj+10; pile[WZ1]=20555; pile[WZ2]=218; pile[WZ3]=jvj+11; 
(*f[58])( );     /*TRI3(jvj+10,20555,218,jvj+11)*/
...
pile[v[22]]=jvj+7; pile[WZ1]=489; pile[WZ2]=V; pile[WZ3]=jvj+5; 
(*f[1753])( );     /*LIER1(jvj+7,489,V,jvj+5)*/
goto l2;
}
