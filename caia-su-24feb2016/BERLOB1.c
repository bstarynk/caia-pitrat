...
x[jvj+2]=0 ;z[jvj+2]=0;
V3=N-1;
pile[v[22]]=100; pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=28; pile[WZ4]=jvj+4; 
(*f[181])( );     /*QUADRI2(100,20,101,28,jvj+4)*/
pile[WZ3]=485; pile[WZ4]=jvj+9; 
(*f[181])( );     /*QUADRI2(100,20,101,485,jvj+9)*/
pile[WZ3]=486; pile[WZ4]=jvj+14; 
(*f[181])( );     /*QUADRI2(100,20,101,486,jvj+14)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=1001; pile[WZ4]=jvj+15; 
(*f[192])( );     /*QUADRI4(100,41,130,1001,jvj+15)*/
...
pile[WZ1]=22; pile[WZ2]=111; pile[WZ3]=jvj+14; pile[WZ4]=jvj+10; 
(*f[181])( );     /*QUADRI2(100,22,111,jvj+14,jvj+10)*/
pile[v[22]]=jvj+10; pile[WZ1]=107; pile[WZ2]=jvj+15; 
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=101; pile[WZ4]=jvj+21; 
(*f[192])( );     /*QUADRI4(100,41,130,101,jvj+21)*/
...
pile[WZ1]=22; pile[WZ2]=111; pile[WZ3]=jvj+20; pile[WZ4]=jvj+11; 
(*f[181])( );     /*QUADRI2(100,22,111,jvj+20,jvj+11)*/
pile[v[22]]=jvj+11; pile[WZ1]=107; pile[WZ2]=jvj+21; 
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=11; pile[WZ4]=jvj+27; 
(*f[192])( );     /*QUADRI4(100,41,130,11,jvj+27)*/
...
pile[WZ1]=22; pile[WZ2]=111; pile[WZ3]=jvj+26; pile[WZ4]=jvj+12; 
(*f[181])( );     /*QUADRI2(100,22,111,jvj+26,jvj+12)*/
pile[v[22]]=jvj+12; pile[WZ1]=107; pile[WZ2]=jvj+27; 
...
pile[WZ1]=22; pile[WZ2]=111; pile[WZ3]=jvj+32; pile[WZ4]=jvj+13; 
(*f[181])( );     /*QUADRI2(100,22,111,jvj+32,jvj+13)*/
pile[v[22]]=jvj+13; pile[WZ1]=107; pile[WZ2]=jvj+33; 
(*f[36])( );     /*PLUSC0(jvj+13,107,jvj+33)*/
pile[WZ2]=jvj+34; 
(*f[36])( );     /*PLUSC0(jvj+13,107,jvj+34)*/
...
pile[v[22]]=100; pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V3; pile[WZ4]=jvj+6; 
(*f[192])( );     /*QUADRI4(100,41,130,V3,jvj+6)*/
