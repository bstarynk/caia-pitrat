...
x[jvj+3]=0 ;z[jvj+3]=0;
x[jvj+2]=d[137];z[jvj+2]=0;
l1:if((x[jvj+2]>0)) goto l2;
x[NNNE]=x[jvj+3] ;z[NNNE]=z[jvj+3];
l3:x[jvj+1]=incon; v[0]=jvj; v[22]-=1; return;
l2:I=s[x[jvj+2]];
pile[v[22]]=100; pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=55; pile[WZ4]=jvj+5; 
(*f[181])( );     /*QUADRI2(100,20,101,55,jvj+5)*/
pile[WZ3]=26; pile[WZ4]=jvj+9; 
(*f[181])( );     /*QUADRI2(100,20,101,26,jvj+9)*/
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-1544); pile[WZ4]=jvj+14; 
(*f[270])( );     /*QUADRI7(100,21,140,(-1544),jvj+14)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=5; pile[WZ4]=jvj+16; 
(*f[192])( );     /*QUADRI4(100,41,130,5,jvj+16)*/
...
pile[v[22]]=100; pile[WZ1]=22; pile[WZ2]=102; pile[WZ3]=jvj+13; pile[WZ4]=jvj+12; pile[WZ5]=jvj+6; 
(*f[269])( );     /*QUADRI6(100,22,102,jvj+13,jvj+12,jvj+6)*/
pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=26; pile[WZ4]=jvj+17; 
(*f[181])( );     /*QUADRI2(100,20,101,26,jvj+17)*/
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-1544); pile[WZ4]=jvj+22; 
(*f[270])( );     /*QUADRI7(100,21,140,(-1544),jvj+22)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=1; pile[WZ4]=jvj+24; 
(*f[192])( );     /*QUADRI4(100,41,130,1,jvj+24)*/
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=3; pile[WZ4]=jvj+19; 
(*f[192])( );     /*QUADRI4(100,41,130,3,jvj+19)*/
...
pile[v[22]]=100; pile[WZ1]=22; pile[WZ2]=102; pile[WZ3]=jvj+21; pile[WZ4]=jvj+20; pile[WZ5]=jvj+7; 
(*f[269])( );     /*QUADRI6(100,22,102,jvj+21,jvj+20,jvj+7)*/
pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=26; pile[WZ4]=jvj+25; 
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=2; pile[WZ4]=jvj+32; 
(*f[192])( );     /*QUADRI4(100,41,130,2,jvj+32)*/
...
pile[v[22]]=100; pile[WZ1]=22; pile[WZ2]=102; pile[WZ3]=jvj+29; pile[WZ4]=jvj+28; pile[WZ5]=jvj+8; 
(*f[269])( );     /*QUADRI6(100,22,102,jvj+29,jvj+28,jvj+8)*/
pile[WZ2]=111; pile[WZ3]=jvj+5; pile[WZ4]=jvj+4; 
(*f[181])( );     /*QUADRI2(100,22,111,jvj+5,jvj+4)*/
pile[v[22]]=jvj+4; pile[WZ1]=107; pile[WZ2]=jvj+6; 
(*f[36])( );     /*PLUSC0(jvj+4,107,jvj+6)*/
pile[WZ2]=jvj+7; 
(*f[36])( );     /*PLUSC0(jvj+4,107,jvj+7)*/
pile[WZ2]=jvj+8; 
