...
l5:pile[v[22]]=I; pile[WZ1]=(-630); 
(*f[201])( );if(v[102]) goto l4;     /*FCOEFF0(I,(-630),V7)*/
V7=pile[WZ2]; 
x[jvj+2]=0 ;z[jvj+2]=0;
pile[WZ1]=(-620); 
(*f[3979])( );if(v[102]) goto l6;     /*LONGUEUR0(I,(-620),V5)*/
V5=pile[WZ2]; 
J=1;
l1:if((J>V5)) goto l6;
pile[v[22]]=J; pile[WZ1]=I; pile[WZ2]=(-620); 
(*f[203])( );if(v[102]) goto l2;     /*FTAB0(J,I,(-620),V6)*/
V6=pile[WZ3]; 
