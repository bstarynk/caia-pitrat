...
V2=tt[K];
x[jvj+23]=V2 ;z[jvj+23]=(V2<=sepcte) ? V2 : 0;
x[jvj+1]=x[jvj+23] ;z[jvj+1]=z[jvj+23];
...
(*f[26])( );if(v[102]) goto l4;     /*FNDC0(855,jvj+1,NT)*/
NT=pile[WZ2]; 
l64:V69=tp[K];
V3=incon;
if((x[jvj+1]!=576)) goto l5;
V72=ta1[K];
x[jvj+2]=V72 ;z[jvj+2]=(V72<=sepcte) ? V72 : 0;
pile[v[22]]=929; pile[WZ1]=jvj+2; 
(*f[26])( );if(v[102]) goto l5;     /*FNDC0(929,jvj+2,YA)*/
YA=pile[WZ2]; 
...
;
V7=incon;
if((x[jvj+1]!=489)) goto l6;
V79=tn[K];
if((K!=V79)) goto l6;
pile[v[22]]=50; pile[WZ1]=V3; pile[WZ2]=42; 
(*f[41])( );     /*SRB0(50,V3,42,V158)*/
V158=pile[WZ3]; 
...
(*f[342])( );     /*SLG2(V269,3)*/
l66:pile[v[22]]=41; pile[WZ1]=K; pile[WZ2]=V7; 
...
if((NT<=0)) goto l15;
V83=ta1[K];
pile[v[22]]=849; pile[WZ1]=jvj+1; pile[WZ2]=jvj+6; 
(*f[32])( );if(v[102]) goto l15;     /*FNDO0(849,jvj+1,jvj+6)*/
V17=incon;
if((x[jvj+6]!=20)) goto l11;
x[jvj+4]=V83 ;z[jvj+4]=(V83<=sepcte) ? V83 : 0;
pile[v[22]]=642; pile[WZ1]=jvj+4; 
(*f[26])( );if(v[102]) goto l11;     /*FNDC0(642,jvj+4,C)*/
C=pile[WZ2]; 
...
V17=pile[WZ2]; 
l13:pile[v[22]]=jvj+6; pile[WZ1]=V83; pile[WZ2]=V17; 
(*f[39])( );     /*SDX0(jvj+6,V83,V17,V20)*/
V20=pile[WZ3]; 
V19=incon;
if((x[jvj+6]!=20)) goto l12;
x[jvj+5]=V83 ;z[jvj+5]=(V83<=sepcte) ? V83 : 0;
pile[v[22]]=929; pile[WZ1]=jvj+5; 
(*f[26])( );if(v[102]) goto l12;     /*FNDC0(929,jvj+5,NC)*/
NC=pile[WZ2]; 
...
if((NT<=1)) goto l19;
V93=ta2[K];
pile[v[22]]=852; pile[WZ1]=jvj+1; pile[WZ2]=jvj+8; 
(*f[32])( );if(v[102]) goto l19;     /*FNDO0(852,jvj+1,jvj+8)*/
pile[v[22]]=jvj+8; pile[WZ1]=V93; pile[WZ2]=V15; 
(*f[39])( );     /*SDX0(jvj+8,V93,V15,V24)*/
V24=pile[WZ3]; 
V23=incon;
if((x[jvj+8]!=20)) goto l17;
x[jvj+7]=V93 ;z[jvj+7]=(V93<=sepcte) ? V93 : 0;
pile[v[22]]=929; pile[WZ1]=jvj+7; 
(*f[26])( );if(v[102]) goto l17;     /*FNDC0(929,jvj+7,NF)*/
NF=pile[WZ2]; 
...
V96=ta1[K];
V95=tnd[M][0];
x[jvj+11]=V95 ;z[jvj+11]=(V95<=sepcte) ? V95 : 0;
V102=vnd[M][0];
V101=V102;
...
V28=pile[WZ2]; 
V27=incon;
if((x[jvj+11]!=20)) goto l21;
x[jvj+9]=V96 ;z[jvj+9]=(V96<=sepcte) ? V96 : 0;
pile[v[22]]=642; pile[WZ1]=jvj+9; 
(*f[26])( );if(v[102]) goto l21;     /*FNDC0(642,jvj+9,D)*/
D=pile[WZ2]; 
...
V27=pile[WZ2]; 
l23:pile[v[22]]=jvj+11; pile[WZ1]=V96; pile[WZ2]=V27; 
(*f[39])( );     /*SDX0(jvj+11,V96,V27,V30)*/
V30=pile[WZ3]; 
V29=incon;
if((x[jvj+11]!=20)) goto l22;
x[jvj+10]=V96 ;z[jvj+10]=(V96<=sepcte) ? V96 : 0;
pile[v[22]]=929; pile[WZ1]=jvj+10; 
(*f[26])( );if(v[102]) goto l22;     /*FNDC0(929,jvj+10,ND)*/
ND=pile[WZ2]; 
...
V105=ta2[K];
V104=tnd[M][1];
x[jvj+14]=V104 ;z[jvj+14]=(V104<=sepcte) ? V104 : 0;
V111=vnd[M][1];
V110=V111;
R=0;
...
V34=pile[WZ2]; 
V33=incon;
if((x[jvj+14]!=20)) goto l27;
x[jvj+12]=V105 ;z[jvj+12]=(V105<=sepcte) ? V105 : 0;
pile[v[22]]=642; pile[WZ1]=jvj+12; 
(*f[26])( );if(v[102]) goto l27;     /*FNDC0(642,jvj+12,V106)*/
V106=pile[WZ2]; 
if((R!=V106)) goto l27;
...
V33=pile[WZ2]; 
l29:pile[v[22]]=jvj+14; pile[WZ1]=V105; pile[WZ2]=V33; 
(*f[39])( );     /*SDX0(jvj+14,V105,V33,V36)*/
V36=pile[WZ3]; 
V35=incon;
if((x[jvj+14]!=20)) goto l28;
x[jvj+13]=V105 ;z[jvj+13]=(V105<=sepcte) ? V105 : 0;
pile[v[22]]=929; pile[WZ1]=jvj+13; 
(*f[26])( );if(v[102]) goto l28;     /*FNDC0(929,jvj+13,NE)*/
NE=pile[WZ2]; 
...
if((NT<=2)) goto l33;
V113=tnd[M][2];
x[jvj+15]=V113 ;z[jvj+15]=(V113<=sepcte) ? V113 : 0;
V114=ta3[K];
V116=vnd[M][2];
V115=V116;
...
V207=pile[WZ2]; 
pile[v[22]]=jvj+15; pile[WZ1]=V114; pile[WZ2]=V207; 
(*f[39])( );     /*SDX0(jvj+15,V114,V207,V208)*/
V208=pile[WZ3]; 
...
if((NT<=3)) goto l35;
V118=tnd[M][3];
x[jvj+16]=V118 ;z[jvj+16]=(V118<=sepcte) ? V118 : 0;
V119=ta4[K];
V121=vnd[M][3];
V120=V121;
...
V213=pile[WZ2]; 
pile[v[22]]=jvj+16; pile[WZ1]=V119; pile[WZ2]=V213; 
(*f[39])( );     /*SDX0(jvj+16,V119,V213,V214)*/
V214=pile[WZ3]; 
...
if((NT<=4)) goto l37;
V123=tnd[M][4];
x[jvj+17]=V123 ;z[jvj+17]=(V123<=sepcte) ? V123 : 0;
V124=ta5[K];
V126=vnd[M][4];
V125=V126;
...
V219=pile[WZ2]; 
pile[v[22]]=jvj+17; pile[WZ1]=V124; pile[WZ2]=V219; 
(*f[39])( );     /*SDX0(jvj+17,V124,V219,V220)*/
V220=pile[WZ3]; 
...
V127=ta1[K];
if((V127<=0)) goto l43;
x[jvj+18]=V127 ;z[jvj+18]=(V127<=sepcte) ? V127 : 0;
V45=incon;
pile[v[22]]=642; pile[WZ1]=jvj+18; 
(*f[26])( );if(v[102]) goto l39;     /*FNDC0(642,jvj+18,F)*/
F=pile[WZ2]; 
...
V48=pile[WZ3]; 
V47=incon;
pile[v[22]]=929; pile[WZ1]=jvj+18; 
(*f[26])( );if(v[102]) goto l40;     /*FNDC0(929,jvj+18,NG)*/
NG=pile[WZ2]; 
...
V131=ta2[K];
if((V131<=0)) goto l49;
x[jvj+19]=V131 ;z[jvj+19]=(V131<=sepcte) ? V131 : 0;
V51=incon;
pile[v[22]]=642; pile[WZ1]=jvj+19; 
(*f[26])( );if(v[102]) goto l45;     /*FNDC0(642,jvj+19,G)*/
G=pile[WZ2]; 
...
(*f[26])( );if(v[102]) goto l46;     /*FNDC0(929,jvj+19,NH)*/
NH=pile[WZ2]; 
...
V135=ta3[K];
if((V135<=0)) goto l55;
x[jvj+20]=V135 ;z[jvj+20]=(V135<=sepcte) ? V135 : 0;
V57=incon;
pile[v[22]]=642; pile[WZ1]=jvj+20; 
(*f[26])( );if(v[102]) goto l51;     /*FNDC0(642,jvj+20,H)*/
H=pile[WZ2]; 
...
(*f[26])( );if(v[102]) goto l52;     /*FNDC0(929,jvj+20,NI)*/
NI=pile[WZ2]; 
...
V139=ta4[K];
if((V139<=0)) goto l59;
x[jvj+21]=V139 ;z[jvj+21]=(V139<=sepcte) ? V139 : 0;
V63=incon;
pile[v[22]]=642; pile[WZ1]=jvj+21; 
(*f[26])( );if(v[102]) goto l57;     /*FNDC0(642,jvj+21,I)*/
I=pile[WZ2]; 
...
V142=ta5[K];
if((V142<=0)) goto l63;
x[jvj+22]=V142 ;z[jvj+22]=(V142<=sepcte) ? V142 : 0;
V67=incon;
pile[v[22]]=642; pile[WZ1]=jvj+22; 
(*f[26])( );if(v[102]) goto l61;     /*FNDC0(642,jvj+22,J)*/
J=pile[WZ2]; 
...
l6:V7=V3;
goto l66;
l7:x[jvj+3]=V69 ;z[jvj+3]=(V69<=sepcte) ? V69 : 0;
pile[v[22]]=135; pile[WZ1]=V10; pile[WZ2]=jvj+3; 
(*f[42])( );     /*SRA1(135,V10,jvj+3,V9)*/
V9=pile[WZ3]; 
goto l8;
l9:V165=BL;
