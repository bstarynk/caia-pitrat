...
{int V2=0,V1=0,V8=0,V7=0,V6=0,RX=0,V9=0,XN=0,V3=0,V4=0,V5=0,V27=0,V48=0,V47=0,V33=0,V34=0,V38=0,V40=0,V44=0,V52=0,V50=0,V54=0,V51=0;
int X,ATT,XT;
int WZ1,WZ2,WZ3;
int jvj;
jvj=v[0];
...
pile[v[22]]=X; 
(*f[59])( );     /*LECT0(X)*/
l1:if((V8=w[x[ATT]][2])==incon) goto l2;
V7=V8;
V6=(-V7);
RX=V6;
l2:V9=XT;
