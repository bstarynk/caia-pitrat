...
(*f[32])( );if(v[102]) goto l9;     /*FNDO0(1142,R,jvj+11)*/
if((x[jvj+11]!=68)) goto l9;
pile[v[22]]=870; 
(*f[26])( );if(v[102]) goto l9;     /*FNDC0(870,R,V4)*/
V4=pile[WZ2]; 
...
if((x[jvj+14]!=55)) goto l7;
pile[v[22]]=870; pile[WZ1]=jvj+12; 
(*f[26])( );if(v[102]) goto l7;     /*FNDC0(870,jvj+12,V5)*/
V5=pile[WZ2]; 
if((V4>V5)) goto l7;
