...
{int I=0,V5=0,L=0,V13=0,V3=0,V8=0,J=0,V9=0,V15=0,V16=0,V10=0,V17=0;
int NK;
int NNNE;
...
(*f[26])( );if(v[102]) goto l8;     /*FNDC0(117,jvj+5,V16)*/
V16=pile[WZ2]; 
V10=V16;
x[jvj+3]=0 ;z[jvj+3]=0;
...
l4:J++;
goto l3;
l6:pile[v[22]]=jvj+5; pile[WZ1]=117; pile[WZ2]=V15; 
(*f[186])( );     /*BTC0(jvj+5,117,V15)*/
V15++;
goto l5;
...
pile[v[22]]=100; pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V17; pile[WZ4]=jvj+17; 
(*f[192])( );     /*QUADRI4(100,41,130,V17,jvj+17)*/
