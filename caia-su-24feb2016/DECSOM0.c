...
x[E]=x[jvj+20] ;z[E]=z[jvj+20];
pile[v[22]]=67; pile[WZ1]=447; pile[WZ2]=H; 
(*f[54])( );     /*TRI1(67,447,H)*/
...
(*f[1667])( );     /*DECOMP0(R,H,jvj+13,V8)*/
V8=pile[WZ3]; 
pile[v[22]]=117; pile[WZ1]=V8; pile[WZ2]=218; pile[WZ3]=jvj+13; pile[WZ4]=jvj+14; 
(*f[567])( );     /*QUADRI11(117,V8,218,jvj+13,jvj+14)*/
pile[v[22]]=E; pile[WZ1]=jvj+14; 
(*f[522])( );     /*PLUB2(E,jvj+14)*/
l5:x[jvj+21]=x[E] ;z[jvj+21]=z[E];
