...
{int Y=0,V9=0,V16=0,V19=0,V20=0,I=0;
int A;
int R;
int WZ1,WZ2,WZ3,WZ4;
int jvj;
...
pile[v[22]]=117; pile[WZ1]=I; pile[WZ2]=1410; pile[WZ3]=V16; pile[WZ4]=jvj+4; 
(*f[391])( );     /*QUADRI10(117,I,1410,V16,jvj+4)*/
...
(*f[26])( );if(v[102]) goto l4;     /*FNDC0(1410,jvj+2,V19)*/
V19=pile[WZ2]; 
V20=V19;
l9:x[jvj+10]=d[150];z[jvj+10]=0;
pile[v[22]]=176; pile[WZ1]=jvj+2; pile[WZ2]=1410; pile[WZ3]=V20; pile[WZ4]=jvj+11; 
(*f[192])( );     /*QUADRI4(176,jvj+2,1410,V20,jvj+11)*/
pile[v[22]]=jvj+10; pile[WZ1]=jvj+11; pile[WZ2]=R; 
(*f[196])( );     /*PLUF0(jvj+10,jvj+11,R)*/
l10:x[jvj+18]=w[x[jvj+5]][9];
l11:if((x[jvj+18]>0)) goto l12;
x[jvj+19]=w[x[jvj+5]][8];
l14:if((x[jvj+19]<=0)) goto l17;
x[jvj+14]=s[x[jvj+19]] ;z[jvj+14]=(x[jvj+14]<=sepcte) ? x[jvj+14] : z[jvj+19];
pile[v[22]]=jvj+14; pile[WZ1]=A; pile[WZ2]=jvj+15; 
(*f[33])( );     /*FNDE0(jvj+14,A,jvj+15)*/
x[jvj+20]=x[jvj+15] ;z[jvj+20]=z[jvj+15];
l15:if((x[jvj+20]>0)) goto l16;
x[jvj+19]=t[x[jvj+19]];
goto l14;
l1:V9=150;
l8:x[jvj+7]=d[150];z[jvj+7]=0;
pile[v[22]]=176; pile[WZ1]=jvj+1; pile[WZ2]=1410; pile[WZ3]=V9; pile[WZ4]=jvj+8; 
(*f[192])( );     /*QUADRI4(176,jvj+1,1410,V9,jvj+8)*/
