...
{int V1=0;
int ZZG,ZZBL,ZZN,OS1,O1,NS1,N1,OS2,O2,OS3,O3,OS4,O4;
int RES;
...
ZZG=pile[v[22]]; ZZBL=pile[v[22]+1]; ZZN=pile[v[22]+2]; OS1=pile[v[22]+3]; O1=pile[v[22]+4]; NS1=pile[v[22]+5]; N1=pile[v[22]+6]; OS2=pile[v[22]+7]; O2=pile[v[22]+8]; OS3=pile[v[22]+9]; O3=pile[v[22]+10]; OS4=pile[v[22]+11]; O4=pile[v[22]+12]; RES=pile[v[22]+13]; v[22]+=14; 
...
pile[v[22]]=101; pile[WZ1]=O4; pile[WZ2]=140; pile[WZ3]=OS4; pile[WZ4]=jvj+19; pile[WZ5]=jvj+6; 
(*f[599])( );     /*QUADRI12(101,O4,140,OS4,jvj+19,jvj+6)*/
