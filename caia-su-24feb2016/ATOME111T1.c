...
{int V16=0,V1=0,V17=0,V23=0,V22=0,V21=0,V2=0;
int R;
...
(*f[32])( );if(v[102]) goto l19;     /*FNDO0(111,R,jvj+23)*/
...
(*f[32])( );if(v[102]) goto l15;     /*FNDO0(869,R,jvj+3)*/
if((x[jvj+3]==769)) goto l19;
l15:pile[v[22]]=929; pile[WZ1]=R; 
(*f[1975])( );if(v[102]) goto l19;     /*FNDCND0(929,R,V16)*/
V16=pile[WZ2]; 
...
pile[v[22]]=R; 
(*f[981])( );if(v[102]) goto l19;     /*CPTVAR0(R,V1)*/
V1=pile[WZ1]; 
if((V1<=6)) goto l16;
...
if((x[R]==x[jvj+4])) goto l17;
pile[v[22]]=111; pile[WZ1]=jvj+4; pile[WZ2]=jvj+28; 
(*f[32])( );if(v[102]) goto l17;     /*FNDO0(111,jvj+4,jvj+28)*/
pile[v[22]]=101; pile[WZ1]=jvj+28; pile[WZ2]=jvj+29; 
(*f[32])( );if(v[102]) goto l17;     /*FNDO0(101,jvj+28,jvj+29)*/
if((x[jvj+29]!=25)) goto l17;
pile[v[22]]=869; pile[WZ1]=jvj+4; pile[WZ2]=jvj+5; 
(*f[32])( );if(v[102]) goto l18;     /*FNDO0(869,jvj+4,jvj+5)*/
if((x[jvj+5]==769)) goto l17;
l18:pile[v[22]]=929; pile[WZ1]=jvj+4; 
(*f[1975])( );if(v[102]) goto l17;     /*FNDCND0(929,jvj+4,V17)*/
V17=pile[WZ2]; 
if((V16>=V17)) goto l17;
