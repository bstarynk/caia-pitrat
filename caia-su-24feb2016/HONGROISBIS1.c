...
{int I=0,V10=0,V3=0,V8=0,MM=0,V7=0,K=0,L=0;
int N,P;
int NNNE;
...
x[jvj+5]=0 ;z[jvj+5]=0;
V10=N-1;
pile[v[22]]=30; pile[WZ1]=2; pile[WZ2]=V10; 
(*f[1005])( );if(v[102]) goto l7;     /*RACN0(30,2,V10,V3)*/
V3=pile[WZ3]; 
V8=P-1;
MM=1;
l3:if((MM>V3)) goto l7;
...
pile[v[22]]=100; pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=26; pile[WZ4]=jvj+10; 
...
pile[v[22]]=100; pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V7; pile[WZ4]=jvj+12; 
...
l6:L=K;
goto l5;
l7:x[NNNE]=x[jvj+5] ;z[NNNE]=z[jvj+5];
l8:x[jvj+1]=incon; v[0]=jvj; v[22]-=3; return;
l9:pile[v[22]]=100; pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-1544); pile[WZ4]=jvj+7; 
(*f[270])( );     /*QUADRI7(100,21,140,(-1544),jvj+7)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=I; pile[WZ4]=jvj+9; 
(*f[192])( );     /*QUADRI4(100,41,130,I,jvj+9)*/
