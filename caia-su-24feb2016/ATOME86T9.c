...
(*f[3109])( );if(v[102]) goto l4;     /*INFG0(DX,jvj+13,jvj+14)*/
...
(*f[3108])( );if(v[102]) goto l4;     /*SUPG0(DX,jvj+15,jvj+16)*/
...
pile[v[22]]=jvj+20; pile[WZ1]=3367; pile[WZ2]=246; pile[WZ3]=jvj+21; 
(*f[189])( );     /*TRI4(jvj+20,3367,246,jvj+21)*/
