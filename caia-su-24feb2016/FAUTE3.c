...
{int V3=0,V6=0,V1=0,V2=0,V4=0,V5=0,V8=0,V7=0,V12=0,V9=0,V10=0,V11=0;
int BL,S,R,BK,V;
int WZ1,WZ2,WZ3;

BL=pile[v[22]]; S=pile[v[22]+1]; R=pile[v[22]+2]; BK=pile[v[22]+3]; V=pile[v[22]+4]; v[22]+=5; 
...
(*f[37])( );     /*SRA0(0,V,V9)*/
V9=pile[WZ2]; 
pile[v[22]]=V9; pile[WZ1]=S; 
(*f[37])( );     /*SRA0(V9,S,V10)*/
V10=pile[WZ2]; 
pile[v[22]]=20; pile[WZ1]=V12; pile[WZ2]=V10; 
(*f[39])( );     /*SDX0(20,V12,V10,V11)*/
V11=pile[WZ3]; 
pile[v[22]]=V11; 
(*f[40])( );     /*SLG0(V11)*/
v[22]-=5; return;
