...
{int V1=0;
int ZZG,ZZBL,ZZN,OS1,O1,OS2,O2,NS1,N1;
int RES;
...
ZZG=pile[v[22]]; ZZBL=pile[v[22]+1]; ZZN=pile[v[22]+2]; OS1=pile[v[22]+3]; O1=pile[v[22]+4]; OS2=pile[v[22]+5]; O2=pile[v[22]+6]; NS1=pile[v[22]+7]; N1=pile[v[22]+8]; RES=pile[v[22]+9]; v[22]+=10; 
...
pile[v[22]]=130; pile[WZ1]=N1; pile[WZ2]=140; pile[WZ3]=NS1; pile[WZ4]=jvj+13; pile[WZ5]=jvj+4; 
(*f[197])( );     /*QUADRI5(130,N1,140,NS1,jvj+13,jvj+4)*/
