...
{int V10=0,V1=0,V2=0,V3=0,V4=0,V21=0,V25=0,V35=0,V16=0,V43=0,V37=0,V38=0,V39=0,V40=0;
int N,F,KR,UR;
...
N=pile[v[22]]; F=pile[v[22]+1]; KR=pile[v[22]+2]; UR=pile[v[22]+3]; v[22]+=4; 
...
if((V16=w[x[jvj+29]][1])==incon) goto l22;
if((V16!=23)) goto l22;
pile[v[22]]=N; 
(*f[413])( );     /*LREEC0(N)*/
...
pile[WZ1]=0; pile[WZ2]=V10; pile[WZ3]=184; 
(*f[285])( );     /*ENLY0(jvj+5,0,V10,184,V1,V2)*/
V1=pile[WZ4]; V2=pile[WZ5]; 
pile[WZ1]=V2; pile[WZ2]=V1; pile[WZ3]=565; 
(*f[285])( );     /*ENLY0(jvj+5,V2,V1,565,V3,V4)*/
...
(*f[26])( );if(v[102]) goto l17;     /*FNDC0(130,jvj+22,V35)*/
V35=pile[WZ2]; 
...
pile[v[22]]=V35; pile[WZ1]=jvj+20; pile[WZ2]=jvj+26; 
(*f[235])( );     /*PLUSC2(V35,jvj+20,jvj+26)*/
x[jvj+34]=t[x[jvj+34]];
goto l20;
l11:V21++;
goto l10;
l12:V25=r[V21];
if((V25!=1)) goto l11;
x[jvj+15]=V21 ;z[jvj+15]=(V21<=sepcte) ? V21 : 0;
...
pile[WZ1]=0; pile[WZ2]=V43; pile[WZ3]=184; 
(*f[285])( );     /*ENLY0(jvj+31,0,V43,184,V37,V38)*/
V37=pile[WZ4]; V38=pile[WZ5]; 
pile[WZ1]=V38; pile[WZ2]=V37; pile[WZ3]=565; 
(*f[285])( );     /*ENLY0(jvj+31,V38,V37,565,V39,V40)*/
