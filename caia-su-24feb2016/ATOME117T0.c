...
{int V17=0,V2=0,I=0,V18=0;
int R;
int WZ1,WZ2,WZ3,WZ4;
int jvj;
jvj=v[0];
v[0]+=19;
x[jvj+1]=20117;z[jvj+1]=(-100);
if(v[0]>99700) (*f[6])( );
if(v[90]==3543&&v[97]==0) {
...
pile[v[22]]=jvj+15; pile[WZ1]=3543; pile[WZ2]=246; pile[WZ3]=jvj+16; 
(*f[189])( );     /*TRI4(jvj+15,3543,246,jvj+16)*/
pile[v[22]]=jvj+16; pile[WZ1]=20117; pile[WZ2]=218; pile[WZ3]=jvj+17; 
(*f[58])( );     /*TRI3(jvj+16,20117,218,jvj+17)*/
...
pile[v[22]]=jvj+13; pile[WZ1]=280; pile[WZ2]=jvj+12; pile[WZ3]=V2; 
(*f[2056])( );     /*VAUT0(jvj+13,280,jvj+12,V2)*/
