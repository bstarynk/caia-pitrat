...
if((x[jvj+7]!=30)) goto l3;
pile[v[22]]=869; pile[WZ1]=R; pile[WZ2]=jvj+8; 
(*f[32])( );if(v[102]) goto l3;     /*FNDO0(869,R,jvj+8)*/
...
(*f[1948])( );if(v[102]) goto l3;     /*FNDOND0(498,jvj+9,jvj+10)*/
pile[v[22]]=1182; pile[WZ1]=jvj+10; pile[WZ2]=jvj+11; 
(*f[32])( );if(v[102]) goto l3;     /*FNDO0(1182,jvj+10,jvj+11)*/
if((68!=x[jvj+11])) goto l3;
pile[v[22]]=102; pile[WZ1]=R; pile[WZ2]=jvj+12; 
(*f[32])( );if(v[102]) goto l3;     /*FNDO0(102,R,jvj+12)*/
pile[v[22]]=103; pile[WZ2]=jvj+13; 
(*f[32])( );if(v[102]) goto l3;     /*FNDO0(103,R,jvj+13)*/
x[jvj+4]=0 ;z[jvj+4]=0;
...
x[jvj+20]=s[x[jvj+4]] ;z[jvj+20]=(x[jvj+20]<=sepcte) ? x[jvj+20] : z[jvj+4];
...
pile[v[22]]=jvj+16; pile[WZ1]=3367; pile[WZ2]=246; pile[WZ3]=jvj+17; 
(*f[189])( );     /*TRI4(jvj+16,3367,246,jvj+17)*/
