...
(*f[32])( );if(v[102]) goto l6;     /*FNDO0(103,R,jvj+7)*/
...
if(x[jvj+9]!=25&&x[jvj+9]!=29&&x[jvj+9]!=30) goto l6;
V1=incon;
if((x[jvj+9]!=29)) goto l1;
V21=L-1;
V1=V21;
l1:if(x[jvj+9]==25||x[jvj+9]==30) goto l2;
if(V1==incon) goto l6;
l4:if((V1==(-99999998))) goto l6;
pile[v[22]]=102; pile[WZ1]=R; pile[WZ2]=jvj+10; 
(*f[32])( );if(v[102]) goto l6;     /*FNDO0(102,R,jvj+10)*/
...
pile[v[22]]=jvj+21; pile[WZ1]=3322; pile[WZ2]=246; pile[WZ3]=jvj+22; 
(*f[189])( );     /*TRI4(jvj+21,3322,246,jvj+22)*/
pile[v[22]]=158; pile[WZ1]=1; pile[WZ2]=218; pile[WZ3]=20010; pile[WZ4]=jvj+22; pile[WZ5]=jvj+18; 
(*f[269])( );     /*QUADRI6(158,1,218,20010,jvj+22,jvj+18)*/
