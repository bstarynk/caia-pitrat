...
{int J=0,V14=0,V13=0,V7=0,V10=0,Q=0,V9=0,V8=0,V6=0,I=0;
int K,N;
int NNNE;
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-624); pile[WZ4]=jvj+23; 
(*f[270])( );     /*QUADRI7(100,21,140,(-624),jvj+23)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=Q; pile[WZ4]=jvj+25; 
(*f[192])( );     /*QUADRI4(100,41,130,Q,jvj+25)*/
...
pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=48; pile[WZ4]=jvj+26; 
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V13; pile[WZ4]=jvj+14; 
(*f[192])( );     /*QUADRI4(100,41,130,V13,jvj+14)*/
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=Q; pile[WZ4]=jvj+9; 
(*f[192])( );     /*QUADRI4(100,41,130,Q,jvj+9)*/
