...
for(a=x[jvj+4];a>0;a=t[a]) if(s[a]==27) goto l2;
...
pile[v[22]]=jvj+7; pile[WZ1]=3195; pile[WZ2]=246; pile[WZ3]=jvj+8; 
(*f[189])( );     /*TRI4(jvj+7,3195,246,jvj+8)*/
pile[v[22]]=jvj+8; pile[WZ1]=20043; pile[WZ2]=218; pile[WZ3]=jvj+9; 
(*f[58])( );     /*TRI3(jvj+8,20043,218,jvj+9)*/
