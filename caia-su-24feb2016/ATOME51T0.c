...
(*f[1948])( );if(v[102]) goto l5;     /*FNDOND0(498,jvj+2,jvj+10)*/
...
pile[v[22]]=jvj+13; pile[WZ1]=3045; pile[WZ2]=246; pile[WZ3]=jvj+14; 
(*f[189])( );     /*TRI4(jvj+13,3045,246,jvj+14)*/
...
pile[WZ1]=164; pile[WZ2]=jvj+2; pile[WZ3]=V1; 
(*f[2056])( );     /*VAUT0(jvj+11,164,jvj+2,V1)*/
