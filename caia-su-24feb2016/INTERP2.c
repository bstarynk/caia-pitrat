...
{int V1=0;
int ZZG,ZZBL,ZZN,OS1,O1,SS1,S1;
int RES;
...
ZZG=pile[v[22]]; ZZBL=pile[v[22]+1]; ZZN=pile[v[22]+2]; OS1=pile[v[22]+3]; O1=pile[v[22]+4]; SS1=pile[v[22]+5]; S1=pile[v[22]+6]; RES=pile[v[22]+7]; v[22]+=8; 
