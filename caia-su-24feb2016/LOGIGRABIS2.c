...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-733); pile[WZ4]=jvj+20; 
(*f[270])( );     /*QUADRI7(100,21,140,(-733),jvj+20)*/
...
goto l11;
l6:V20=JJ+V23;
pile[v[22]]=100; pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-733); pile[WZ4]=jvj+8; 
(*f[270])( );     /*QUADRI7(100,21,140,(-733),jvj+8)*/
...
l9:I++;
goto l8;
l10:pile[v[22]]=1; pile[WZ1]=I; pile[WZ2]=(-1859); 
(*f[203])( );if(v[102]) goto l9;     /*FTAB0(1,I,(-1859),V8)*/
V8=pile[WZ3]; 
if((V8<=0)) goto l9;
pile[v[22]]=I; pile[WZ1]=(-1859); 
(*f[3979])( );if(v[102]) goto l9;     /*LONGUEUR0(I,(-1859),V3)*/
V3=pile[WZ2]; 
N=V3;
V15=N-1;
...
pile[v[22]]=I; pile[WZ1]=(-1859); 
(*f[3979])( );if(v[102]) goto l3;     /*LONGUEUR0(I,(-1859),V6)*/
V6=pile[WZ2]; 
II=1;
l1:if((II>V6)) goto l3;
pile[v[22]]=II; pile[WZ1]=I; pile[WZ2]=(-1859); 
(*f[203])( );if(v[102]) goto l2;     /*FTAB0(II,I,(-1859),V7)*/
V7=pile[WZ3]; 
