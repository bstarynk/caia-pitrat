...
(*f[1969])( );     /*FNDEND0(365,jvj+2,jvj+7)*/
...
(*f[1738])( );if(v[102]) goto l7;     /*EVLM0(R,jvj+2,jvj+8,V1)*/
V1=pile[WZ3]; 
if((V1!=134)) goto l7;
...
pile[v[22]]=jvj+11; pile[WZ1]=3127; pile[WZ2]=246; pile[WZ3]=jvj+12; 
(*f[189])( );     /*TRI4(jvj+11,3127,246,jvj+12)*/
...
(*f[1569])( );     /*DELIER0(365,jvj+2,jvj+8,jvj+9)*/
...
(*f[1975])( );if(v[102]) goto l4;     /*FNDCND0(472,jvj+3,V6)*/
V6=pile[WZ2]; 
if((V6==1)) goto l6;
