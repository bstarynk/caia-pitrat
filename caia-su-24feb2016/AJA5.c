...
K=pile[v[22]]; V=pile[v[22]+1]; AT=pile[v[22]+2]; RL=pile[v[22]+3]; T=pile[v[22]+4]; G=pile[v[22]+5]; v[22]+=6; 
...
pile[v[22]]=145; pile[WZ1]=RL; pile[WZ2]=201; pile[WZ3]=G; pile[WZ4]=jvj+9; pile[WZ5]=jvj+5; 
(*f[269])( );     /*QUADRI6(145,RL,201,G,jvj+9,jvj+5)*/
