...
N=pile[v[22]]; NK=pile[v[22]+1]; NNNE=pile[v[22]+2]; v[22]+=3; 
...
pile[v[22]]=100; pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=NK; pile[WZ4]=jvj+12; 
(*f[192])( );     /*QUADRI4(100,41,130,NK,jvj+12)*/
