...
(*f[1975])( );if(v[102]) goto l5;     /*FNDCND0(929,jvj+2,V25)*/
V25=pile[WZ2]; 
...
pile[v[22]]=jvj+37; pile[WZ1]=3870; pile[WZ2]=246; pile[WZ3]=jvj+38; 
(*f[189])( );     /*TRI4(jvj+37,3870,246,jvj+38)*/
...
(*f[1296])( );     /*NOUVCONTR0(jvj+3,jvj+21)*/
goto l2;
