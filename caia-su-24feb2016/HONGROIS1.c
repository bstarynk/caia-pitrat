...
{int V6=0,V2=0,K=0,V4=0,J=0,V5=0;
int N,P;
int NNNE;
...
x[jvj+2]=0 ;z[jvj+2]=0;
V6=N-1;
pile[v[22]]=30; pile[WZ1]=2; pile[WZ2]=V6; 
(*f[1005])( );if(v[102]) goto l5;     /*RACN0(30,2,V6,V2)*/
V2=pile[WZ3]; 
K=1;
l1:if((K>V2)) goto l5;
V4=K*K;
...
J++;
goto l2;
l5:x[NNNE]=x[jvj+2] ;z[NNNE]=z[jvj+2];
l6:x[jvj+1]=incon; v[0]=jvj; v[22]-=3; return;
l7:pile[v[22]]=100; pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=26; pile[WZ4]=jvj+4; 
