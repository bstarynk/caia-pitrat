...
l1:pile[v[22]]=473; pile[WZ1]=N; 
(*f[1975])( );if(v[102]) goto l4;     /*FNDCND0(473,N,V3)*/
V3=pile[WZ2]; 
pile[v[22]]=498; pile[WZ1]=D; pile[WZ2]=jvj+4; 
(*f[1948])( );if(v[102]) goto l4;     /*FNDOND0(498,D,jvj+4)*/
...
pile[v[22]]=jvj+11; pile[WZ1]=3070; pile[WZ2]=246; pile[WZ3]=jvj+12; 
(*f[189])( );     /*TRI4(jvj+11,3070,246,jvj+12)*/
