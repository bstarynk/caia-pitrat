...
{int I=0,DKK=0,DK=0,V1=0,V2=0,JJ=0,V6=0,V5=0,V8=0,V7=0,N=0,V19=0,V10=0,V12=0,V11=0,V13=0,V15=0,V16=0,V17=0;
int J,DK1,DK2;
int WZ1,WZ2,WZ3;

J=pile[v[22]]; DK1=pile[v[22]+1]; DK2=pile[v[22]+2]; v[22]+=3; 
