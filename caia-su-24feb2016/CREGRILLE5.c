...
NT=pile[v[22]]; A=pile[v[22]+1]; NNNE=pile[v[22]+2]; v[22]+=3; 
...
l3:for(a=x[A];a>0;a=t[a]) if(s[a]==I) goto l2;
pile[v[22]]=100; pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=962; pile[WZ4]=jvj+4; 
...
pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=134; pile[WZ4]=jvj+6; 
