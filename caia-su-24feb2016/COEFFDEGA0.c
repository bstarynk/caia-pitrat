...
{int D=0,K=0,II=0,V4=0,V39=0,V10=0,V13=0,V6=0,V26=0,V19=0,V59=0,V52=0,V68=0,V81=0,V74=0,V90=0,KK=0,V102=0,V96=0,V97=0,V98=0;
int XA,RS,P;
int WZ1,WZ2;
int jvj;
jvj=v[0];
...
XA=pile[v[22]]; RS=pile[v[22]+1]; P=pile[v[22]+2]; v[22]+=3; 
...
D=1;
l1:K=1;
l27:pile[v[22]]=763; pile[WZ1]=RS; pile[WZ2]=jvj+29; 
(*f[33])( );     /*FNDE0(763,RS,jvj+29)*/
l28:if((x[jvj+29]>0)) goto l29;
pile[v[22]]=D; pile[WZ1]=117; pile[WZ2]=jvj+31; 
(*f[46])( );     /*TRI0(D,117,jvj+31)*/
pile[v[22]]=RS; pile[WZ1]=763; 
(*f[36])( );     /*PLUSC0(RS,763,jvj+31)*/
l31:V97=incon;
if((x[P]==36)) goto l32;
V98=(-K);
V97=V98;
l33:pile[v[22]]=jvj+31; pile[WZ1]=510; pile[WZ2]=V97; 
(*f[186])( );     /*BTC0(jvj+31,510,V97)*/
l34:v[0]=jvj; v[22]-=3; return;
...
(*f[32])( );if(v[102]) goto l34;     /*FNDO0(111,XA,jvj+2)*/
pile[v[22]]=101; pile[WZ1]=jvj+2; pile[WZ2]=jvj+3; 
(*f[32])( );if(v[102]) goto l34;     /*FNDO0(101,jvj+2,jvj+3)*/
if((x[jvj+3]==596)) goto l5;
if((x[jvj+3]==486)) goto l7;
if((x[jvj+3]!=52)) goto l34;
...
(*f[32])( );if(v[102]) goto l34;     /*FNDO0(103,XA,jvj+4)*/
pile[v[22]]=130; pile[WZ1]=jvj+4; 
(*f[26])( );if(v[102]) goto l34;     /*FNDC0(130,jvj+4,V39)*/
V39=pile[WZ2]; 
pile[v[22]]=102; pile[WZ1]=XA; pile[WZ2]=jvj+5; 
(*f[32])( );if(v[102]) goto l34;     /*FNDO0(102,XA,jvj+5)*/
pile[v[22]]=100; pile[WZ1]=jvj+5; pile[WZ2]=jvj+6; 
(*f[32])( );if(v[102]) goto l34;     /*FNDO0(100,jvj+5,jvj+6)*/
if((x[jvj+6]==21)) goto l6;
if((x[jvj+6]!=484)) goto l34;
D=V39;
goto l1;
l6:D=V39;
goto l1;
...
K=V74;
goto l27;
l9:x[jvj+8]=s[x[jvj+32]] ;z[jvj+8]=(x[jvj+8]<=sepcte) ? x[jvj+8] : z[jvj+32];
...
x[jvj+9]=s[x[jvj+33]] ;z[jvj+9]=(x[jvj+9]<=sepcte) ? x[jvj+9] : z[jvj+33];
...
goto l16;
l19:x[jvj+14]=s[x[jvj+36]] ;z[jvj+14]=(x[jvj+14]<=sepcte) ? x[jvj+14] : z[jvj+36];
...
x[jvj+15]=s[x[jvj+37]] ;z[jvj+15]=(x[jvj+15]<=sepcte) ? x[jvj+15] : z[jvj+37];
...
goto l25;
l29:x[jvj+30]=s[x[jvj+29]] ;z[jvj+30]=(x[jvj+30]<=sepcte) ? x[jvj+30] : z[jvj+29];
pile[v[22]]=117; pile[WZ1]=jvj+30; 
(*f[26])( );if(v[102]) goto l30;     /*FNDC0(117,jvj+30,V96)*/
V96=pile[WZ2]; 
if((V96!=D)) goto l30;
