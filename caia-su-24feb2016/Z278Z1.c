...
pile[v[22]]=BTTT; pile[WZ1]=130; pile[WZ2]=1; 
(*f[186])( );     /*BTC0(BTTT,130,1)*/
l1:pile[v[22]]=100; pile[WZ1]=BXXX; pile[WZ2]=jvj+3; 
(*f[32])( );if(v[102]) goto l8;     /*FNDO0(100,BXXX,jvj+3)*/
if(x[jvj+3]==484||x[jvj+3]==531||x[jvj+3]==453||x[jvj+3]==979||x[jvj+3]==1027) goto l4;
x[jvj+9]=w[x[jvj+3]][9];
...
(*f[32])( );if(v[102]) goto l3;     /*FNDO0(jvj+4,BXXX,jvj+5)*/
pile[v[22]]=jvj+5; pile[WZ1]=BTTT; 
(*f[1937])( );     /*Z278Z1(jvj+5,BTTT)*/
l3:x[jvj+9]=t[x[jvj+9]];
goto l2;
l4:x[jvj+10]=w[x[jvj+3]][8];
