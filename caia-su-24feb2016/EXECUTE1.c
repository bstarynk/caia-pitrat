...
{int V3=0,Q=0,NV=0,V6=0,V9=0,V8=0,I=0,V5=0,V4=0,V16=0,V18=0,V17=0,V11=0,V15=0,V14=0,V38=0,V40=0,V39=0,V32=0,V37=0,V36=0,V25=0,V27=0,V26=0,V24=0,V28=0,V29=0,V10=0,V21=0,V20=0,V42=0,V43=0,V48=0,V50=0,V49=0,V47=0,V46=0,V54=0,V53=0;
int B,A;
int R;
int WZ1,WZ2;
int jvj;
...
x[jvj+15]=x[jvj+14] ;z[jvj+15]=0;
x[R]=x[jvj+15] ;z[R]=z[jvj+15];
l20:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=3; v[102]=0;return;
