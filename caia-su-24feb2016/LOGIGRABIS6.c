...
{int I=0,V8=0,II=0,V9=0,V27=0,V6=0,Q=0,V15=0,V35=0,V13=0,V39=0,PP=0,V38=0,V43=0,SS=0,V42=0,V44=0,P=0,V31=0,V16=0,V30=0,V33=0,V32=0,V26=0,V28=0,V10=0,V5=0,N=0,V25=0,V24=0,V23=0,V46=0,L=0,V45=0;
int H,V,MH;
int NNNE;
...
pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=55; pile[WZ4]=jvj+59; 
(*f[181])( );     /*QUADRI2(100,20,101,55,jvj+59)*/
...
L++;
goto l17;
l6:pile[v[22]]=Q; pile[WZ1]=I; pile[WZ2]=(-8615); 
(*f[203])( );if(v[102]) goto l5;     /*FTAB0(Q,I,(-8615),V15)*/
V15=pile[WZ3]; 
...
pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=28; pile[WZ4]=jvj+36; 
(*f[181])( );     /*QUADRI2(100,20,101,28,jvj+36)*/
...
goto l11;
l8:V38=PP+V39;
pile[v[22]]=100; pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-8635); pile[WZ4]=jvj+15; 
(*f[270])( );     /*QUADRI7(100,21,140,(-8635),jvj+15)*/
...
goto l7;
l10:V42=SS+V43;
pile[v[22]]=100; pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-8635); pile[WZ4]=jvj+18; 
(*f[270])( );     /*QUADRI7(100,21,140,(-8635),jvj+18)*/
...
goto l9;
l13:V31=P-1;
pile[v[22]]=P; pile[WZ1]=I; pile[WZ2]=(-8615); 
(*f[203])( );if(v[102]) goto l12;     /*FTAB0(P,I,(-8615),V16)*/
V16=pile[WZ3]; 
...
l15:I++;
goto l14;
l16:pile[v[22]]=1; pile[WZ1]=I; pile[WZ2]=(-8615); 
(*f[203])( );if(v[102]) goto l15;     /*FTAB0(1,I,(-8615),V10)*/
V10=pile[WZ3]; 
if((V10<=0)) goto l15;
pile[v[22]]=I; pile[WZ1]=(-8615); 
(*f[3979])( );if(v[102]) goto l15;     /*LONGUEUR0(I,(-8615),V5)*/
V5=pile[WZ2]; 
N=V5;
V25=N-1;
...
pile[v[22]]=I; pile[WZ1]=(-8615); 
(*f[3979])( );if(v[102]) goto l3;     /*LONGUEUR0(I,(-8615),V8)*/
V8=pile[WZ2]; 
II=1;
l1:if((II>V8)) goto l3;
pile[v[22]]=II; pile[WZ1]=I; pile[WZ2]=(-8615); 
(*f[203])( );if(v[102]) goto l2;     /*FTAB0(II,I,(-8615),V9)*/
V9=pile[WZ3]; 
