...
l3:pile[v[22]]=100; pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=29; pile[WZ4]=jvj+4; 
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-630); pile[WZ4]=jvj+12; 
(*f[270])( );     /*QUADRI7(100,21,140,(-630),jvj+12)*/
