...
X=pile[v[22]]; F=pile[v[22]+1]; V=pile[v[22]+2]; v[22]+=3; 
WZ2=v[22]+2; WZ1=v[22]+1; 
pile[v[22]]=100; pile[WZ1]=X; pile[WZ2]=jvj+1; 
(*f[32])( );if(v[102]) goto l4;     /*FNDO0(100,X,jvj+1)*/
if((x[jvj+1]!=22)) goto l4;
pile[v[22]]=102; pile[WZ2]=jvj+2; 
(*f[32])( );if(v[102]) goto l4;     /*FNDO0(102,X,jvj+2)*/
...
if(x[jvj+5]!=29&&x[jvj+5]!=30&&x[jvj+5]!=27&&x[jvj+5]!=28) goto l3;
pile[v[22]]=103; pile[WZ1]=X; pile[WZ2]=jvj+6; 
(*f[32])( );if(v[102]) goto l3;     /*FNDO0(103,X,jvj+6)*/
...
l2:x[V]=x[jvj+2] ;z[V]=z[jvj+2];
l8:v[0]=jvj; v[22]-=3; v[102]=0;return;
l1:x[F]=x[jvj+5] ;z[F]=z[jvj+5];
goto l2;
l3:if(x[jvj+3]!=96&&x[jvj+3]!=89&&x[jvj+3]!=41&&x[jvj+3]!=20&&x[jvj+3]!=128&&x[jvj+3]!=570&&x[jvj+3]!=1317) goto l4;
pile[v[22]]=103; pile[WZ1]=X; pile[WZ2]=jvj+8; 
(*f[32])( );if(v[102]) goto l4;     /*FNDO0(103,X,jvj+8)*/
...
(*f[32])( );if(v[102]) goto l4;     /*FNDO0(111,X,jvj+10)*/
pile[v[22]]=101; pile[WZ1]=jvj+10; pile[WZ2]=jvj+11; 
(*f[32])( );if(v[102]) goto l4;     /*FNDO0(101,jvj+10,jvj+11)*/
if(x[jvj+11]!=29&&x[jvj+11]!=30&&x[jvj+11]!=27&&x[jvj+11]!=28) goto l4;
pile[v[22]]=844; pile[WZ1]=jvj+11; pile[WZ2]=F; 
(*f[32])( );if(v[102]) goto l4;     /*FNDO0(844,jvj+11,F)*/
x[V]=x[jvj+8] ;z[V]=z[jvj+8];
goto l8;
l4:pile[v[22]]=111; pile[WZ1]=X; pile[WZ2]=jvj+12; 
(*f[32])( );if(v[102]) goto l7;     /*FNDO0(111,X,jvj+12)*/
pile[v[22]]=101; pile[WZ1]=jvj+12; pile[WZ2]=jvj+13; 
(*f[32])( );if(v[102]) goto l7;     /*FNDO0(101,jvj+12,jvj+13)*/
if((x[jvj+13]!=25)) goto l7;
x[jvj+14]=d[20];z[jvj+14]=0;
l5:if((x[jvj+14]<=0)) goto l7;
x[jvj+15]=s[x[jvj+14]] ;z[jvj+15]=(x[jvj+15]<=sepcte) ? x[jvj+15] : z[jvj+14];
pile[v[22]]=jvj+15; pile[WZ1]=X; pile[WZ2]=jvj+16; 
(*f[32])( );if(v[102]) goto l6;     /*FNDO0(jvj+15,X,jvj+16)*/
...
(*f[32])( );if(v[102]) goto l6;     /*FNDO0(268,jvj+15,jvj+18)*/
pile[v[22]]=jvj+18; pile[WZ1]=X; pile[WZ2]=jvj+19; 
(*f[32])( );if(v[102]) goto l6;     /*FNDO0(jvj+18,X,jvj+19)*/
pile[v[22]]=100; pile[WZ1]=jvj+19; pile[WZ2]=jvj+20; 
(*f[32])( );if(v[102]) goto l6;     /*FNDO0(100,jvj+19,jvj+20)*/
if(x[jvj+20]!=96&&x[jvj+20]!=89&&x[jvj+20]!=41&&x[jvj+20]!=20&&x[jvj+20]!=128&&x[jvj+20]!=570&&x[jvj+20]!=1317) goto l6;
x[F]=25 ;z[F]=25;
x[V]=x[jvj+16] ;z[V]=z[jvj+16];
goto l8;
