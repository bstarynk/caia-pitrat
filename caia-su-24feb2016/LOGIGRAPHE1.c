...
{int V17=0,V10=0,V16=0,V19=0,I=0,V18=0,A=0,V13=0,J=0,V4=0,V5=0,NU=0,V12=0;
int H,V;
int NNNE;
...
l3:V10=0;
goto l5;
l9:pile[v[22]]=J; pile[WZ1]=(-1859); 
(*f[3979])( );if(v[102]) goto l8;     /*LONGUEUR0(J,(-1859),V4)*/
V4=pile[WZ2]; 
if((V4!=1)) goto l8;
pile[v[22]]=1; pile[WZ1]=J; pile[WZ2]=(-1859); 
(*f[203])( );if(v[102]) goto l8;     /*FTAB0(1,J,(-1859),V5)*/
V5=pile[WZ3]; 
NU=V5;
if((NU<=0)) goto l8;
V12=H-NU;
