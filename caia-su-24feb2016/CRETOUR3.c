...
{int V9=0,I=0,V7=0,J=0,V8=0,V12=0,V11=0,V15=0,V14=0,V13=0;
int N,NK,NP;
int NNNE;
...
N=pile[v[22]]; NK=pile[v[22]+1]; NP=pile[v[22]+2]; NNNE=pile[v[22]+3]; v[22]+=4; 
...
pile[v[22]]=100; pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V13; pile[WZ4]=jvj+17; 
(*f[192])( );     /*QUADRI4(100,41,130,V13,jvj+17)*/
