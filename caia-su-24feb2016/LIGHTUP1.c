...
{int K=0,V8=0,V9=0,P=0,V6=0,V7=0,XI=0,V14=0,YI=0,V13=0,V15=0,V17=0,V16=0,V3=0;
int NC,NL,NK;
int NNNE;
...
l3:pile[v[22]]=K; pile[WZ1]=(-596); 
(*f[201])( );if(v[102]) goto l2;     /*FCOEFF0(K,(-596),V8)*/
V8=pile[WZ2]; 
if((V14!=V8)) goto l2;
pile[WZ1]=(-606); 
(*f[201])( );if(v[102]) goto l2;     /*FCOEFF0(K,(-606),V9)*/
V9=pile[WZ2]; 
if((V15==V9)) goto l6;
l2:K++;
l1:if((K<=NK)) goto l3;
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V16; pile[WZ4]=jvj+9; 
(*f[192])( );     /*QUADRI4(100,41,130,V16,jvj+9)*/
...
l4:XI++;
if((XI<=1)) goto l5;
l11:pile[v[22]]=jvj+2; pile[WZ1]=jvj+4; 
...
pile[v[22]]=100; pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V3; pile[WZ4]=jvj+12; 
(*f[192])( );     /*QUADRI4(100,41,130,V3,jvj+12)*/
...
l9:P++;
goto l8;
l10:pile[v[22]]=P; pile[WZ1]=(-598); 
(*f[201])( );if(v[102]) goto l9;     /*FCOEFF0(P,(-598),V3)*/
V3=pile[WZ2]; 
if((V3<0)) goto l9;
x[jvj+2]=0 ;z[jvj+2]=0;
pile[WZ1]=(-596); 
(*f[201])( );if(v[102]) goto l11;     /*FCOEFF0(P,(-596),V6)*/
V6=pile[WZ2]; 
pile[WZ1]=(-606); 
(*f[201])( );if(v[102]) goto l11;     /*FCOEFF0(P,(-606),V7)*/
V7=pile[WZ2]; 
XI=(-1);
l5:V14=V6+XI;
if((V14<0)) goto l4;
