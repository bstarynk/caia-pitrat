...
NE=pile[v[22]]; ND=pile[v[22]+1]; NNNE=pile[v[22]+2]; v[22]+=3; 
...
(*f[270])( );     /*QUADRI7(100,21,140,(-632),jvj+9)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V3; pile[WZ4]=jvj+11; 
(*f[192])( );     /*QUADRI4(100,41,130,V3,jvj+11)*/
...
pile[WZ1]=89; pile[WZ2]=162; pile[WZ3]=35; pile[WZ4]=jvj+6; 
(*f[272])( );     /*QUADRI9(100,89,162,35,jvj+6)*/
