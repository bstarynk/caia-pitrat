...
pile[WZ3]=30; pile[WZ4]=jvj+9; 
(*f[181])( );     /*QUADRI2(100,20,101,30,jvj+9)*/
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-8802); pile[WZ4]=jvj+14; 
(*f[270])( );     /*QUADRI7(100,21,140,(-8802),jvj+14)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=J; pile[WZ4]=jvj+16; 
(*f[192])( );     /*QUADRI4(100,41,130,J,jvj+16)*/
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-8801); pile[WZ4]=jvj+17; 
(*f[270])( );     /*QUADRI7(100,21,140,(-8801),jvj+17)*/
...
pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=30; pile[WZ4]=jvj+20; 
(*f[181])( );     /*QUADRI2(100,20,101,30,jvj+20)*/
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-8802); pile[WZ4]=jvj+25; 
(*f[270])( );     /*QUADRI7(100,21,140,(-8802),jvj+25)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V3; pile[WZ4]=jvj+27; 
(*f[192])( );     /*QUADRI4(100,41,130,V3,jvj+27)*/
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-8801); pile[WZ4]=jvj+28; 
(*f[270])( );     /*QUADRI7(100,21,140,(-8801),jvj+28)*/
...
pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=30; pile[WZ4]=jvj+31; 
(*f[181])( );     /*QUADRI2(100,20,101,30,jvj+31)*/
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-8804); pile[WZ4]=jvj+36; 
(*f[270])( );     /*QUADRI7(100,21,140,(-8804),jvj+36)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=J; pile[WZ4]=jvj+38; 
(*f[192])( );     /*QUADRI4(100,41,130,J,jvj+38)*/
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-8803); pile[WZ4]=jvj+39; 
(*f[270])( );     /*QUADRI7(100,21,140,(-8803),jvj+39)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V3; pile[WZ4]=jvj+41; 
(*f[192])( );     /*QUADRI4(100,41,130,V3,jvj+41)*/
...
pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=30; pile[WZ4]=jvj+42; 
(*f[181])( );     /*QUADRI2(100,20,101,30,jvj+42)*/
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-8804); pile[WZ4]=jvj+47; 
(*f[270])( );     /*QUADRI7(100,21,140,(-8804),jvj+47)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V3; pile[WZ4]=jvj+49; 
(*f[192])( );     /*QUADRI4(100,41,130,V3,jvj+49)*/
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-8803); pile[WZ4]=jvj+50; 
(*f[270])( );     /*QUADRI7(100,21,140,(-8803),jvj+50)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=J; pile[WZ4]=jvj+52; 
(*f[192])( );     /*QUADRI4(100,41,130,J,jvj+52)*/
pile[v[22]]=jvj+50; pile[WZ1]=111; pile[WZ2]=jvj+51; 
(*f[54])( );     /*TRI1(jvj+50,111,jvj+51)*/
pile[v[22]]=100; pile[WZ1]=484; pile[WZ2]=102; pile[WZ3]=jvj+52; pile[WZ4]=jvj+51; pile[WZ5]=jvj+44; 
(*f[269])( );     /*QUADRI6(100,484,102,jvj+52,jvj+51,jvj+44)*/
