...
pile[v[22]]=jvj+3; pile[WZ2]=jvj+2; pile[WZ3]=M; 
(*f[2062])( );     /*TRNBVRAI1(jvj+3,X,jvj+2,M)*/
l3:x[jvj+7]=t[x[jvj+7]];
goto l1;
l6:x[jvj+6]=s[x[jvj+9]] ;z[jvj+6]=(x[jvj+6]<=sepcte) ? x[jvj+6] : z[jvj+9];
pile[v[22]]=jvj+6; pile[WZ1]=X; pile[WZ2]=jvj+4; pile[WZ3]=M; 
(*f[2062])( );     /*TRNBVRAI1(jvj+6,X,jvj+4,M)*/
x[jvj+9]=t[x[jvj+9]];
goto l5;
