...
pile[v[22]]=1358; pile[WZ1]=R; pile[WZ2]=jvj+6; 
(*f[32])( );if(v[102]) goto l1;     /*FNDO0(1358,R,jvj+6)*/
...
(*f[32])( );if(v[102]) goto l2;     /*FNDO0(1569,R,jvj+3)*/
if((x[jvj+3]==67)) goto l1;
...
pile[v[22]]=jvj+9; pile[WZ1]=3669; pile[WZ2]=246; pile[WZ3]=jvj+10; 
(*f[189])( );     /*TRI4(jvj+9,3669,246,jvj+10)*/
pile[v[22]]=jvj+10; pile[WZ1]=20214; pile[WZ2]=218; pile[WZ3]=jvj+11; 
(*f[58])( );     /*TRI3(jvj+10,20214,218,jvj+11)*/
