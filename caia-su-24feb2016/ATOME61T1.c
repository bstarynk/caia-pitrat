...
(*f[1948])( );if(v[102]) goto l12;     /*FNDOND0(498,A,jvj+9)*/
pile[v[22]]=472; pile[WZ1]=jvj+9; 
(*f[1975])( );if(v[102]) goto l12;     /*FNDCND0(472,jvj+9,V1)*/
V1=pile[WZ2]; 
pile[v[22]]=750; 
(*f[1975])( );if(v[102]) goto l12;     /*FNDCND0(750,jvj+9,V2)*/
V2=pile[WZ2]; 
V13=V5*V2;
x[jvj+7]=0 ;z[jvj+7]=0;
...
pile[v[22]]=jvj+13; pile[WZ1]=3065; pile[WZ2]=246; pile[WZ3]=jvj+14; 
(*f[189])( );     /*TRI4(jvj+13,3065,246,jvj+14)*/
