...
{int V16=0,V15=0,V17=0,V6=0,V20=0,V19=0,V21=0,V9=0,V23=0,V22=0,V24=0,V12=0,V25=0,V10=0,J=0;
int NNNE;
...
x[jvj+9]=0 ;z[jvj+9]=0;
J=0;
l12:pile[v[22]]=0; pile[WZ1]=117; pile[WZ2]=jvj+6; 
(*f[46])( );     /*TRI0(0,117,jvj+6)*/
V23=5*J;
V22=V23+1;
V24=V22+4;
l7:if((V22<=V24)) goto l9;
pile[v[22]]=117; pile[WZ1]=jvj+6; 
(*f[26])( );if(v[102]) goto l10;     /*FNDC0(117,jvj+6,V25)*/
V25=pile[WZ2]; 
V10=V25;
x[jvj+2]=0 ;z[jvj+2]=0;
V16=5*J;
...
l3:pile[v[22]]=V15; pile[WZ1]=(-630); 
(*f[201])( );if(v[102]) goto l2;     /*FCOEFF0(V15,(-630),V6)*/
V6=pile[WZ2]; 
if((V6!=0)) goto l2;
...
l2:V15++;
goto l1;
l6:pile[v[22]]=V19; pile[WZ1]=(-630); 
(*f[201])( );if(v[102]) goto l5;     /*FCOEFF0(V19,(-630),V9)*/
V9=pile[WZ2]; 
if((V9<=0)) goto l5;
...
l5:V19++;
goto l4;
l9:pile[v[22]]=V22; pile[WZ1]=(-630); 
(*f[201])( );if(v[102]) goto l8;     /*FCOEFF0(V22,(-630),V12)*/
V12=pile[WZ2]; 
if((V12<=0)) goto l8;
