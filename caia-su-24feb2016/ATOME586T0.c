...
(*f[3888])( );if(v[102]) goto l3;     /*SUPB0(jvj+11,jvj+12)*/
...
pile[v[22]]=jvj+21; pile[WZ1]=3900; pile[WZ2]=246; pile[WZ3]=jvj+22; 
(*f[189])( );     /*TRI4(jvj+21,3900,246,jvj+22)*/
pile[v[22]]=jvj+22; pile[WZ1]=20586; pile[WZ2]=218; pile[WZ3]=jvj+23; 
(*f[58])( );     /*TRI3(jvj+22,20586,218,jvj+23)*/
...
pile[v[22]]=jvj+19; pile[WZ1]=164; pile[WZ2]=jvj+14; pile[WZ3]=V20; 
(*f[2056])( );     /*VAUT0(jvj+19,164,jvj+14,V20)*/
