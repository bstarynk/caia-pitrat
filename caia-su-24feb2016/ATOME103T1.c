...
(*f[1948])( );if(v[102]) goto l6;     /*FNDOND0(498,jvj+9,jvj+10)*/
...
(*f[1975])( );if(v[102]) goto l6;     /*FNDCND0(280,D,V5)*/
V5=pile[WZ2]; 
if((V5<=0)) goto l6;
x[jvj+8]=0 ;z[jvj+8]=0;
...
pile[v[22]]=jvj+20; pile[WZ1]=3509; pile[WZ2]=246; pile[WZ3]=jvj+21; 
(*f[189])( );     /*TRI4(jvj+20,3509,246,jvj+21)*/
