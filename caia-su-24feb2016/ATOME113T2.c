...
(*f[32])( );if(v[102]) goto l11;     /*FNDO0(869,RR,jvj+16)*/
if((x[jvj+16]!=769)) goto l11;
pile[v[22]]=870; 
(*f[26])( );if(v[102]) goto l11;     /*FNDC0(870,RR,V5)*/
V5=pile[WZ2]; 
if((V5>3)) goto l11;
...
goto l4;
l2:DA=s[V25];
for(a=x[jvj+4];a>0;a=t[a]) if(s[a]==DA) goto l3;
...
(*f[32])( );if(v[102]) goto l10;     /*FNDO0(103,jvj+3,jvj+19)*/
...
if((x[jvj+21]!=485)) goto l10;
pile[v[22]]=102; pile[WZ1]=jvj+3; pile[WZ2]=jvj+22; 
(*f[32])( );if(v[102]) goto l10;     /*FNDO0(102,jvj+3,jvj+22)*/
