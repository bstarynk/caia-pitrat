...
{int V31=0,F=0,V20=0,V7=0,V37=0,V6=0,L=0,V62=0,V61=0;
int D;
int WZ1,WZ2,WZ3,WZ4,WZ5;
int jvj;
jvj=v[0];
v[0]+=45;
x[jvj+1]=20043;z[jvj+1]=(-100);
...
for(a=x[jvj+23];a>0;a=t[a]) if(s[a]==27) goto l5;
...
(*f[32])( );if(v[102]) goto l3;     /*FNDO0(103,jvj+4,jvj+7)*/
...
(*f[44])( );if(v[102]) goto l3;     /*FNDC1(140,jvj+9,V31)*/
V31=pile[WZ2]; 
pile[v[22]]=102; pile[WZ1]=jvj+4; pile[WZ2]=jvj+10; 
(*f[32])( );if(v[102]) goto l3;     /*FNDO0(102,jvj+4,jvj+10)*/
F=V31;
...
(*f[44])( );if(v[102]) goto l3;     /*FNDC1(140,jvj+12,V20)*/
V20=pile[WZ2]; 
if((F!=V20)) goto l3;
...
(*f[32])( );if(v[102]) goto l3;     /*FNDO0(102,jvj+10,jvj+14)*/
...
pile[v[22]]=102; pile[WZ1]=jvj+7; pile[WZ2]=jvj+16; 
(*f[32])( );if(v[102]) goto l3;     /*FNDO0(102,jvj+7,jvj+16)*/
...
pile[v[22]]=jvj+27; pile[WZ1]=3447; pile[WZ2]=246; pile[WZ3]=jvj+28; 
(*f[189])( );     /*TRI4(jvj+27,3447,246,jvj+28)*/
pile[v[22]]=jvj+28; pile[WZ1]=20043; pile[WZ2]=218; pile[WZ3]=jvj+29; 
(*f[58])( );     /*TRI3(jvj+28,20043,218,jvj+29)*/
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=L; pile[WZ4]=jvj+35; 
(*f[192])( );     /*QUADRI4(100,41,130,L,jvj+35)*/
pile[v[22]]=jvj+32; pile[WZ1]=111; pile[WZ2]=jvj+33; 
(*f[54])( );     /*TRI1(jvj+32,111,jvj+33)*/
pile[v[22]]=jvj+33; pile[WZ1]=jvj+22; pile[WZ2]=103; pile[WZ3]=jvj+34; 
(*f[58])( );     /*TRI3(jvj+33,jvj+22,103,jvj+34)*/
pile[v[22]]=100; pile[WZ1]=22; pile[WZ2]=102; pile[WZ3]=jvj+35; pile[WZ4]=jvj+34; pile[WZ5]=jvj+25; 
(*f[269])( );     /*QUADRI6(100,22,102,jvj+35,jvj+34,jvj+25)*/
