...
{int V=0,V22=0,V16=0,V25=0,V38=0,V33=0;
int A;
int R;
int WZ1,WZ2;
int jvj;
...
(*f[44])( );if(v[102]) goto l3;     /*FNDC1(140,jvj+5,V22)*/
V22=pile[WZ2]; 
V16=V22;
pile[v[22]]=R; pile[WZ1]=V16; 
(*f[331])( );     /*PLUE3(R,V16)*/
...
(*f[44])( );if(v[102]) goto l8;     /*FNDC1(140,jvj+14,V38)*/
V38=pile[WZ2]; 
V33=V38;
pile[v[22]]=R; pile[WZ1]=V33; 
(*f[331])( );     /*PLUE3(R,V33)*/
...
x[jvj+23]=t[x[jvj+23]];
l17:if((x[jvj+23]<=0)) goto l16;
x[jvj+7]=s[x[jvj+23]] ;z[jvj+7]=(x[jvj+7]<=sepcte) ? x[jvj+7] : z[jvj+23];
x[jvj+19]=incon;
...
(*f[44])( );if(v[102]) goto l9;     /*FNDC1(140,jvj+11,V25)*/
V25=pile[WZ2]; 
...
x[jvj+21]=w[x[jvj+1]][9];
l11:if((x[jvj+21]<=0)) goto l14;
x[jvj+15]=s[x[jvj+21]] ;z[jvj+15]=(x[jvj+15]<=sepcte) ? x[jvj+15] : z[jvj+21];
...
goto l11;
l14:x[jvj+22]=w[x[jvj+1]][8];
l15:if((x[jvj+22]<=0)) goto l19;
