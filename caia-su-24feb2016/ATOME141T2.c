...
(*f[32])( );if(v[102]) goto l10;     /*FNDO0(111,RR,jvj+13)*/
pile[v[22]]=101; pile[WZ1]=jvj+13; pile[WZ2]=jvj+14; 
(*f[32])( );if(v[102]) goto l10;     /*FNDO0(101,jvj+13,jvj+14)*/
if((x[jvj+14]!=55)) goto l10;
x[jvj+12]=0 ;z[jvj+12]=0;
pile[v[22]]=RR; pile[WZ1]=jvj+9; 
(*f[887])( );     /*VARND0(RR,jvj+9)*/
l1:if((x[jvj+9]>0)) goto l2;
pile[v[22]]=107; pile[WZ1]=RR; pile[WZ2]=jvj+15; 
(*f[33])( );     /*FNDE0(107,RR,jvj+15)*/
pile[v[22]]=1294; pile[WZ2]=jvj+16; 
(*f[33])( );     /*FNDE0(1294,RR,jvj+16)*/
for(a=x[jvj+16];a>0;a=t[a]) if(s[a]==1311) goto l7;
l10:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=1; return;
l2:x[jvj+10]=s[x[jvj+9]] ;z[jvj+10]=(x[jvj+10]<=sepcte) ? x[jvj+10] : z[jvj+9];
...
x[jvj+9]=t[x[jvj+9]];
goto l1;
l4:x[jvj+5]=s[x[jvj+28]] ;z[jvj+5]=(x[jvj+5]<=sepcte) ? x[jvj+5] : z[jvj+28];
if((x[jvj+5]==x[RR])) goto l5;
pile[v[22]]=1417; pile[WZ1]=jvj+5; pile[WZ2]=jvj+6; 
(*f[33])( );     /*FNDE0(1417,jvj+5,jvj+6)*/
for(a=x[jvj+6];a>0;a=t[a]) if(s[a]==423) goto l6;
x[jvj+7]=vo[14];z[jvj+7]=vz[14];
pile[v[22]]=1545; pile[WZ1]=jvj+7; pile[WZ2]=jvj+8; 
(*f[33])( );     /*FNDE0(1545,jvj+7,jvj+8)*/
for(a=x[jvj+8];a>0;a=t[a]) if(s[a]==423) goto l6;
l5:x[jvj+28]=t[x[jvj+28]];
goto l3;
l6:pile[v[22]]=jvj+12; pile[WZ1]=jvj+5; 
(*f[68])( );     /*PLUE0(jvj+12,jvj+5)*/
goto l5;
l11:pile[v[22]]=101; pile[WZ1]=jvj+3; pile[WZ2]=110; pile[WZ3]=(-601); pile[WZ4]=jvj+26; 
(*f[270])( );     /*QUADRI7(101,jvj+3,110,(-601),jvj+26)*/
...
(*f[32])( );if(v[102]) goto l8;     /*FNDO0(111,jvj+3,jvj+17)*/
pile[v[22]]=101; pile[WZ1]=jvj+17; pile[WZ2]=jvj+18; 
(*f[32])( );if(v[102]) goto l8;     /*FNDO0(101,jvj+17,jvj+18)*/
if((x[jvj+18]!=25)) goto l8;
pile[v[22]]=1188; pile[WZ1]=jvj+3; pile[WZ2]=jvj+4; 
(*f[32])( );if(v[102]) goto l9;     /*FNDO0(1188,jvj+3,jvj+4)*/
if((x[jvj+4]==68)) goto l8;
l9:pile[v[22]]=102; pile[WZ1]=jvj+3; pile[WZ2]=jvj+19; 
(*f[32])( );if(v[102]) goto l8;     /*FNDO0(102,jvj+3,jvj+19)*/
pile[v[22]]=103; pile[WZ2]=jvj+20; 
(*f[32])( );if(v[102]) goto l8;     /*FNDO0(103,jvj+3,jvj+20)*/
pile[v[22]]=1294; pile[WZ2]=jvj+21; 
(*f[33])( );     /*FNDE0(1294,jvj+3,jvj+21)*/
for(a=x[jvj+21];a>0;a=t[a]) if(s[a]==1327) goto l11;
goto l8;
}
