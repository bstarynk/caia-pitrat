...
{int V9=0,V11=0,IX=0,V8=0,IY=0,V10=0,V13=0,V12=0,V6=0,I=0;
int N,NP;
int NNNE;
...
N=pile[v[22]]; NP=pile[v[22]+1]; NNNE=pile[v[22]+2]; v[22]+=3; 
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=NP; pile[WZ4]=jvj+20; 
(*f[192])( );     /*QUADRI4(100,41,130,NP,jvj+20)*/
...
pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=28; pile[WZ4]=jvj+26; 
...
pile[v[22]]=jvj+32; pile[WZ1]=jvj+4; pile[WZ2]=107; pile[WZ3]=jvj+33; 
(*f[301])( );     /*TRI11(jvj+32,jvj+4,107,jvj+33)*/
pile[v[22]]=jvj+33; pile[WZ1]=22; pile[WZ2]=100; pile[WZ3]=jvj+30; 
(*f[58])( );     /*TRI3(jvj+33,22,100,jvj+30)*/
pile[v[22]]=100; pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=2; pile[WZ4]=jvj+28; 
...
pile[v[22]]=100; pile[WZ1]=22; pile[WZ2]=102; pile[WZ3]=jvj+30; pile[WZ4]=jvj+29; pile[WZ5]=jvj+17; 
(*f[269])( );     /*QUADRI6(100,22,102,jvj+30,jvj+29,jvj+17)*/
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V12; pile[WZ4]=jvj+14; 
(*f[192])( );     /*QUADRI4(100,41,130,V12,jvj+14)*/
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=NP; pile[WZ4]=jvj+9; 
(*f[192])( );     /*QUADRI4(100,41,130,NP,jvj+9)*/
