...
{int V10=0,V12=0,I=0,V11=0,V8=0,J=0,V3=0,V4=0;
int H,V;
int NNNE;
...
l4:J++;
goto l3;
l5:pile[v[22]]=J; pile[WZ1]=(-1859); 
(*f[3979])( );if(v[102]) goto l4;     /*LONGUEUR0(J,(-1859),V3)*/
V3=pile[WZ2]; 
if((V3!=1)) goto l4;
pile[v[22]]=1; pile[WZ1]=J; pile[WZ2]=(-1859); 
(*f[203])( );if(v[102]) goto l4;     /*FTAB0(1,J,(-1859),V4)*/
V4=pile[WZ3]; 
if((V4!=0)) goto l4;
x[jvj+2]=0 ;z[jvj+2]=0;
V10=H-1;
