...
L=pile[v[22]]; NNNE=pile[v[22]+1]; v[22]+=2; 
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-8802); pile[WZ4]=jvj+15; 
(*f[270])( );     /*QUADRI7(100,21,140,(-8802),jvj+15)*/
...
pile[v[22]]=100; pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=L; pile[WZ4]=jvj+6; 
(*f[192])( );     /*QUADRI4(100,41,130,L,jvj+6)*/
