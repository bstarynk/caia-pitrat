...
(*f[26])( );if(v[102]) goto l1;     /*FNDC0(1274,jvj+3,V1)*/
V1=pile[WZ2]; 
if((V1!=2)) goto l1;
pile[v[22]]=489; pile[WZ1]=D; pile[WZ2]=jvj+4; 
(*f[1969])( );     /*FNDEND0(489,D,jvj+4)*/
for(i=x[jvj+4],V3=0;i>0;i=t[i],V3++)  ;
if((V3!=1)) goto l1;
pile[v[22]]=101; pile[WZ2]=110; pile[WZ3]=(-656); pile[WZ4]=jvj+10; 
(*f[270])( );     /*QUADRI7(101,D,110,(-656),jvj+10)*/
pile[v[22]]=603; pile[WZ1]=715; pile[WZ2]=jvj+6; 
(*f[54])( );     /*TRI1(603,715,jvj+6)*/
pile[v[22]]=jvj+6; pile[WZ1]=v[13]; pile[WZ2]=642; pile[WZ3]=jvj+7; 
(*f[189])( );     /*TRI4(jvj+6,v[13],642,jvj+7)*/
pile[v[22]]=jvj+7; pile[WZ1]=3097; pile[WZ2]=246; pile[WZ3]=jvj+8; 
(*f[189])( );     /*TRI4(jvj+7,3097,246,jvj+8)*/
pile[v[22]]=jvj+8; pile[WZ1]=20088; pile[WZ2]=218; pile[WZ3]=jvj+9; 
(*f[58])( );     /*TRI3(jvj+8,20088,218,jvj+9)*/
