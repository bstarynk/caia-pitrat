...
(*f[1975])( );if(v[102]) goto l3;     /*FNDCND0(164,D,V3)*/
V3=pile[WZ2]; 
...
(*f[1948])( );if(v[102]) goto l3;     /*FNDOND0(498,D,jvj+7)*/
...
pile[v[22]]=jvj+12; pile[WZ1]=3422; pile[WZ2]=246; pile[WZ3]=jvj+13; 
(*f[189])( );     /*TRI4(jvj+12,3422,246,jvj+13)*/
