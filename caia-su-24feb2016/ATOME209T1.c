...
for(a=x[jvj+6];a>0;a=t[a]) if(s[a]==1291) goto l2;
...
pile[v[22]]=jvj+9; pile[WZ1]=3381; pile[WZ2]=246; pile[WZ3]=jvj+10; 
(*f[189])( );     /*TRI4(jvj+9,3381,246,jvj+10)*/
pile[v[22]]=jvj+10; pile[WZ1]=20209; pile[WZ2]=218; pile[WZ3]=jvj+11; 
(*f[58])( );     /*TRI3(jvj+10,20209,218,jvj+11)*/
