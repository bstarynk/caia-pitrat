...
{int V9=0,M=0,R=0,V11=0,P=0,N=0,V3=0,K=0,V17=0,V16=0,V14=0,V25=0,V=0,V28=0,V36=0,V35=0,V31=0,V33=0,V32=0,V30=0,V7=0,V8=0,V22=0,V20=0;
int T,HIST,A;
int WZ1,WZ2;
int jvj;
jvj=v[0];
...
T=pile[v[22]]; HIST=pile[v[22]+1]; A=pile[v[22]+2]; v[22]+=3; 
...
(*f[26])( );if(v[102]) goto l20;     /*FNDC0(993,994,V20)*/
V20=pile[WZ2]; 
if((V20!=3)) goto l20;
...
(*f[26])( );if(v[102]) goto l10;     /*FNDC0(246,jvj+14,V25)*/
V25=pile[WZ2]; 
if((V25!=M)) goto l10;
...
(*f[44])( );if(v[102]) goto l12;     /*FNDC1(110,jvj+17,V28)*/
V28=pile[WZ2]; 
if((V28!=V)) goto l12;
...
for(i=x[jvj+21],V36=0;i>0;i=t[i],V36++)  ;
V35=25600+V36;
ts[K]=V35;
...
l23:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=3; return;
l1:V9=301;
goto l2;
l4:ta1[K]=V14;
...
(*f[26])( );if(v[102]) goto l19;     /*FNDC0(117,jvj+8,V17)*/
V17=pile[WZ2]; 
V16=R+V17;
