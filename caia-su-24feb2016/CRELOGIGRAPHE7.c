...
{int V3=0,V4=0,I=0,V7=0,J=0,V6=0,V5=0,V8=0;
int H,W;
int NNNE;
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-662); pile[WZ4]=jvj+20; 
(*f[270])( );     /*QUADRI7(100,21,140,(-662),jvj+20)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V8; pile[WZ4]=jvj+22; 
(*f[192])( );     /*QUADRI4(100,41,130,V8,jvj+22)*/
