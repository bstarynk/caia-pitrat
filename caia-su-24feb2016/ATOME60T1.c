...
(*f[1948])( );if(v[102]) goto l12;     /*FNDOND0(498,D,jvj+9)*/
pile[v[22]]=473; pile[WZ1]=jvj+9; 
(*f[1975])( );if(v[102]) goto l12;     /*FNDCND0(473,jvj+9,V10)*/
V10=pile[WZ2]; 
pile[v[22]]=688; 
(*f[1975])( );if(v[102]) goto l12;     /*FNDCND0(688,jvj+9,V14)*/
V14=pile[WZ2]; 
V11=V5*V14;
pile[v[22]]=473; 
(*f[1975])( );if(v[102]) goto l12;     /*FNDCND0(473,jvj+9,V1)*/
V1=pile[WZ2]; 
pile[v[22]]=688; 
(*f[1975])( );if(v[102]) goto l12;     /*FNDCND0(688,jvj+9,V2)*/
V2=pile[WZ2]; 
x[jvj+7]=0 ;z[jvj+7]=0;
...
pile[v[22]]=jvj+13; pile[WZ1]=3083; pile[WZ2]=246; pile[WZ3]=jvj+14; 
(*f[189])( );     /*TRI4(jvj+13,3083,246,jvj+14)*/
