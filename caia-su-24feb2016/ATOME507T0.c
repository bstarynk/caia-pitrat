...
{int V66=0,V68=0,I=0,V81=0,V20=0,V82=0,V75=0,V25=0,V84=0,V26=0,V85=0,V35=0,V79=0,V50=0,V69=0,V67=0,V28=0,V27=0;
int NNNN;
int WZ1,WZ2,WZ3,WZ4,WZ5;
int jvj;
jvj=v[0];
v[0]+=65;
x[jvj+1]=20507;z[jvj+1]=(-100);
if(v[0]>99700) (*f[6])( );
if(v[90]==3931&&v[97]==0) {
...
pile[v[22]]=111; pile[WZ1]=NNNN; pile[WZ2]=jvj+20; 
(*f[32])( );if(v[102]) goto l26;     /*FNDO0(111,NNNN,jvj+20)*/
pile[v[22]]=101; pile[WZ1]=jvj+20; pile[WZ2]=jvj+21; 
(*f[32])( );if(v[102]) goto l26;     /*FNDO0(101,jvj+20,jvj+21)*/
if((x[jvj+21]!=29)) goto l26;
pile[v[22]]=103; pile[WZ1]=NNNN; pile[WZ2]=jvj+22; 
(*f[32])( );if(v[102]) goto l26;     /*FNDO0(103,NNNN,jvj+22)*/
...
V79=pile[WZ2]; 
pile[v[22]]=102; pile[WZ1]=NNNN; pile[WZ2]=jvj+5; 
(*f[32])( );if(v[102]) goto l26;     /*FNDO0(102,NNNN,jvj+5)*/
pile[v[22]]=100; pile[WZ1]=jvj+5; pile[WZ2]=jvj+26; 
(*f[32])( );if(v[102]) goto l26;     /*FNDO0(100,jvj+5,jvj+26)*/
if((x[jvj+26]!=484)) goto l26;
pile[v[22]]=jvj+5; pile[WZ1]=jvj+27; 
(*f[200])( );if(v[102]) goto l26;     /*NDD0(jvj+5,jvj+27)*/
...
pile[v[22]]=1006; pile[WZ1]=NNNN; pile[WZ2]=jvj+19; 
(*f[33])( );     /*FNDE0(1006,NNNN,jvj+19)*/
V85=x[jvj+19];
...
pile[v[22]]=101; pile[WZ1]=NNNN; pile[WZ2]=110; pile[WZ3]=(-11756); pile[WZ4]=jvj+58; 
(*f[270])( );     /*QUADRI7(101,NNNN,110,(-11756),jvj+58)*/
...
pile[v[22]]=jvj+55; pile[WZ1]=3931; pile[WZ2]=246; pile[WZ3]=jvj+56; 
(*f[189])( );     /*TRI4(jvj+55,3931,246,jvj+56)*/
pile[v[22]]=jvj+56; pile[WZ1]=20507; pile[WZ2]=218; pile[WZ3]=jvj+57; 
(*f[58])( );     /*TRI3(jvj+56,20507,218,jvj+57)*/
...
(*f[26])( );if(v[102]) goto l25;     /*FNDC0(130,jvj+41,V67)*/
V67=pile[WZ2]; 
V66=V67-1;
...
(*f[26])( );if(v[102]) goto l20;     /*FNDC0(130,jvj+38,V69)*/
V69=pile[WZ2]; 
V68=1-V69;
...
pile[v[22]]=jvj+5; pile[WZ1]=jvj+39; pile[WZ2]=jvj+40; 
(*f[760])( );     /*MEMEX0(jvj+5,jvj+39,jvj+40)*/
