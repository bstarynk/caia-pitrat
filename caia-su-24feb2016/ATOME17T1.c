...
(*f[1975])( );if(v[102]) goto l1;     /*FNDCND0(472,jvj+5,V3)*/
V3=pile[WZ2]; 
if((V1<=V3)) goto l1;
...
pile[v[22]]=jvj+8; pile[WZ1]=3437; pile[WZ2]=246; pile[WZ3]=jvj+9; 
(*f[189])( );     /*TRI4(jvj+8,3437,246,jvj+9)*/
pile[v[22]]=jvj+9; pile[WZ1]=20017; pile[WZ2]=218; pile[WZ3]=jvj+10; 
(*f[58])( );     /*TRI3(jvj+9,20017,218,jvj+10)*/
