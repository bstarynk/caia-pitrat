...
(*f[1738])( );if(v[102]) goto l10;     /*EVLM0(R,jvj+3,jvj+4,V1)*/
V1=pile[WZ3]; 
if((V1!=135)) goto l10;
x[jvj+45]=t[x[jvj+45]];
...
pile[v[22]]=jvj+41; pile[WZ1]=3320; pile[WZ2]=246; pile[WZ3]=jvj+42; 
(*f[189])( );     /*TRI4(jvj+41,3320,246,jvj+42)*/
...
(*f[1969])( );     /*FNDEND0(365,jvj+3,jvj+5)*/
