/* transformed file by ../improve-generated-dx.cc from _old_dx_.h to dx.h*/
...
/*@@@@@ corrected by ./improve-generated-dx*/
#ifndef CAIA_GLOBAL_VAR
#define CAIA_GLOBAL_VAR extern
#endif /*CAIA_GLOBAL_VAR @@@@*/
...
/*** CAIA global variables: */
CAIA_GLOBAL_VAR short int cpa[32768];
CAIA_GLOBAL_VAR long lon;
CAIA_GLOBAL_VAR int t[30000001];
CAIA_GLOBAL_VAR int s[30000001];
CAIA_GLOBAL_VAR short int r[30000001];
CAIA_GLOBAL_VAR int v[301];
CAIA_GLOBAL_VAR int d[300];
CAIA_GLOBAL_VAR char bh[6][300];
CAIA_GLOBAL_VAR char c[6][40000];
CAIA_GLOBAL_VAR short int z[100000];
CAIA_GLOBAL_VAR int x[100000];
CAIA_GLOBAL_VAR int fa[6];
CAIA_GLOBAL_VAR int a;
CAIA_GLOBAL_VAR int i;
CAIA_GLOBAL_VAR char sy[1000000];
CAIA_GLOBAL_VAR char sw[1000000];
CAIA_GLOBAL_VAR int lpr[32000];
CAIA_GLOBAL_VAR int phb[32768];
CAIA_GLOBAL_VAR int cpb[32768];
CAIA_GLOBAL_VAR int ou[6000001];
CAIA_GLOBAL_VAR int av[6000001];
CAIA_GLOBAL_VAR short int pl[6000001];
CAIA_GLOBAL_VAR short int ty[6000001];
CAIA_GLOBAL_VAR int w[30001][10];
CAIA_GLOBAL_VAR int vo[50];
CAIA_GLOBAL_VAR int vz[50];
CAIA_GLOBAL_VAR char temps[50];
CAIA_GLOBAL_VAR ptrfonc_t f[10000];
CAIA_GLOBAL_VAR void *binpart[10000];
CAIA_GLOBAL_VAR char srt[100];
CAIA_GLOBAL_VAR char res[100];
CAIA_GLOBAL_VAR int g[1001];
CAIA_GLOBAL_VAR int vg[1001];
CAIA_GLOBAL_VAR short int vnd[10000][40];
CAIA_GLOBAL_VAR short int knd[10000];
CAIA_GLOBAL_VAR short int knr[10000];
CAIA_GLOBAL_VAR int pile[1000000];
CAIA_GLOBAL_VAR short int tnd[10000][40];
CAIA_GLOBAL_VAR short int vbl[10000];
CAIA_GLOBAL_VAR int prov[200];
CAIA_GLOBAL_VAR int gardevaleur[50];
CAIA_GLOBAL_VAR short int sansechec[10000];
CAIA_GLOBAL_VAR short int tp[600002];
CAIA_GLOBAL_VAR short int tt[600002];
CAIA_GLOBAL_VAR int tn[600002];
CAIA_GLOBAL_VAR int ta1[600002];
CAIA_GLOBAL_VAR int ta2[600002];
CAIA_GLOBAL_VAR int ta3[600002];
CAIA_GLOBAL_VAR int ta4[600002];
CAIA_GLOBAL_VAR int ta5[600002];
CAIA_GLOBAL_VAR short int tm[600002];
CAIA_GLOBAL_VAR short int ctt[2000];
CAIA_GLOBAL_VAR char *error;
CAIA_GLOBAL_VAR short int vu[30001];
CAIA_GLOBAL_VAR short int opn[10000];
CAIA_GLOBAL_VAR time_t *tzt;
CAIA_GLOBAL_VAR int vv[201];
CAIA_GLOBAL_VAR int depuis;
CAIA_GLOBAL_VAR int ensuite;
CAIA_GLOBAL_VAR int m;
CAIA_GLOBAL_VAR int ww[101];
CAIA_GLOBAL_VAR FILE *fx[101];
CAIA_GLOBAL_VAR int sk[201][401];
CAIA_GLOBAL_VAR int mr;
CAIA_GLOBAL_VAR int xxzxx[100001];
CAIA_GLOBAL_VAR short int ctt[2000];
CAIA_GLOBAL_VAR short int ctp[2000];
CAIA_GLOBAL_VAR short int ctm[2000];
CAIA_GLOBAL_VAR int ctn[2000];
CAIA_GLOBAL_VAR int cta1[2000];
CAIA_GLOBAL_VAR int cta2[2000];
CAIA_GLOBAL_VAR int cta3[2000];
CAIA_GLOBAL_VAR int cta4[2000];
CAIA_GLOBAL_VAR int cta5[2000];
CAIA_GLOBAL_VAR int tu[600002];
CAIA_GLOBAL_VAR int cts[2000];
CAIA_GLOBAL_VAR int ctu[2000];
CAIA_GLOBAL_VAR int ctw[2000];
CAIA_GLOBAL_VAR short int ctx[2000];
CAIA_GLOBAL_VAR short int ts[600002];
CAIA_GLOBAL_VAR int ii;
CAIA_GLOBAL_VAR char vdna[2000];
CAIA_GLOBAL_VAR int j;
CAIA_GLOBAL_VAR int h[300][4];
CAIA_GLOBAL_VAR int du[300];
CAIA_GLOBAL_VAR int td[300];
CAIA_GLOBAL_VAR int qt[300];
CAIA_GLOBAL_VAR int q;
CAIA_GLOBAL_VAR int k;
CAIA_GLOBAL_VAR int u[4][8];
CAIA_GLOBAL_VAR int n[2000];
CAIA_GLOBAL_VAR int b;
CAIA_GLOBAL_VAR int ic;
CAIA_GLOBAL_VAR char cmt[3000][80];
CAIA_GLOBAL_VAR char sycmt[80];
CAIA_GLOBAL_VAR char swcmt[80];
CAIA_GLOBAL_VAR short int pres[10000];
