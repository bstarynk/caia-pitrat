...
{int V1=0,C=0,V2=0,T=0,V7=0,V4=0,V3=0,H=0,V5=0,V8=0,V9=0,V10=0,V11=0,V13=0,V15=0,V17=0,V19=0,V6=0;
int A,B,K;
int S;
int WZ1,WZ2,WZ3;
int jvj;
...
A=pile[v[22]]; B=pile[v[22]+1]; K=pile[v[22]+2]; v[22]+=4; 
...
(*f[1779])( );if(v[102]) goto l4;     /*RESEQDV1(B,C,V7,T)*/
T=pile[WZ3]; 
l2:V4=A*T;
V3=V4+K;
H=V3;
...
l3:V6=H/B;
S=V6;
l5:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=4; pile[v[22]+3]=S; v[102]=0;return;
l1:V2=B-K;
T=V2;
goto l2;
