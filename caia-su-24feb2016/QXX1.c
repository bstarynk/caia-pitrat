...
BL=pile[v[22]]; N=pile[v[22]+1]; M=pile[v[22]+2]; v[22]+=3; 
WZ5=v[22]+5; WZ4=v[22]+4; WZ3=v[22]+3; WZ2=v[22]+2; WZ1=v[22]+1; 
x[jvj+3]=incon;
if((x[BL]!=10290)) goto l4;
x[jvj+4]=vo[14];z[jvj+4]=vz[14];
pile[v[22]]=405; pile[WZ1]=jvj+4; 
(*f[26])( );if(v[102]) goto l4;     /*FNDC0(405,jvj+4,V2)*/
V2=pile[WZ2]; 
I=0;
l2:if((I>V2)) goto l4;
pile[v[22]]=BL; pile[WZ1]=I; pile[WZ2]=jvj+5; 
(*f[133])( );if(v[102]) goto l3;     /*TLDEBL1(BL,I,jvj+5)*/
pile[v[22]]=jvj+5; pile[WZ1]=46; 
(*f[339])( );     /*CMP0(jvj+5,46)*/
l3:I++;
goto l2;
l1:pile[v[22]]=372; pile[WZ1]=jvj+3; 
(*f[71])( );     /*ENLV0(372,jvj+3)*/
l5:v[131]=0;
v[132]=0;
if((x[BL]==10290)) goto l7;
pile[v[22]]=jvj+3; 
(*f[306])( );     /*EAC0(jvj+3)*/
pile[WZ1]=46; 
(*f[339])( );     /*CMP0(jvj+3,46)*/
l7:if((v[132]==0)) goto l8;
x[jvj+7]=vo[14];z[jvj+7]=vz[14];
pile[v[22]]=jvj+7; pile[WZ1]=935; pile[WZ2]=953; 
(*f[35])( );     /*CHGC1(jvj+7,935,953)*/
l8:if((v[131]==0)) goto l10;
x[jvj+6]=vo[16];z[jvj+6]=vz[16];
pile[v[22]]=498; pile[WZ1]=jvj+6; pile[WZ2]=jvj+8; 
(*f[32])( );if(v[102]) goto l10;     /*FNDO0(498,jvj+6,jvj+8)*/
V16=incon;
pile[v[22]]=163; 
(*f[44])( );if(v[102]) goto l6;     /*FNDC1(163,jvj+6,LL)*/
LL=pile[WZ2]; 
V16=LL;
l9:V14=0;
...
l10:if(x[jvj+3]!=incon) goto l11;
l12:if((v[131]!=0)) goto l17;
if((v[132]!=0)) goto l17;
if((x[BL]!=10290)) goto l17;
x[jvj+11]=vo[14];z[jvj+11]=vz[14];
pile[v[22]]=405; pile[WZ1]=jvj+11; 
(*f[26])( );if(v[102]) goto l17;     /*FNDC0(405,jvj+11,V26)*/
V26=pile[WZ2]; 
V24=0;
l13:if((V24>V26)) goto l17;
pile[v[22]]=BL; pile[WZ1]=V24; pile[WZ2]=jvj+12; 
(*f[133])( );if(v[102]) goto l14;     /*TLDEBL1(BL,V24,jvj+12)*/
pile[v[22]]=246; pile[WZ1]=jvj+12; 
(*f[26])( );if(v[102]) goto l14;     /*FNDC0(246,jvj+12,V28)*/
V28=pile[WZ2]; 
...
l14:V24++;
goto l13;
l4:pile[v[22]]=BL; pile[WZ1]=N; pile[WZ2]=jvj+3; 
(*f[133])( );if(v[102]) goto l7;     /*TLDEBL1(BL,N,jvj+3)*/
if((M==78)) goto l1;
if((M!=66)) goto l5;
pile[v[22]]=jvj+3; pile[WZ1]=372; pile[WZ2]=68; 
(*f[35])( );     /*CHGC1(jvj+3,372,68)*/
goto l5;
l6:V16=((-6488));
goto l9;
l11:if((v[131]!=0)) goto l12;
if((v[132]!=0)) goto l12;
if((x[BL]==10290)) goto l12;
pile[v[22]]=246; pile[WZ1]=jvj+3; 
(*f[26])( );if(v[102]) goto l12;     /*FNDC0(246,jvj+3,V23)*/
V23=pile[WZ2]; 
...
(*f[340])( );     /*EACB0(jvj+10)*/
goto l12;
l15:pile[v[22]]=V30; pile[WZ1]=83; 
(*f[38])( );     /*SPC0(V30,83,V29)*/
V29=pile[WZ2]; 
l16:pile[v[22]]=V29; 
(*f[40])( );     /*SLG0(V29)*/
l18:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=3; return;
l17:if((v[131]!=0)) goto l18;
if((v[132]!=0)) goto l18;
if((x[BL]!=10290)) goto l18;
V31=(time(tzt)-inccc);
v[145]=0;
(*f[174])( );     /*COMB0()*/
V32=vv[33];
