...
(*f[1975])( );if(v[102]) goto l1;     /*FNDCND0(750,jvj+5,V3)*/
V3=pile[WZ2]; 
if((V1>=V3)) goto l1;
...
pile[v[22]]=jvj+8; pile[WZ1]=3430; pile[WZ2]=246; pile[WZ3]=jvj+9; 
(*f[189])( );     /*TRI4(jvj+8,3430,246,jvj+9)*/
