...
(*f[32])( );if(v[102]) goto l3;     /*FNDO0(103,R,jvj+10)*/
l1:if((x[jvj+8]<=0)) goto l3;
x[jvj+11]=s[x[jvj+8]] ;z[jvj+11]=(x[jvj+11]<=sepcte) ? x[jvj+11] : z[jvj+8];
pile[v[22]]=jvj+11; pile[WZ1]=jvj+9; pile[WZ2]=jvj+12; 
(*f[3109])( );if(v[102]) goto l2;     /*INFG0(jvj+11,jvj+9,jvj+12)*/
pile[WZ1]=jvj+10; pile[WZ2]=jvj+13; 
(*f[3108])( );if(v[102]) goto l2;     /*SUPG0(jvj+11,jvj+10,jvj+13)*/
pile[v[22]]=101; pile[WZ1]=R; pile[WZ2]=110; pile[WZ3]=(-601); pile[WZ4]=jvj+20; 
(*f[270])( );     /*QUADRI7(101,R,110,(-601),jvj+20)*/
pile[v[22]]=V11; pile[WZ1]=858; pile[WZ2]=jvj+16; 
(*f[46])( );     /*TRI0(V11,858,jvj+16)*/
pile[v[22]]=jvj+16; pile[WZ1]=v[13]; pile[WZ2]=642; pile[WZ3]=jvj+17; 
(*f[189])( );     /*TRI4(jvj+16,v[13],642,jvj+17)*/
pile[v[22]]=jvj+17; pile[WZ1]=3377; pile[WZ2]=246; pile[WZ3]=jvj+18; 
(*f[189])( );     /*TRI4(jvj+17,3377,246,jvj+18)*/
pile[v[22]]=jvj+18; pile[WZ1]=20192; pile[WZ2]=218; pile[WZ3]=jvj+19; 
(*f[58])( );     /*TRI3(jvj+18,20192,218,jvj+19)*/
...
pile[v[22]]=100; pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=30; pile[WZ4]=jvj+22; 
(*f[181])( );     /*QUADRI2(100,20,101,30,jvj+22)*/
