...
(*f[32])( );if(v[102]) goto l6;     /*FNDO0(103,R,jvj+3)*/
...
if(x[jvj+5]!=25&&x[jvj+5]!=27&&x[jvj+5]!=28) goto l6;
V1=incon;
if((x[jvj+5]!=27)) goto l1;
V21=L+1;
V1=V21;
l1:if(x[jvj+5]==25||x[jvj+5]==28) goto l2;
if(V1==incon) goto l6;
l3:if((V1==(-99999998))) goto l6;
pile[v[22]]=102; pile[WZ1]=R; pile[WZ2]=jvj+6; 
(*f[32])( );if(v[102]) goto l6;     /*FNDO0(102,R,jvj+6)*/
...
pile[v[22]]=jvj+19; pile[WZ1]=3246; pile[WZ2]=246; pile[WZ3]=jvj+20; 
(*f[189])( );     /*TRI4(jvj+19,3246,246,jvj+20)*/
pile[v[22]]=158; pile[WZ1]=1; pile[WZ2]=218; pile[WZ3]=20007; pile[WZ4]=jvj+20; pile[WZ5]=jvj+17; 
(*f[269])( );     /*QUADRI6(158,1,218,20007,jvj+20,jvj+17)*/
