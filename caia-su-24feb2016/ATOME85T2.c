...
(*f[26])( );if(v[102]) goto l6;     /*FNDC0(997,G,L)*/
L=pile[WZ2]; 
x[jvj+7]=incon;
if((L==1)) goto l1;
if((L<2)) goto l6;
...
l7:pile[v[22]]=jvj+7; pile[WZ1]=715; pile[WZ2]=jvj+8; 
(*f[54])( );     /*TRI1(jvj+7,715,jvj+8)*/
pile[v[22]]=jvj+8; pile[WZ1]=v[13]; pile[WZ2]=642; pile[WZ3]=jvj+9; 
(*f[189])( );     /*TRI4(jvj+8,v[13],642,jvj+9)*/
pile[v[22]]=jvj+9; pile[WZ1]=3110; pile[WZ2]=246; pile[WZ3]=jvj+10; 
(*f[189])( );     /*TRI4(jvj+9,3110,246,jvj+10)*/
pile[v[22]]=158; pile[WZ1]=187; pile[WZ2]=218; pile[WZ3]=20085; pile[WZ4]=jvj+10; pile[WZ5]=jvj+6; 
(*f[269])( );     /*QUADRI6(158,187,218,20085,jvj+10,jvj+6)*/
pile[v[22]]=jvj+6; 
