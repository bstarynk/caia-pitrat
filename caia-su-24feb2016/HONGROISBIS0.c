...
pile[v[22]]=100; pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V8; pile[WZ4]=jvj+12; 
(*f[192])( );     /*QUADRI4(100,41,130,V8,jvj+12)*/
...
l3:pile[v[22]]=100; pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-1544); pile[WZ4]=jvj+7; 
