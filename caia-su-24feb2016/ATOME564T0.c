...
{int V32=0,V26=0,V31=0,V23=0,V28=0,V25=0,V22=0;
int VV;
int WZ1,WZ2,WZ3,WZ4;
int jvj;
jvj=v[0];
v[0]+=42;
x[jvj+1]=20564;z[jvj+1]=(-100);
if(v[0]>99700) (*f[6])( );
if(v[90]==3946&&v[97]==0) {
...
pile[v[22]]=202; pile[WZ1]=VV; pile[WZ2]=jvj+20; 
(*f[1948])( );if(v[102]) goto l16;     /*FNDOND0(202,VV,jvj+20)*/
...
V32=pile[WZ2]; 
pile[v[22]]=365; pile[WZ1]=VV; pile[WZ2]=jvj+22; 
(*f[1969])( );     /*FNDEND0(365,VV,jvj+22)*/
for(i=x[jvj+22],V26=0;i>0;i=t[i],V26++)  ;
pile[v[22]]=509; pile[WZ2]=jvj+23; 
(*f[1969])( );     /*FNDEND0(509,VV,jvj+23)*/
...
if((V31!=3)) goto l8;
for(a=x[jvj+25];a>0;a=t[a]) if(s[a]==x[VV]) goto l10;
...
pile[v[22]]=VV; pile[WZ2]=jvj+4; pile[WZ3]=jvj+5; 
(*f[1719])( );     /*SUBSTITUTES0(VV,jvj+3,jvj+4,jvj+5)*/
pile[v[22]]=jvj+6; pile[WZ1]=jvj+7; 
(*f[1972])( );if(v[102]) goto l15;     /*INVEXP0(jvj+6,jvj+7)*/
pile[v[22]]=jvj+8; pile[WZ2]=jvj+5; pile[WZ3]=jvj+9; 
(*f[1719])( );     /*SUBSTITUTES0(jvj+8,jvj+7,jvj+5,jvj+9)*/
...
pile[v[22]]=jvj+13; pile[WZ1]=jvj+14; pile[WZ2]=VV; pile[WZ3]=jvj+15; 
(*f[3850])( );if(v[102]) goto l5;     /*COMPAT0(jvj+13,jvj+14,VV,jvj+15)*/
pile[v[22]]=jvj+8; pile[WZ1]=jvj+6; pile[WZ3]=jvj+16; 
(*f[3850])( );if(v[102]) goto l5;     /*COMPAT0(jvj+8,jvj+6,VV,jvj+16)*/
...
if((x[jvj+8]==x[jvj+13])) goto l13;
if((x[VV]==x[jvj+8])) goto l13;
pile[v[22]]=202; pile[WZ1]=jvj+8; pile[WZ2]=jvj+28; 
(*f[1948])( );if(v[102]) goto l13;     /*FNDOND0(202,jvj+8,jvj+28)*/
if((x[jvj+28]!=68)) goto l13;
pile[v[22]]=365; pile[WZ2]=jvj+29; 
(*f[1969])( );     /*FNDEND0(365,jvj+8,jvj+29)*/
for(i=x[jvj+29],V28=0;i>0;i=t[i],V28++)  ;
V25=V26*V28;
V22=V23*V25;
if((V22>=500)) goto l13;
...
pile[WZ1]=jvj+14; pile[WZ2]=jvj+8; pile[WZ3]=jvj+19; 
(*f[3850])( );if(v[102]) goto l17;     /*COMPAT0(jvj+13,jvj+14,jvj+8,jvj+19)*/
...
l17:pile[v[22]]=101; pile[WZ1]=VV; pile[WZ2]=110; pile[WZ3]=(-671); pile[WZ4]=jvj+36; 
(*f[270])( );     /*QUADRI7(101,VV,110,(-671),jvj+36)*/
...
pile[v[22]]=jvj+33; pile[WZ1]=3946; pile[WZ2]=246; pile[WZ3]=jvj+34; 
(*f[189])( );     /*TRI4(jvj+33,3946,246,jvj+34)*/
pile[v[22]]=jvj+34; pile[WZ1]=20564; pile[WZ2]=218; pile[WZ3]=jvj+35; 
(*f[58])( );     /*TRI3(jvj+34,20564,218,jvj+35)*/
