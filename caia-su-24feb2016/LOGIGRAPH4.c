...
(*f[203])( );if(v[102]) goto l2;     /*FTAB0(1,I,(-8615),V3)*/
V3=pile[WZ3]; 
if((V3<=0)) goto l2;
pile[v[22]]=I; pile[WZ1]=(-8615); 
(*f[3979])( );if(v[102]) goto l2;     /*LONGUEUR0(I,(-8615),V2)*/
V2=pile[WZ2]; 
V7=V2-1;
V9=I*MH;
J=1;
l4:if((J>V7)) goto l2;
pile[v[22]]=J; pile[WZ1]=I; pile[WZ2]=(-8615); 
(*f[203])( );if(v[102]) goto l5;     /*FTAB0(J,I,(-8615),V4)*/
V4=pile[WZ3]; 
V8=J+V9;
V11=J-1;
V10=V11+V9;
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-2850); pile[WZ4]=jvj+15; 
(*f[270])( );     /*QUADRI7(100,21,140,(-2850),jvj+15)*/
