...
{int V9=0,K=0,V8=0,V7=0,I=0;
int NNNE;
int WZ1,WZ2,WZ3,WZ4,WZ5;
int jvj;
jvj=v[0];
v[0]+=26;
x[jvj+1]=26228;z[jvj+1]=(-100);
if(v[0]>99700) (*f[6])( );
if(v[90]==2917&&v[97]==0) {
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V7; pile[WZ4]=jvj+12; 
(*f[192])( );     /*QUADRI4(100,41,130,V7,jvj+12)*/
...
pile[v[22]]=100; pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-620); pile[WZ4]=jvj+24; 
(*f[270])( );     /*QUADRI7(100,21,140,(-620),jvj+24)*/
...
pile[v[22]]=100; pile[WZ1]=484; pile[WZ2]=102; pile[WZ3]=jvj+26; pile[WZ4]=jvj+25; pile[WZ5]=jvj+18; 
(*f[269])( );     /*QUADRI6(100,484,102,jvj+26,jvj+25,jvj+18)*/
