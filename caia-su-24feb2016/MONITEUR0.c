...
x[jvj+3]=x[jvj+24]=x[jvj+34]=x[jvj+23]=incon;
...
l32:x[jvj+41]=68 ;z[jvj+41]=68;
if(x[jvj+3]!=incon) goto l33;
l40:if(x[jvj+24]==incon) goto l41;
l45:if(x[jvj+3]!=incon) goto l46;
if(x[jvj+24]!=incon) goto l50;
l51:if(x[jvj+23]==incon) goto l52;
l54:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=1; return;
...
if((x[jvj+3]==493)) goto l56;
if((x[jvj+3]==1084)) goto l23;
if((x[jvj+3]==228)) goto l57;
...
(*f[958])( );if(v[102]) goto l25;     /*MANAGER1(jvj+27,jvj+24)*/
goto l32;
l6:x[jvj+49]=1196 ;z[jvj+49]=1196;
l28:x[jvj+41]=x[jvj+29] ;z[jvj+41]=z[jvj+29];
...
l30:x[jvj+24]=x[jvj+50] ;z[jvj+24]=z[jvj+50];
goto l32;
l10:x[jvj+50]=1336 ;z[jvj+50]=1336;
goto l30;
l11:if((v[206]<=0)) goto l29;
(*f[962])( );     /*APPLIREG0()*/
l29:pile[v[22]]=M; pile[WZ1]=jvj+30; 
(*f[963])( );if(v[102]) goto l32;     /*EXAMEN0(M,jvj+30)*/
x[jvj+50]=incon;
...
if((x[jvj+17]==135)) goto l55;
l14:x[jvj+13]=t[x[jvj+13]];
goto l13;
l15:x[jvj+51]=80 ;z[jvj+51]=80;
l31:x[jvj+24]=x[jvj+51] ;z[jvj+24]=z[jvj+51];
goto l32;
...
goto l32;
l21:x[jvj+24]=120 ;z[jvj+24]=120;
goto l32;
l22:pile[v[22]]=jvj+24; 
(*f[960])( );if(v[102]) goto l25;     /*MONITORE0(jvj+24)*/
goto l32;
l23:pile[v[22]]=M; 
(*f[964])( );     /*BILANSANSCHOIX0(M)*/
l24:x[jvj+24]=12 ;z[jvj+24]=12;
goto l32;
...
(*f[958])( );if(v[102]) goto l26;     /*MANAGER1(jvj+28,jvj+24)*/
goto l32;
l26:if((x[jvj+3]==865)) goto l27;
if((x[jvj+3]==84)) goto l11;
if((x[jvj+3]!=287)) goto l32;
pile[v[22]]=218; pile[WZ1]=M; pile[WZ2]=jvj+31; 
(*f[32])( );if(v[102]) goto l32;     /*FNDO0(218,M,jvj+31)*/
pile[v[22]]=860; pile[WZ1]=jvj+31; pile[WZ2]=jvj+32; 
(*f[32])( );if(v[102]) goto l32;     /*FNDO0(860,jvj+31,jvj+32)*/
if((x[jvj+32]==368)) goto l32;
...
goto l31;
l27:pile[v[22]]=M; pile[WZ1]=jvj+29; 
(*f[956])( );if(v[102]) goto l32;     /*VEILLE0(M,jvj+29)*/
x[jvj+49]=incon;
...
goto l14;
l56:pile[v[22]]=493; pile[WZ1]=158; pile[WZ2]=jvj+25; 
(*f[54])( );     /*TRI1(493,158,jvj+25)*/
pile[v[22]]=jvj+25; pile[WZ1]=jvj+24; 
(*f[958])( );if(v[102]) goto l25;     /*MANAGER1(jvj+25,jvj+24)*/
goto l32;
l57:pile[v[22]]=228; pile[WZ1]=158; pile[WZ2]=jvj+26; 
