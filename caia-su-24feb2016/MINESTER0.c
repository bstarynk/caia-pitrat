...
{int V11=0,V10=0,V9=0,V13=0,V12=0,XX=0,V15=0,V19=0,V18=0,YY=0,V16=0,V17=0,V7=0,A=0,V5=0;
int N;
int NNNE;
...
l8:pile[v[22]]=A; pile[WZ1]=(-630); 
(*f[201])( );if(v[102]) goto l7;     /*FCOEFF0(A,(-630),V5)*/
V5=pile[WZ2]; 
x[jvj+2]=0 ;z[jvj+2]=0;
V11=A-1;
V10=V11/N;
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V17; pile[WZ4]=jvj+9; 
(*f[192])( );     /*QUADRI4(100,41,130,V17,jvj+9)*/
...
pile[WZ3]=1215; pile[WZ4]=jvj+15; 
(*f[181])( );     /*QUADRI2(100,20,101,1215,jvj+15)*/
...
pile[v[22]]=100; pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V5; pile[WZ4]=jvj+12; 
(*f[192])( );     /*QUADRI4(100,41,130,V5,jvj+12)*/
