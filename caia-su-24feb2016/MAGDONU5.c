...
{int I=0,V7=0,V2=0,V9=0,V4=0,V8=0,V3=0,V11=0,V5=0,K=0,V12=0;
int NNNE;
...
V9=I+1;
pile[v[22]]=V9; 
(*f[201])( );if(v[102]) goto l1;     /*FCOEFF0(V9,(-630),V4)*/
V4=pile[WZ2]; 
l3:if((V9>16)) goto l1;
V8=V9%2;
if((V8==0)) goto l4;
pile[v[22]]=V9; pile[WZ1]=(-630); 
(*f[201])( );if(v[102]) goto l4;     /*FCOEFF0(V9,(-630),V3)*/
V3=pile[WZ2]; 
if((V2!=V3)) goto l4;
V11=V9+1;
pile[v[22]]=V11; 
(*f[201])( );if(v[102]) goto l4;     /*FCOEFF0(V11,(-630),V5)*/
V5=pile[WZ2]; 
if((V4!=V5)) goto l4;
K=1;
l5:V12=K+1;
l6:if((V12<=16)) goto l8;
K++;
if((K<=16)) goto l5;
l4:V9++;
goto l3;
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V12; pile[WZ4]=jvj+22; 
(*f[192])( );     /*QUADRI4(100,41,130,V12,jvj+22)*/
