...
{int I=0,V12=0,V6=0,II=0,V14=0,V9=0;
int N,K;
int NNNE;
...
jvj=v[0];
v[0]+=35;
x[jvj+1]=26130;z[jvj+1]=(-100);
if(v[0]>99700) (*f[6])( );
if(v[90]==2544&&v[97]==0) {
(*f[4])( ); x[jvj+1]=incon;v[0]=jvj;return;
}
N=pile[v[22]]; K=pile[v[22]+1]; NNNE=pile[v[22]+2]; v[22]+=3; 
...
pile[v[22]]=100; pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=K; pile[WZ4]=jvj+29; 
(*f[192])( );     /*QUADRI4(100,41,130,K,jvj+29)*/
pile[WZ1]=22; pile[WZ2]=111; pile[WZ3]=jvj+27; pile[WZ4]=jvj+26; 
...
pile[v[22]]=jvj+35; pile[WZ1]=22; pile[WZ2]=100; pile[WZ3]=jvj+24; 
(*f[58])( );     /*TRI3(jvj+35,22,100,jvj+24)*/
