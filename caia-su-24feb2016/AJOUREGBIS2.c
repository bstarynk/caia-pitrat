...
T=(-1);
l14:pile[v[22]]=100; pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=BL; pile[WZ4]=jvj+13; 
...
l10:if((x[XP]==250)) goto l11;
pile[v[22]]=jvj+9; pile[WZ1]=107; pile[WZ2]=XP; 
(*f[36])( );     /*PLUSC0(jvj+9,107,XP)*/
l11:pile[v[22]]=120; pile[WZ1]=jvj+6; pile[WZ2]=jvj+12; 
(*f[32])( );if(v[102]) goto l12;     /*FNDO0(120,jvj+6,jvj+12)*/
pile[v[22]]=jvj+9; pile[WZ1]=120; 
(*f[35])( );     /*CHGC1(jvj+9,120,jvj+12)*/
l12:pile[v[22]]=jvj+6; pile[WZ1]=120; pile[WZ2]=jvj+9; 
