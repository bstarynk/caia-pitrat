...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-8863); pile[WZ4]=jvj+9; 
(*f[270])( );     /*QUADRI7(100,21,140,(-8863),jvj+9)*/
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V4; pile[WZ4]=jvj+6; 
(*f[192])( );     /*QUADRI4(100,41,130,V4,jvj+6)*/
