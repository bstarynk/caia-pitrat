...
{int V6=0,V5=0,V22=0,V1=0,V38=0;
int RR;
...
pile[v[22]]=870; 
(*f[26])( );if(v[102]) goto l8;     /*FNDC0(870,jvj+14,V5)*/
V5=pile[WZ2]; 
if((V5>V6)) goto l8;
