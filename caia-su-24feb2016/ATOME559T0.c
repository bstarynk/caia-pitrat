...
(*f[1975])( );if(v[102]) goto l3;     /*FNDCND0(472,V,V5)*/
V5=pile[WZ2]; 
...
(*f[1029])( );     /*DIFFAPP0(jvj+6,jvj+3,jvj+7)*/
...
pile[v[22]]=jvj+10; pile[WZ1]=3792; pile[WZ2]=246; pile[WZ3]=jvj+11; 
(*f[189])( );     /*TRI4(jvj+10,3792,246,jvj+11)*/
...
(*f[1569])( );     /*DELIER0(365,V,jvj+6,jvj+8)*/
goto l2;
}
