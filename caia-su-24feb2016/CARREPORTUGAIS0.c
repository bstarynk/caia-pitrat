...
{int J=0,V9=0,V6=0,I=0,V5=0,M=0;
int NNNE;
int WZ1,WZ2,WZ3,WZ4,WZ5;
int jvj;
jvj=v[0];
v[0]+=29;
x[jvj+1]=26231;z[jvj+1]=(-100);
if(v[0]>99700) (*f[6])( );
if(v[90]==2927&&v[97]==0) {
...
J=1;
l3:V9=4-J;
pile[v[22]]=V9; pile[WZ1]=10; 
(*f[1006])( );if(v[102]) goto l2;     /*POWER0(V9,10,V6)*/
V6=pile[WZ2]; 
...
pile[WZ1]=89; pile[WZ2]=162; pile[WZ3]=M; pile[WZ4]=jvj+12; 
(*f[272])( );     /*QUADRI9(100,89,162,M,jvj+12)*/
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V6; pile[WZ4]=jvj+9; 
(*f[192])( );     /*QUADRI4(100,41,130,V6,jvj+9)*/
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-2041); pile[WZ4]=jvj+24; 
(*f[270])( );     /*QUADRI7(100,21,140,(-2041),jvj+24)*/
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-2041); pile[WZ4]=jvj+27; 
(*f[270])( );     /*QUADRI7(100,21,140,(-2041),jvj+27)*/
...
pile[v[22]]=100; pile[WZ1]=484; pile[WZ2]=102; pile[WZ3]=jvj+29; pile[WZ4]=jvj+28; pile[WZ5]=jvj+23; 
(*f[269])( );     /*QUADRI6(100,484,102,jvj+29,jvj+28,jvj+23)*/
pile[WZ1]=22; pile[WZ2]=111; pile[WZ3]=jvj+21; pile[WZ4]=jvj+15; 
(*f[181])( );     /*QUADRI2(100,22,111,jvj+21,jvj+15)*/
pile[v[22]]=jvj+15; pile[WZ1]=107; pile[WZ2]=jvj+22; 
(*f[36])( );     /*PLUSC0(jvj+15,107,jvj+22)*/
pile[WZ2]=jvj+23; 
