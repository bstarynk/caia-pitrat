...
(*f[1975])( );if(v[102]) goto l3;     /*FNDCND0(473,N,V3)*/
V3=pile[WZ2]; 
...
if((V1>=V3)) goto l2;
pile[v[22]]=101; pile[WZ2]=110; pile[WZ3]=(-656); pile[WZ4]=jvj+12; 
(*f[270])( );     /*QUADRI7(101,jvj+5,110,(-656),jvj+12)*/
...
pile[v[22]]=jvj+10; pile[WZ1]=3289; pile[WZ2]=246; pile[WZ3]=jvj+11; 
(*f[189])( );     /*TRI4(jvj+10,3289,246,jvj+11)*/
pile[v[22]]=158; pile[WZ1]=1; pile[WZ2]=218; pile[WZ3]=20026; pile[WZ4]=jvj+11; pile[WZ5]=jvj+8; 
(*f[269])( );     /*QUADRI6(158,1,218,20026,jvj+11,jvj+8)*/
