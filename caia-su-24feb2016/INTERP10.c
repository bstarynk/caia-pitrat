...
{int V1=0;
int ZZG,ZZBL,ZZN,OS1,O1,ES1,E1;
int RES;
...
ZZG=pile[v[22]]; ZZBL=pile[v[22]+1]; ZZN=pile[v[22]+2]; OS1=pile[v[22]+3]; O1=pile[v[22]+4]; ES1=pile[v[22]+5]; E1=pile[v[22]+6]; RES=pile[v[22]+7]; v[22]+=8; 
