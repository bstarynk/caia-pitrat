...
{int V11=0,V10=0,V9=0,V13=0,V12=0,L=0,V16=0,V15=0,V6=0,J=0;
int N;
int NNNE;
...
V16=3*N;
V15=V16-6;
pile[v[22]]=V15; pile[WZ1]=6; 
(*f[1006])( );if(v[102]) goto l6;     /*POWER0(V15,6,V6)*/
V6=pile[WZ2]; 
J=1;
l5:if((J>N)) goto l6;
x[jvj+2]=0 ;z[jvj+2]=0;
...
J++;
goto l5;
l2:pile[v[22]]=jvj+2; pile[WZ1]=V9; 
