...
NT=pile[v[22]]; NH=pile[v[22]+1]; A=pile[v[22]+2]; NNNE=pile[v[22]+3]; v[22]+=4; 
...
l5:if((J<=I)) goto l14;
pile[v[22]]=X; pile[WZ1]=(-7730); 
(*f[3979])( );if(v[102]) goto l16;     /*LONGUEUR0(X,(-7730),V8)*/
V8=pile[WZ2]; 
S=1;
l3:if((S>V8)) goto l16;
pile[v[22]]=S; pile[WZ1]=X; pile[WZ2]=(-7730); 
(*f[203])( );if(v[102]) goto l4;     /*FTAB0(S,X,(-7730),V9)*/
V9=pile[WZ3]; 
SS=V9;
if((SS<=I)) goto l4;
if((SS<J)) goto l14;
...
l9:if((X>NH)) goto l7;
pile[v[22]]=X; pile[WZ1]=(-7730); 
(*f[3979])( );if(v[102]) goto l10;     /*LONGUEUR0(X,(-7730),V2)*/
V2=pile[WZ2]; 
XX=1;
l11:if((XX>V2)) goto l10;
pile[v[22]]=XX; pile[WZ1]=X; pile[WZ2]=(-7730); 
(*f[203])( );if(v[102]) goto l12;     /*FTAB0(XX,X,(-7730),V3)*/
V3=pile[WZ3]; 
if((V3!=I)) goto l12;
YY=1;
l13:if((YY>V2)) goto l12;
if((YY==XX)) goto l14;
pile[v[22]]=YY; pile[WZ1]=X; pile[WZ2]=(-7730); 
(*f[203])( );if(v[102]) goto l14;     /*FTAB0(YY,X,(-7730),V5)*/
V5=pile[WZ3]; 
J=V5;
for(a=x[A];a>0;a=t[a]) if(s[a]==J) goto l14;
if((J>=I)) goto l5;
pile[v[22]]=X; pile[WZ1]=(-7730); 
(*f[3979])( );if(v[102]) goto l16;     /*LONGUEUR0(X,(-7730),V6)*/
V6=pile[WZ2]; 
Z=1;
l1:if((Z>V6)) goto l16;
pile[v[22]]=Z; pile[WZ1]=X; pile[WZ2]=(-7730); 
(*f[203])( );if(v[102]) goto l2;     /*FTAB0(Z,X,(-7730),V7)*/
V7=pile[WZ3]; 
ZZ=V7;
if((ZZ>=I)) goto l2;
if((ZZ>J)) goto l5;
