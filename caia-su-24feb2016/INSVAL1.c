...
X=pile[v[22]]; P=pile[v[22]+1]; L=pile[v[22]+2]; v[22]+=3; 
WZ4=v[22]+4; WZ3=v[22]+3; WZ2=v[22]+2; WZ1=v[22]+1; 
x[L]=incon;
pile[v[22]]=120; pile[WZ1]=X; pile[WZ2]=jvj+1; 
(*f[32])( );if(v[102]) goto l11;     /*FNDO0(120,X,jvj+1)*/
...
x[L]=x[jvj+4] ;z[L]=z[jvj+4];
l3:if(x[L]==incon) goto l4;
l7:if(x[L]==incon) goto l6;
l9:if(x[L]!=incon) goto l10;
...
(*f[32])( );if(v[102]) goto l9;     /*FNDO0(120,jvj+12,jvj+9)*/
pile[v[22]]=130; pile[WZ1]=P; 
(*f[26])( );if(v[102]) goto l12;     /*FNDC0(130,P,V12)*/
V12=pile[WZ2]; 
pile[v[22]]=120; pile[WZ1]=jvj+9; pile[WZ2]=jvj+10; 
(*f[32])( );if(v[102]) goto l12;     /*FNDO0(120,jvj+9,jvj+10)*/
pile[v[22]]=218; pile[WZ1]=jvj+10; pile[WZ2]=jvj+11; 
(*f[32])( );if(v[102]) goto l12;     /*FNDO0(218,jvj+10,jvj+11)*/
pile[v[22]]=130; pile[WZ1]=jvj+11; 
(*f[26])( );if(v[102]) goto l12;     /*FNDC0(130,jvj+11,V9)*/
V9=pile[WZ2]; 
if((V9<=V12)) goto l12;
x[jvj+12]=x[jvj+9] ;z[jvj+12]=z[jvj+9];
goto l5;
l11:pile[v[22]]=P; pile[WZ1]=218; pile[WZ2]=jvj+2; 
(*f[54])( );     /*TRI1(P,218,jvj+2)*/
x[L]=x[jvj+2] ;z[L]=z[jvj+2];
pile[v[22]]=X; pile[WZ1]=120; 
(*f[35])( );     /*CHGC1(X,120,jvj+2)*/
l10:v[0]=jvj; v[22]-=3; v[102]=0;return;
l12:pile[v[22]]=P; pile[WZ1]=218; pile[WZ2]=jvj+14; 
