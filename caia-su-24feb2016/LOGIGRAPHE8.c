...
{int V31=0,V12=0,V32=0,V33=0,V30=0,J=0,V35=0,V34=0,A=0,V26=0,B=0,V22=0,V21=0,V20=0,V28=0,V27=0,C=0,V25=0,V24=0,V23=0,V18=0,I=0,V4=0,V5=0,NU=0,V6=0,NV=0,V7=0,NW=0,V17=0,V16=0,V15=0,V14=0;
int H,V;
int NNNE;
...
J=0;
goto l6;
l16:pile[v[22]]=I; pile[WZ1]=(-8615); 
(*f[3979])( );if(v[102]) goto l15;     /*LONGUEUR0(I,(-8615),V4)*/
V4=pile[WZ2]; 
if((V4!=3)) goto l15;
pile[v[22]]=1; pile[WZ1]=I; pile[WZ2]=(-8615); 
(*f[203])( );if(v[102]) goto l15;     /*FTAB0(1,I,(-8615),V5)*/
V5=pile[WZ3]; 
NU=V5;
pile[v[22]]=2; 
(*f[203])( );if(v[102]) goto l15;     /*FTAB0(2,I,(-8615),V6)*/
V6=pile[WZ3]; 
NV=V6;
pile[v[22]]=3; 
(*f[203])( );if(v[102]) goto l15;     /*FTAB0(3,I,(-8615),V7)*/
V7=pile[WZ3]; 
NW=V7;
V17=NV+NW;
V16=NU+V17;
