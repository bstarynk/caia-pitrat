...
{int V7=0,V24=0,V11=0,V3=0,V28=0;
int R;
int WZ1,WZ2,WZ3,WZ4;
int jvj;
jvj=v[0];
...
(*f[45])( );if(v[102]) goto l2;     /*FNDZ0(R,jvj+11,V24,jvj+12)*/
V24=pile[WZ2]; 
...
(*f[26])( );if(v[102]) goto l4;     /*FNDC0(130,jvj+13,V11)*/
V11=pile[WZ2]; 
V28=x[jvj+10];
l5:if((V28<=0)) goto l4;
V3=s[V28];
if((x[jvj+13]==V3)) goto l6;
...
pile[v[22]]=jvj+16; pile[WZ1]=3630; pile[WZ2]=246; pile[WZ3]=jvj+17; 
(*f[189])( );     /*TRI4(jvj+16,3630,246,jvj+17)*/
pile[v[22]]=jvj+17; pile[WZ1]=20136; pile[WZ2]=218; pile[WZ3]=jvj+18; 
(*f[58])( );     /*TRI3(jvj+17,20136,218,jvj+18)*/
