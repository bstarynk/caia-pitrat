...
AT=pile[v[22]]; BL=pile[v[22]+1]; V=pile[v[22]+2]; X=pile[v[22]+3]; EA=pile[v[22]+4]; EB=pile[v[22]+5]; v[22]+=6; 
...
T=(-1);
l13:pile[v[22]]=100; pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=BL; pile[WZ4]=jvj+11; 
(*f[181])( );     /*QUADRI2(100,20,101,BL,jvj+11)*/
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=V; pile[WZ4]=jvj+13; 
(*f[270])( );     /*QUADRI7(100,21,140,V,jvj+13)*/
pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=44; pile[WZ4]=jvj+15; 
(*f[181])( );     /*QUADRI2(100,20,101,44,jvj+15)*/
...
pile[v[22]]=100; pile[WZ1]=984; pile[WZ2]=102; pile[WZ3]=jvj+15; pile[WZ4]=jvj+14; pile[WZ5]=jvj+9; 
(*f[269])( );     /*QUADRI6(100,984,102,jvj+15,jvj+14,jvj+9)*/
if((T<0)) goto l8;
pile[v[22]]=jvj+9; pile[WZ1]=1547; pile[WZ2]=T; 
(*f[43])( );     /*CHGC2(jvj+9,1547,T)*/
l8:V3=0;
if((x[EA]==V3)) goto l9;
pile[v[22]]=jvj+9; pile[WZ1]=763; pile[WZ2]=EA; 
(*f[34])( );     /*CHGC0(jvj+9,763,EA)*/
l9:if((x[EB]==V3)) goto l10;
pile[v[22]]=jvj+9; pile[WZ1]=159; pile[WZ2]=EB; 
(*f[34])( );     /*CHGC0(jvj+9,159,EB)*/
l10:pile[v[22]]=120; pile[WZ1]=jvj+6; pile[WZ2]=jvj+10; 
(*f[32])( );if(v[102]) goto l11;     /*FNDO0(120,jvj+6,jvj+10)*/
...
l12:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=6; return;
