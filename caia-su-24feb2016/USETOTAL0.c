...
l8:pile[v[22]]=jvj+9; pile[WZ1]=R; 
(*f[1238])( );     /*USE1(jvj+9,R)*/
x[jvj+13]=t[x[jvj+13]];
goto l6;
l3:x[jvj+5]=s[x[jvj+11]] ;z[jvj+5]=(x[jvj+5]<=sepcte) ? x[jvj+5] : z[jvj+11];
...
goto l2;
l7:x[jvj+3]=s[x[jvj+13]] ;z[jvj+3]=(x[jvj+3]<=sepcte) ? x[jvj+3] : z[jvj+13];
x[jvj+9]=incon;
...
(*f[44])( );if(v[102]) goto l10;     /*FNDC1(140,A,V)*/
V=pile[WZ2]; 
