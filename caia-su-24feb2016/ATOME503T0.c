...
pile[v[22]]=688; pile[WZ1]=V; 
(*f[1975])( );if(v[102]) goto l3;     /*FNDCND0(688,V,V4)*/
V4=pile[WZ2]; 
pile[v[22]]=489; pile[WZ2]=jvj+2; 
(*f[1969])( );     /*FNDEND0(489,V,jvj+2)*/
...
(*f[1029])( );     /*DIFFAPP0(jvj+5,jvj+2,jvj+6)*/
...
pile[v[22]]=jvj+9; pile[WZ1]=3937; pile[WZ2]=246; pile[WZ3]=jvj+10; 
(*f[189])( );     /*TRI4(jvj+9,3937,246,jvj+10)*/
pile[v[22]]=jvj+10; pile[WZ1]=20503; pile[WZ2]=218; pile[WZ3]=jvj+11; 
(*f[58])( );     /*TRI3(jvj+10,20503,218,jvj+11)*/
...
(*f[1569])( );     /*DELIER0(365,V,jvj+5,jvj+7)*/
goto l2;
}
