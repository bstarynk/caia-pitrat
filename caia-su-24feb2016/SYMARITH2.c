...
NV=pile[v[22]]; ND=pile[v[22]+1]; NNNE=pile[v[22]+2]; v[22]+=3; 
...
I++;
goto l8;
l4:pile[v[22]]=P; pile[WZ1]=(-630); 
(*f[201])( );if(v[102]) goto l3;     /*FCOEFF0(P,(-630),V6)*/
V6=pile[WZ2]; 
if((V6!=I)) goto l3;
...
l3:P++;
goto l2;
l7:pile[v[22]]=PP; pile[WZ1]=(-630); 
(*f[201])( );if(v[102]) goto l6;     /*FCOEFF0(PP,(-630),V9)*/
V9=pile[WZ2]; 
if((V9!=I)) goto l6;
