...
{int V3=0,V4=0,I=0,V6=0,J=0,V5=0,V8=0,V7=0;
int H,W;
int NNNE;
...
pile[WZ3]=30; pile[WZ4]=jvj+7; 
(*f[181])( );     /*QUADRI2(100,20,101,30,jvj+7)*/
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-662); pile[WZ4]=jvj+12; 
(*f[270])( );     /*QUADRI7(100,21,140,(-662),jvj+12)*/
...
pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=29; pile[WZ4]=jvj+15; 
(*f[181])( );     /*QUADRI2(100,20,101,29,jvj+15)*/
pile[WZ3]=485; pile[WZ4]=jvj+20; 
(*f[181])( );     /*QUADRI2(100,20,101,485,jvj+20)*/
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-2241); pile[WZ4]=jvj+23; 
(*f[270])( );     /*QUADRI7(100,21,140,(-2241),jvj+23)*/
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-662); pile[WZ4]=jvj+26; 
(*f[270])( );     /*QUADRI7(100,21,140,(-662),jvj+26)*/
...
pile[v[22]]=100; pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-2241); pile[WZ4]=jvj+29; 
(*f[270])( );     /*QUADRI7(100,21,140,(-2241),jvj+29)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V5; pile[WZ4]=jvj+31; 
(*f[192])( );     /*QUADRI4(100,41,130,V5,jvj+31)*/
pile[v[22]]=jvj+29; pile[WZ1]=111; pile[WZ2]=jvj+30; 
(*f[54])( );     /*TRI1(jvj+29,111,jvj+30)*/
pile[v[22]]=100; pile[WZ1]=484; pile[WZ2]=102; pile[WZ3]=jvj+31; pile[WZ4]=jvj+30; pile[WZ5]=jvj+17; 
(*f[269])( );     /*QUADRI6(100,484,102,jvj+31,jvj+30,jvj+17)*/
