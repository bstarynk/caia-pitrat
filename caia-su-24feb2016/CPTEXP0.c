...
A=pile[v[22]]; VX=pile[v[22]+1]; N=pile[v[22]+2]; RES=pile[v[22]+3]; v[22]+=4; 
...
V2=incon;
pile[v[22]]=A; pile[WZ1]=VX; pile[WZ2]=jvj+3; 
(*f[760])( );     /*MEMEX0(A,VX,jvj+3)*/
...
l2:V2=1;
goto l3;
l4:pile[v[22]]=N; pile[WZ1]=1260; pile[WZ2]=A; 
...
pile[v[22]]=jvj+1; pile[WZ1]=VX; pile[WZ2]=N; pile[WZ3]=jvj+2; 
(*f[4071])( );     /*CPTEXP0(jvj+1,VX,N,jvj+2)*/
if((x[jvj+2]==134)) goto l9;
x[jvj+7]=t[x[jvj+7]];
goto l1;
}
