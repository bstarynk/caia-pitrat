...
(*f[255])( );     /*COPEXP0(A,R)*/
pile[v[22]]=100; pile[WZ2]=jvj+1; 
(*f[32])( );if(v[102]) goto l7;     /*FNDO0(100,R,jvj+1)*/
x[jvj+7]=w[x[jvj+1]][9];
...
pile[WZ3]=B; 
(*f[1146])( );     /*INSTANTIE1(jvj+2,R,jvj+3,B)*/
l3:x[jvj+7]=t[x[jvj+7]];
goto l1;
l6:x[jvj+6]=s[x[jvj+9]] ;z[jvj+6]=(x[jvj+6]<=sepcte) ? x[jvj+6] : z[jvj+9];
pile[v[22]]=jvj+4; pile[WZ1]=R; pile[WZ2]=jvj+6; pile[WZ3]=B; 
(*f[1146])( );     /*INSTANTIE1(jvj+4,R,jvj+6,B)*/
x[jvj+9]=t[x[jvj+9]];
goto l5;
