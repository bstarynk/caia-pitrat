...
{int V6=0,V5=0,V7=0,V24=0,V1=0,V40=0;
int R;
...
pile[v[22]]=870; 
(*f[26])( );if(v[102]) goto l11;     /*FNDC0(870,R,V6)*/
V6=pile[WZ2]; 
if((V6<=2)) goto l11;
V5=V6-1;
...
(*f[26])( );if(v[102]) goto l7;     /*FNDC0(870,jvj+14,V7)*/
V7=pile[WZ2]; 
if((V5>V7)) goto l7;
