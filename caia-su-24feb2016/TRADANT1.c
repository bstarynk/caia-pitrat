...
{int V21=0,V13=0,V=0,V34=0,V3=0,V36=0,V8=0,VV=0,V67=0,V70=0,V74=0;
int A,EE,M;
int R;
...
A=pile[v[22]]; EE=pile[v[22]+1]; M=pile[v[22]+2]; R=pile[v[22]+3]; v[22]+=4; 
WZ5=v[22]+5; WZ4=v[22]+4; WZ3=v[22]+3; WZ2=v[22]+2; WZ1=v[22]+1; 
pile[v[22]]=100; pile[WZ1]=A; pile[WZ2]=jvj+3; 
(*f[32])( );if(v[102]) goto l16;     /*FNDO0(100,A,jvj+3)*/
if((x[jvj+3]!=21)) goto l18;
pile[v[22]]=140; 
(*f[44])( );if(v[102]) goto l16;     /*FNDC1(140,A,V21)*/
V21=pile[WZ2]; 
pile[v[22]]=525; pile[WZ1]=773; pile[WZ2]=jvj+4; 
(*f[33])( );     /*FNDE0(525,773,jvj+4)*/
for(a=x[jvj+4];a>0;a=t[a]) if(s[a]==V21) goto l19;
pile[WZ1]=21; pile[WZ2]=jvj+5; 
(*f[33])( );     /*FNDE0(525,21,jvj+5)*/
for(a=x[jvj+5];a>0;a=t[a]) if(s[a]==V21) goto l20;
pile[WZ1]=23; pile[WZ2]=jvj+6; 
(*f[33])( );     /*FNDE0(525,23,jvj+6)*/
for(a=x[jvj+6];a>0;a=t[a]) if(s[a]==V21) goto l21;
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=V70; pile[WZ4]=jvj+55; 
(*f[270])( );     /*QUADRI7(100,21,140,V70,jvj+55)*/
...
l17:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=4; v[102]=0;return;
...
goto l17;
l18:pile[v[22]]=jvj+3; pile[WZ1]=100; pile[WZ2]=R; 
...
(*f[45])( );if(v[102]) goto l10;     /*FNDZ0(A,jvj+15,V34,jvj+16)*/
V34=pile[WZ2]; 
V3=V34;
V36=V3;
pile[v[22]]=R; pile[WZ2]=V36; 
(*f[43])( );     /*CHGC2(R,jvj+15,V36)*/
l10:x[jvj+17]=d[6];z[jvj+17]=0;
goto l8;
l19:pile[v[22]]=100; pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=654; pile[WZ4]=jvj+26; 
...
goto l6;
l20:pile[v[22]]=100; pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=651; pile[WZ4]=jvj+31; 
...
goto l6;
l21:pile[v[22]]=100; pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=649; pile[WZ4]=jvj+34; 
...
goto l6;
l26:x[jvj+58]=s[x[jvj+62]] ;z[jvj+58]=(x[jvj+58]<=sepcte) ? x[jvj+58] : z[jvj+62];
pile[v[22]]=214; pile[WZ1]=jvj+58; pile[WZ2]=jvj+59; 
(*f[33])( );     /*FNDE0(214,jvj+58,jvj+59)*/
for(a=x[jvj+59];a>0;a=t[a]) if(s[a]==V67) goto l27;
x[jvj+62]=t[x[jvj+62]];
goto l25;
l27:x[jvj+50]=t[x[jvj+50]];
goto l24;
l28:x[jvj+63]=t[x[jvj+63]];
goto l22;
l29:x[jvj+60]=s[x[jvj+63]] ;z[jvj+60]=(x[jvj+60]<=sepcte) ? x[jvj+60] : z[jvj+63];
pile[v[22]]=110; pile[WZ1]=jvj+60; 
(*f[44])( );if(v[102]) goto l28;     /*FNDC1(110,jvj+60,V74)*/
V74=pile[WZ2]; 
if((V74!=VV)) goto l28;
x[jvj+48]=x[jvj+60] ;z[jvj+48]=z[jvj+60];
goto l23;
l14:if((x[jvj+21]<=0)) goto l17;
