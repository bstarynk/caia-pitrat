...
V5=pile[WZ2]; 
pile[v[22]]=489; pile[WZ1]=A; pile[WZ2]=jvj+4; 
(*f[1969])( );     /*FNDEND0(489,A,jvj+4)*/
for(i=x[jvj+4],V1=0;i>0;i=t[i],V1++)  ;
pile[v[22]]=498; pile[WZ2]=jvj+5; 
(*f[1948])( );if(v[102]) goto l1;     /*FNDOND0(498,A,jvj+5)*/
pile[v[22]]=688; pile[WZ1]=jvj+5; 
(*f[1975])( );if(v[102]) goto l1;     /*FNDCND0(688,jvj+5,V3)*/
V3=pile[WZ2]; 
if((V1<=V3)) goto l1;
...
pile[v[22]]=jvj+8; pile[WZ1]=3424; pile[WZ2]=246; pile[WZ3]=jvj+9; 
(*f[189])( );     /*TRI4(jvj+8,3424,246,jvj+9)*/
pile[v[22]]=jvj+9; pile[WZ1]=20025; pile[WZ2]=218; pile[WZ3]=jvj+10; 
(*f[58])( );     /*TRI3(jvj+9,20025,218,jvj+10)*/
