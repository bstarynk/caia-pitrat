...
V4=incon;
pile[v[22]]=S; pile[WZ1]=(-7730); 
(*f[3979])( );if(v[102]) goto l11;     /*LONGUEUR0(S,(-7730),V5)*/
V5=pile[WZ2]; 
TT=1;
l8:if((TT>V5)) goto l11;
pile[v[22]]=TT; pile[WZ1]=S; pile[WZ2]=(-7730); 
(*f[203])( );if(v[102]) goto l9;     /*FTAB0(TT,S,(-7730),V6)*/
V6=pile[WZ3]; 
QQ=V6;
if((QQ>=I)) goto l9;
...
l4:SS++;
goto l3;
l5:pile[v[22]]=S; pile[WZ1]=(-7730); 
(*f[3979])( );if(v[102]) goto l10;     /*LONGUEUR0(S,(-7730),V7)*/
V7=pile[WZ2]; 
MM=1;
l6:if((MM>V7)) goto l10;
pile[v[22]]=MM; pile[WZ1]=S; pile[WZ2]=(-7730); 
(*f[203])( );if(v[102]) goto l7;     /*FTAB0(MM,S,(-7730),V8)*/
V8=pile[WZ3]; 
PP=V8;
if((PP>=I)) goto l7;
if((PP<=QQ)) goto l7;
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-630); pile[WZ4]=jvj+10; 
(*f[270])( );     /*QUADRI7(100,21,140,(-630),jvj+10)*/
