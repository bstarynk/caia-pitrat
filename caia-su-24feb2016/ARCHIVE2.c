...
{int V8=0,M=0,R=0,V10=0,P=0,N=0,V3=0,K=0,V16=0,V15=0,V13=0,V24=0,V=0,V27=0,V35=0,V34=0,V30=0,V32=0,V31=0,V29=0,V7=0,V21=0,V19=0;
int T,HIST;
int WZ1,WZ2;
int jvj;
jvj=v[0];
...
T=pile[v[22]]; HIST=pile[v[22]+1]; v[22]+=2; 
...
V21=vbl[M];
x[jvj+11]=V21 ;z[jvj+11]=(V21<=sepcte) ? V21 : 0;
pile[v[22]]=993; pile[WZ1]=994; 
(*f[26])( );if(v[102]) goto l20;     /*FNDC0(993,994,V19)*/
V19=pile[WZ2]; 
if((V19!=3)) goto l20;
...
(*f[26])( );if(v[102]) goto l10;     /*FNDC0(246,jvj+14,V24)*/
V24=pile[WZ2]; 
if((V24!=M)) goto l10;
...
(*f[44])( );if(v[102]) goto l12;     /*FNDC1(110,jvj+17,V27)*/
V27=pile[WZ2]; 
if((V27!=V)) goto l12;
...
l23:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=2; return;
l1:V8=301;
goto l2;
l4:ta1[K]=V13;
...
(*f[26])( );if(v[102]) goto l19;     /*FNDC0(117,jvj+8,V16)*/
V16=pile[WZ2]; 
V15=R+V16;
