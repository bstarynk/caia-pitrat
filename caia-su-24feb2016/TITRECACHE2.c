...
l2:I++;
goto l1;
l3:pile[v[22]]=I; pile[WZ1]=(-659); 
(*f[3979])( );if(v[102]) goto l2;     /*LONGUEUR0(I,(-659),V2)*/
V2=pile[WZ2]; 
J=1;
l4:if((J>V2)) goto l2;
pile[v[22]]=J; pile[WZ1]=I; pile[WZ2]=(-659); 
(*f[203])( );if(v[102]) goto l5;     /*FTAB0(J,I,(-659),V3)*/
V3=pile[WZ3]; 
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V3; pile[WZ4]=jvj+17; 
(*f[192])( );     /*QUADRI4(100,41,130,V3,jvj+17)*/
