...
BK=pile[v[22]]; V=pile[v[22]+1]; K=pile[v[22]+2]; E=pile[v[22]+3]; v[22]+=4; 
...
l28:x[K]=x[E]=incon;
l27:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=4; v[102]=1;return;
...
goto l28;
l17:x[E]=x[jvj+22] ;z[E]=z[jvj+22];
x[jvj+34]=x[E] ;z[jvj+34]=z[E];
l24:if((x[jvj+34]>0)) goto l25;
l29:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=4; v[102]=0;return;
...
l26:pile[v[22]]=K; pile[WZ1]=117; pile[WZ2]=1; 
(*f[186])( );     /*BTC0(K,117,1)*/
x[jvj+34]=t[x[jvj+34]];
goto l24;
...
goto l21;
l25:x[jvj+23]=s[x[jvj+34]] ;z[jvj+23]=(x[jvj+23]<=sepcte) ? x[jvj+23] : z[jvj+34];
pile[v[22]]=493; pile[WZ1]=jvj+23; 
(*f[26])( );if(v[102]) goto l26;     /*FNDC0(493,jvj+23,V2)*/
V2=pile[WZ2]; 
S=V2;
x[jvj+24]=incon;
if((S==0)) goto l18;
