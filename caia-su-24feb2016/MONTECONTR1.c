...
{int V25=0,V24=0,P=0,V23=0,KK=0,V1=0,M=0,V2=0,NT=0,V3=0,V6=0,V4=0,V7=0,V10=0,V8=0,V11=0,V14=0,V12=0,V15=0,V18=0,V16=0,V19=0,V22=0,V20=0,V26=0,V27=0,V31=0,V32=0,V36=0,V37=0,V41=0,V42=0,V46=0,V47=0,V49=0,V50=0,V51=0;
int K,N;
int WZ1,WZ2;
int jvj;
jvj=v[0];
...
V23=tu[V50];
if((V23!=0)) goto l12;
if(P==904||P==489||P==864||P==365) goto l12;
tu[V50]=V51;
KK=V50;
V1=tm[KK];
M=V1;
...
(*f[26])( );if(v[102]) goto l3;     /*FNDC0(642,jvj+1,V4)*/
V4=pile[WZ2]; 
...
(*f[26])( );if(v[102]) goto l4;     /*FNDC0(642,jvj+2,V8)*/
V8=pile[WZ2]; 
...
(*f[26])( );if(v[102]) goto l5;     /*FNDC0(642,jvj+3,V12)*/
V12=pile[WZ2]; 
...
(*f[26])( );if(v[102]) goto l6;     /*FNDC0(642,jvj+4,V16)*/
V16=pile[WZ2]; 
...
(*f[26])( );if(v[102]) goto l11;     /*FNDC0(642,jvj+5,V20)*/
V20=pile[WZ2]; 
