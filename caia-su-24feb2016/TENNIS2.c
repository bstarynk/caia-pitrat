...
x[jvj+2]=0 ;z[jvj+2]=0;
I=1;
l2:pile[v[22]]=100; pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=25; pile[WZ4]=jvj+4; 
(*f[181])( );     /*QUADRI2(100,20,101,25,jvj+4)*/
pile[WZ3]=485; pile[WZ4]=jvj+9; 
(*f[181])( );     /*QUADRI2(100,20,101,485,jvj+9)*/
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-3308); pile[WZ4]=jvj+12; 
(*f[270])( );     /*QUADRI7(100,21,140,(-3308),jvj+12)*/
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-3307); pile[WZ4]=jvj+15; 
(*f[270])( );     /*QUADRI7(100,21,140,(-3307),jvj+15)*/
