...
F=x[jvj+12];
if(F!=25&&F!=27&&F!=28) goto l5;
V1=incon;
if((F!=27)) goto l1;
V21=L+1;
V1=V21;
l1:if(F==25||F==28) goto l2;
if(V1==incon) goto l3;
...
pile[v[22]]=jvj+20; pile[WZ1]=3268; pile[WZ2]=246; pile[WZ3]=jvj+21; 
(*f[189])( );     /*TRI4(jvj+20,3268,246,jvj+21)*/
pile[v[22]]=158; pile[WZ1]=1; pile[WZ2]=218; pile[WZ3]=20007; pile[WZ4]=jvj+21; pile[WZ5]=jvj+18; 
(*f[269])( );     /*QUADRI6(158,1,218,20007,jvj+21,jvj+18)*/
