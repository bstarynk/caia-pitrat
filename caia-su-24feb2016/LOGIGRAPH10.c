...
{int L=0,I=0,V5=0,V20=0,V3=0,V15=0,V8=0,V22=0,V6=0,V17=0,V18=0,J=0,V2=0,N=0,V19=0,V24=0,V23=0,V27=0,K=0,V12=0,V14=0,V9=0,V11=0,V16=0,V13=0,V25=0,V28=0;
int H,V,MH;
int NNNE;
...
l3:pile[v[22]]=L; pile[WZ1]=I; pile[WZ2]=(-8615); 
(*f[203])( );if(v[102]) goto l2;     /*FTAB0(L,I,(-8615),V5)*/
V5=pile[WZ3]; 
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-2850); pile[WZ4]=jvj+26; 
(*f[270])( );     /*QUADRI7(100,21,140,(-2850),jvj+26)*/
...
pile[v[22]]=100; pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=J; pile[WZ4]=jvj+20; 
...
pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-2850); pile[WZ4]=jvj+34; 
(*f[270])( );     /*QUADRI7(100,21,140,(-2850),jvj+34)*/
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=J; pile[WZ4]=jvj+31; 
...
V15=K+1;
V14=V+V15;
pile[v[22]]=K; pile[WZ1]=I; pile[WZ2]=(-8615); 
(*f[203])( );if(v[102]) goto l13;     /*FTAB0(K,I,(-8615),V9)*/
V9=pile[WZ3]; 
pile[v[22]]=0; pile[WZ1]=117; pile[WZ2]=jvj+2; 
(*f[46])( );     /*TRI0(0,117,jvj+2)*/
L=1;
goto l1;
l6:pile[v[22]]=V15; pile[WZ1]=I; pile[WZ2]=(-8615); 
(*f[203])( );if(v[102]) goto l5;     /*FTAB0(V15,I,(-8615),V8)*/
V8=pile[WZ3]; 
...
goto l4;
l9:I=0;
l8:if((I<=V17)) goto l11;
J++;
goto l7;
l10:I++;
goto l8;
l11:pile[v[22]]=I; pile[WZ1]=(-8615); 
(*f[3979])( );if(v[102]) goto l10;     /*LONGUEUR0(I,(-8615),V2)*/
V2=pile[WZ2]; 
N=V2;
if((N<2)) goto l10;
V19=N-1;
