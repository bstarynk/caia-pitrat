...
{int P=0,V4=0,M=0,V2=0,NN=0,V5=0,V6=0,I=0;
int N,C;
int NNNE;
...
l2:P++;
goto l1;
l3:pile[v[22]]=P; pile[WZ1]=(-7297); 
(*f[201])( );if(v[102]) goto l2;     /*FCOEFF0(P,(-7297),V4)*/
V4=pile[WZ2]; 
M=1;
l4:if((M>N)) goto l2;
pile[v[22]]=M; pile[WZ1]=(-7296); 
(*f[201])( );if(v[102]) goto l5;     /*FCOEFF0(M,(-7296),V2)*/
V2=pile[WZ2]; 
if((V2!=V4)) goto l5;
NN=1;
l6:if((NN>V2)) goto l5;
pile[v[22]]=NN; pile[WZ1]=P; pile[WZ2]=(-620); 
(*f[203])( );if(v[102]) goto l7;     /*FTAB0(NN,P,(-620),V5)*/
V5=pile[WZ3]; 
pile[WZ1]=M; pile[WZ2]=(-595); 
(*f[202])( );if(v[102]) goto l7;     /*FMATRICE0(NN,M,(-595),V6)*/
V6=pile[WZ3]; 
I=1;
l8:if((I>C)) goto l7;
if((V5!=I)) goto l9;
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=M; pile[WZ4]=jvj+14; 
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=P; pile[WZ4]=jvj+9; 
(*f[192])( );     /*QUADRI4(100,41,130,P,jvj+9)*/
...
pile[WZ1]=89; pile[WZ2]=162; pile[WZ3]=V6; pile[WZ4]=jvj+17; 
(*f[272])( );     /*QUADRI9(100,89,162,V6,jvj+17)*/
