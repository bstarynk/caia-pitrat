...
{int V7=0,V9=0,V6=0,V8=0,V16=0,V18=0,V17=0,V58=0,V57=0,V4=0,V63=0,V65=0,V62=0,V64=0,V56=0,V55=0,V51=0,V47=0,V46=0,V42=0,V83=0,V82=0,V3=0,V100=0,V80=0,V101=0,V81=0,V90=0,V106=0,V105=0,V103=0,V104=0,V89=0,V102=0,V91=0,V95=0,V96=0,V93=0,V99=0,V92=0,V86=0,V110=0,V109=0,V2=0,V107=0,V108=0,V117=0,V133=0,V132=0,V130=0,V131=0,V129=0,V118=0,V122=0,V123=0,V120=0,V126=0,V119=0;
int E,F,H,ED;
int EE;
...
E=pile[v[22]]; F=pile[v[22]+1]; H=pile[v[22]+2]; ED=pile[v[22]+3]; EE=pile[v[22]+4]; v[22]+=5; 
WZ5=v[22]+5; WZ4=v[22]+4; WZ3=v[22]+3; WZ2=v[22]+2; WZ1=v[22]+1; 
x[jvj+44]=0 ;z[jvj+44]=0;
x[EE]=x[jvj+44] ;z[EE]=z[jvj+44];
x[jvj+45]=x[E] ;z[jvj+45]=z[E];
l1:if((x[jvj+45]<=0)) goto l13;
x[jvj+3]=s[x[jvj+45]] ;z[jvj+3]=(x[jvj+3]<=sepcte) ? x[jvj+3] : z[jvj+45];
for(a=x[F];a>0;a=t[a]) if(s[a]==x[jvj+3]) goto l2;
x[jvj+4]=x[jvj+3] ;z[jvj+4]=z[jvj+3];
pile[v[22]]=F; pile[WZ1]=jvj+3; 
(*f[68])( );     /*PLUE0(F,jvj+3)*/
pile[v[22]]=870; pile[WZ1]=jvj+4; 
(*f[26])( );if(v[102]) goto l11;     /*FNDC0(870,jvj+4,V7)*/
V7=pile[WZ2]; 
pile[v[22]]=1101; 
(*f[26])( );if(v[102]) goto l11;     /*FNDC0(1101,jvj+4,V9)*/
V9=pile[WZ2]; 
...
x[jvj+46]=x[EE] ;z[jvj+46]=z[EE];
l3:if((x[jvj+46]<=0)) goto l11;
x[jvj+8]=s[x[jvj+46]] ;z[jvj+8]=(x[jvj+8]<=sepcte) ? x[jvj+8] : z[jvj+46];
pile[v[22]]=447; pile[WZ1]=jvj+8; pile[WZ2]=jvj+9; 
(*f[32])( );if(v[102]) goto l4;     /*FNDO0(447,jvj+8,jvj+9)*/
x[jvj+10]=x[jvj+9] ;z[jvj+10]=z[jvj+9];
pile[v[22]]=870; pile[WZ1]=jvj+10; 
(*f[26])( );if(v[102]) goto l4;     /*FNDC0(870,jvj+10,V6)*/
V6=pile[WZ2]; 
if((V6!=V7)) goto l4;
pile[v[22]]=1101; 
(*f[26])( );if(v[102]) goto l4;     /*FNDC0(1101,jvj+10,V8)*/
V8=pile[WZ2]; 
if((V8!=V9)) goto l4;
pile[v[22]]=510; pile[WZ1]=jvj+8; 
(*f[26])( );if(v[102]) goto l4;     /*FNDC0(510,jvj+8,V16)*/
V16=pile[WZ2]; 
...
V80=x[jvj+37];
if(V3==incon) goto l53;
l36:x[jvj+34]=0 ;z[jvj+34]=0;
V101=x[jvj+5];
l37:if((V101>0)) goto l45;
V81=x[jvj+34];
if(V3==incon) goto l44;
l5:if((V3==135)) goto l6;
l4:x[jvj+46]=t[x[jvj+46]];
goto l3;
l2:x[jvj+45]=t[x[jvj+45]];
goto l1;
l6:pile[v[22]]=1260; pile[WZ1]=jvj+10; pile[WZ2]=jvj+12; 
...
x[jvj+53]=x[jvj+12] ;z[jvj+53]=z[jvj+12];
l57:if((x[jvj+53]>0)) goto l76;
V107=x[jvj+42];
if(V2==incon) goto l75;
l58:x[jvj+38]=0 ;z[jvj+38]=0;
x[jvj+52]=x[jvj+6] ;z[jvj+52]=z[jvj+6];
l59:if((x[jvj+52]>0)) goto l67;
V108=x[jvj+38];
if(V2==incon) goto l66;
l7:if((V2==135)) goto l8;
goto l4;
l8:pile[v[22]]=1363; pile[WZ1]=jvj+10; pile[WZ2]=jvj+13; 
(*f[33])( );     /*FNDE0(1363,jvj+10,jvj+13)*/
V4=incon;
x[jvj+33]=0 ;z[jvj+33]=0;
x[jvj+16]=d[125];z[jvj+16]=0;
x[jvj+51]=x[ED] ;z[jvj+51]=z[ED];
l14:if((x[jvj+51]>0)) goto l30;
x[jvj+54]=x[jvj+33] ;z[jvj+54]=z[jvj+33];
x[jvj+28]=0 ;z[jvj+28]=0;
x[jvj+17]=d[125];z[jvj+17]=0;
x[jvj+50]=x[ED] ;z[jvj+50]=z[ED];
l15:if((x[jvj+50]>0)) goto l26;
x[jvj+55]=x[jvj+28] ;z[jvj+55]=z[jvj+28];
for(i=x[jvj+54],V58=0;i>0;i=t[i],V58++)  ;
for(i=x[jvj+55],V57=0;i>0;i=t[i],V57++)  ;
if((V58==V57)) goto l16;
V4=134;
l16:x[jvj+48]=x[jvj+54] ;z[jvj+48]=z[jvj+54];
l17:if((x[jvj+48]>0)) goto l22;
if(V4==incon) goto l21;
l9:if((V4==135)) goto l10;
goto l4;
l10:pile[v[22]]=jvj+4; pile[WZ1]=510; pile[WZ2]=V16; 
(*f[43])( );     /*CHGC2(jvj+4,510,V16)*/
l12:pile[v[22]]=E; pile[WZ1]=F; pile[WZ2]=EE; pile[WZ3]=H; pile[WZ4]=ED; 
(*f[4108])( );     /*GROUPEREG1(E,F,EE,H,ED)*/
l13:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=5; return;
l11:pile[v[22]]=510; pile[WZ1]=H; 
(*f[26])( );if(v[102]) goto l13;     /*FNDC0(510,H,V18)*/
V18=pile[WZ2]; 
V17=V18+1;
x[jvj+14]=d[77];z[jvj+14]=0;
pile[v[22]]=447; pile[WZ1]=jvj+4; pile[WZ2]=510; pile[WZ3]=V17; pile[WZ4]=jvj+15; 
(*f[192])( );     /*QUADRI4(447,jvj+4,510,V17,jvj+15)*/
pile[v[22]]=jvj+14; pile[WZ1]=jvj+15; pile[WZ2]=EE; 
(*f[196])( );     /*PLUF0(jvj+14,jvj+15,EE)*/
pile[v[22]]=jvj+4; pile[WZ1]=510; pile[WZ2]=V17; 
(*f[43])( );     /*CHGC2(jvj+4,510,V17)*/
pile[v[22]]=H; 
(*f[43])( );     /*CHGC2(H,510,V17)*/
goto l12;
l18:x[jvj+47]=t[x[jvj+47]];
l19:if((x[jvj+47]>0)) goto l20;
V4=135;
goto l9;
l20:x[jvj+18]=s[x[jvj+47]] ;z[jvj+18]=(x[jvj+18]<=sepcte) ? x[jvj+18] : z[jvj+47];
pile[v[22]]=447; pile[WZ1]=jvj+18; pile[WZ2]=jvj+19; 
(*f[32])( );if(v[102]) goto l18;     /*FNDO0(447,jvj+18,jvj+19)*/
if((x[jvj+19]!=67)) goto l18;
V4=134;
goto l9;
l21:x[jvj+47]=x[jvj+55] ;z[jvj+47]=z[jvj+55];
goto l19;
l22:x[jvj+20]=s[x[jvj+48]] ;z[jvj+20]=(x[jvj+20]<=sepcte) ? x[jvj+20] : z[jvj+48];
...
V65=pile[WZ2]; 
x[jvj+49]=x[jvj+55] ;z[jvj+49]=z[jvj+55];
l23:if((x[jvj+49]<=0)) goto l25;
...
l24:x[jvj+49]=t[x[jvj+49]];
goto l23;
l25:x[jvj+48]=t[x[jvj+48]];
goto l17;
l26:x[jvj+24]=s[x[jvj+50]] ;z[jvj+24]=(x[jvj+24]<=sepcte) ? x[jvj+24] : z[jvj+50];
...
goto l27;
l30:x[jvj+29]=s[x[jvj+51]] ;z[jvj+29]=(x[jvj+29]<=sepcte) ? x[jvj+29] : z[jvj+51];
...
V133=V107;
goto l63;
l67:x[jvj+39]=s[x[jvj+52]] ;z[jvj+39]=(x[jvj+39]<=sepcte) ? x[jvj+39] : z[jvj+52];
if((x[jvj+39]==250)) goto l68;
pile[v[22]]=jvj+38; pile[WZ1]=jvj+39; 
(*f[68])( );     /*PLUE0(jvj+38,jvj+39)*/
l68:x[jvj+52]=t[x[jvj+52]];
goto l59;
l69:V129=t[V129];
...
l75:V129=V107;
goto l70;
l76:x[jvj+43]=s[x[jvj+53]] ;z[jvj+43]=(x[jvj+43]<=sepcte) ? x[jvj+43] : z[jvj+53];
if((x[jvj+43]==250)) goto l77;
pile[v[22]]=jvj+42; pile[WZ1]=jvj+43; 
(*f[68])( );     /*PLUE0(jvj+42,jvj+43)*/
l77:x[jvj+53]=t[x[jvj+53]];
goto l57;
}
