...
(*f[1975])( );if(v[102]) goto l4;     /*FNDCND0(929,jvj+2,V19)*/
V19=pile[WZ2]; 
...
pile[v[22]]=jvj+28; pile[WZ1]=3877; pile[WZ2]=246; pile[WZ3]=jvj+29; 
(*f[189])( );     /*TRI4(jvj+28,3877,246,jvj+29)*/
...
(*f[1296])( );     /*NOUVCONTR0(jvj+3,jvj+19)*/
