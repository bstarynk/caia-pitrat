...
{int V9=0,V12=0,I=0,V22=0,V4=0,Q=0,V7=0,QQ=0;
int R;
...
(*f[32])( );if(v[102]) goto l19;     /*FNDO0(111,R,jvj+6)*/
pile[v[22]]=101; pile[WZ1]=jvj+6; pile[WZ2]=jvj+7; 
(*f[32])( );if(v[102]) goto l19;     /*FNDO0(101,jvj+6,jvj+7)*/
if((x[jvj+7]!=25)) goto l19;
pile[v[22]]=869; pile[WZ1]=R; pile[WZ2]=jvj+8; 
(*f[32])( );if(v[102]) goto l19;     /*FNDO0(869,R,jvj+8)*/
if((x[jvj+8]!=769)) goto l19;
pile[v[22]]=1274; 
(*f[26])( );if(v[102]) goto l10;     /*FNDC0(1274,R,V9)*/
V9=pile[WZ2]; 
if((V9!=0)) goto l19;
l10:pile[v[22]]=870; pile[WZ1]=R; 
(*f[26])( );if(v[102]) goto l19;     /*FNDC0(870,R,Q)*/
Q=pile[WZ2]; 
x[jvj+17]=incon;
if((Q<3)) goto l19;
if((Q<=4)) goto l7;
...
l11:pile[v[22]]=R; pile[WZ1]=jvj+9; 
...
for(a=x[jvj+11];a>0;a=t[a]) if(s[a]==x[R]) goto l15;
...
(*f[1931])( );if(v[102]) goto l16;     /*ISOLONS0(jvj+3,jvj+10,67,jvj+16)*/
...
pile[WZ1]=jvj+3; pile[WZ3]=(-631); pile[WZ4]=jvj+24; 
(*f[270])( );     /*QUADRI7(101,jvj+3,110,(-631),jvj+24)*/
...
if((QQ<=3)) goto l6;
V4=0;
l18:pile[v[22]]=jvj+3; pile[WZ1]=jvj+15; 
...
l6:V4=1;
goto l18;
l7:x[jvj+17]=206 ;z[jvj+17]=206;
goto l11;
l8:x[jvj+17]=604 ;z[jvj+17]=604;
goto l11;
l9:x[jvj+17]=605 ;z[jvj+17]=605;
goto l11;
l15:x[jvj+26]=x[jvj+11] ;z[jvj+26]=z[jvj+11];
goto l14;
