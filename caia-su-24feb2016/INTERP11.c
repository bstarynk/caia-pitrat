...
{int V1=0;
int ZZG,ZZBL,ZZN,OS1,O1,NS1,N1,NS2,N2;
int RES;
...
ZZG=pile[v[22]]; ZZBL=pile[v[22]+1]; ZZN=pile[v[22]+2]; OS1=pile[v[22]+3]; O1=pile[v[22]+4]; NS1=pile[v[22]+5]; N1=pile[v[22]+6]; NS2=pile[v[22]+7]; N2=pile[v[22]+8]; RES=pile[v[22]+9]; v[22]+=10; 
...
pile[v[22]]=(-200); pile[WZ1]=416; pile[WZ2]=jvj+10; 
(*f[46])( );     /*TRI0((-200),416,jvj+10)*/
pile[v[22]]=jvj+10; pile[WZ1]=41; pile[WZ2]=158; pile[WZ3]=jvj+11; 
(*f[58])( );     /*TRI3(jvj+10,41,158,jvj+11)*/
pile[v[22]]=130; pile[WZ1]=N1; pile[WZ2]=140; pile[WZ3]=NS1; pile[WZ4]=jvj+11; pile[WZ5]=jvj+3; 
(*f[197])( );     /*QUADRI5(130,N1,140,NS1,jvj+11,jvj+3)*/
...
pile[v[22]]=jvj+12; pile[WZ1]=41; pile[WZ2]=158; pile[WZ3]=jvj+13; 
(*f[58])( );     /*TRI3(jvj+12,41,158,jvj+13)*/
pile[v[22]]=130; pile[WZ1]=N2; pile[WZ2]=140; pile[WZ3]=NS2; pile[WZ4]=jvj+13; pile[WZ5]=jvj+4; 
(*f[197])( );     /*QUADRI5(130,N2,140,NS2,jvj+13,jvj+4)*/
