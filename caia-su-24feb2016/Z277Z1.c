...
l1:if(x[jvj+1]==484||x[jvj+1]==531||x[jvj+1]==453||x[jvj+1]==979||x[jvj+1]==1027) goto l4;
x[jvj+7]=w[x[jvj+1]][9];
...
pile[v[22]]=jvj+3; pile[WZ1]=BTTT; 
(*f[1936])( );     /*Z277Z1(jvj+3,BTTT)*/
l3:x[jvj+7]=t[x[jvj+7]];
goto l2;
l4:x[jvj+8]=w[x[jvj+1]][8];
...
pile[v[22]]=jvj+6; pile[WZ1]=BTTT; 
(*f[1936])( );     /*Z277Z1(jvj+6,BTTT)*/
x[jvj+9]=t[x[jvj+9]];
goto l6;
