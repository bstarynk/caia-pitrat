...
{int V47=0,V35=0,V4=0,K=0,V9=0,V14=0,V22=0,V21=0,V25=0,V46=0,V45=0,V26=0,V28=0,V27=0,R=0,V37=0,V38=0,V19=0,V33=0,V1=0,V56=0,V57=0,V59=0,V58=0,V61=0,V63=0,V65=0;
int FF;
int E,DX;
int WZ1,WZ2,WZ3,WZ4;
int jvj;
...
FF=pile[v[22]]; E=pile[v[22]+1]; v[22]+=3; 
...
l31:if(x[E]==incon) goto l32;
l41:if(DX!=incon) goto l42;
l40:x[E]=DX=incon;
l39:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=3; v[102]=1;return;
l3:pile[v[22]]=(-1); pile[WZ1]=64; pile[WZ2]=67; pile[WZ3]=jvj+3; 
(*f[78])( );if(v[102]) goto l31;     /*SMA0((-1),64,67,jvj+3)*/
(*f[107])( );     /*CRC0((-1),K)*/
K=pile[WZ1]; 
V26=bh[v[1]][K];
if((V26==32)) goto l24;
...
(*f[32])( );if(v[102]) goto l13;     /*FNDO0(1249,jvj+4,jvj+7)*/
...
goto l41;
l11:pile[v[22]]=878; pile[WZ1]=jvj+8; pile[WZ2]=jvj+12; 
(*f[33])( );     /*FNDE0(878,jvj+8,jvj+12)*/
x[jvj+33]=x[jvj+12] ;z[jvj+33]=z[jvj+12];
goto l12;
l15:x[jvj+17]=0 ;z[jvj+17]=0;
...
l26:DX=K;
goto l31;
l17:x[jvj+15]=s[x[jvj+16]] ;z[jvj+15]=(x[jvj+15]<=sepcte) ? x[jvj+15] : z[jvj+16];
pile[v[22]]=163; pile[WZ1]=jvj+15; 
(*f[44])( );if(v[102]) goto l46;     /*FNDC1(163,jvj+15,V25)*/
V25=pile[WZ2]; 
if((V25==(-7141))) goto l18;
l46:pile[v[22]]=498; pile[WZ1]=jvj+15; pile[WZ2]=jvj+30; 
(*f[32])( );if(v[102]) goto l18;     /*FNDO0(498,jvj+15,jvj+30)*/
pile[v[22]]=jvj+30; pile[WZ1]=109; pile[WZ2]=jvj+18; 
(*f[54])( );     /*TRI1(jvj+30,109,jvj+18)*/
pile[v[22]]=163; pile[WZ1]=jvj+15; 
(*f[44])( );if(v[102]) goto l19;     /*FNDC1(163,jvj+15,V63)*/
V63=pile[WZ2]; 
pile[v[22]]=jvj+18; pile[WZ1]=163; pile[WZ2]=V63; 
(*f[177])( );     /*CHGC4(jvj+18,163,V63)*/
l19:pile[v[22]]=jvj+17; pile[WZ1]=jvj+18; 
(*f[68])( );     /*PLUE0(jvj+17,jvj+18)*/
l18:x[jvj+16]=t[x[jvj+16]];
goto l16;
l21:x[jvj+19]=s[x[jvj+20]] ;z[jvj+19]=(x[jvj+19]<=sepcte) ? x[jvj+19] : z[jvj+20];
pile[v[22]]=897; pile[WZ1]=jvj+19; 
(*f[44])( );if(v[102]) goto l22;     /*FNDC1(897,jvj+19,V45)*/
V45=pile[WZ2]; 
if((V45!=V37)) goto l22;
pile[v[22]]=163; 
(*f[44])( );if(v[102]) goto l47;     /*FNDC1(163,jvj+19,V46)*/
V46=pile[WZ2]; 
if((V46==(-7141))) goto l22;
l47:pile[v[22]]=498; pile[WZ1]=jvj+19; pile[WZ2]=jvj+31; 
(*f[32])( );if(v[102]) goto l22;     /*FNDO0(498,jvj+19,jvj+31)*/
pile[v[22]]=jvj+31; pile[WZ1]=109; pile[WZ2]=jvj+22; 
(*f[54])( );     /*TRI1(jvj+31,109,jvj+22)*/
pile[v[22]]=163; pile[WZ1]=jvj+19; 
(*f[44])( );if(v[102]) goto l23;     /*FNDC1(163,jvj+19,V65)*/
V65=pile[WZ2]; 
pile[v[22]]=jvj+22; pile[WZ1]=163; pile[WZ2]=V65; 
(*f[177])( );     /*CHGC4(jvj+22,163,V65)*/
l23:pile[v[22]]=jvj+21; pile[WZ1]=jvj+22; 
(*f[68])( );     /*PLUE0(jvj+21,jvj+22)*/
l22:x[jvj+20]=t[x[jvj+20]];
goto l20;
l24:if(x[jvj+3]==324||x[jvj+3]==301||x[jvj+3]==104||x[jvj+3]==528||x[jvj+3]==981) goto l25;
V28=K+1;
V27=bh[v[1]][V28];
if((V27==32)) goto l25;
pile[v[22]]=K; 
...
goto l31;
l25:V19=bh[v[1]][K];
if(V19!=32&&V19!=43&&V19!=44&&V19!=59) goto l26;
if(x[jvj+3]==324||x[jvj+3]==301||x[jvj+3]==104||x[jvj+3]==528||x[jvj+3]==981) goto l26;
if(V19==44||V19==59) goto l15;
V22=K+1;
V21=bh[v[1]][V22];
if((V21==32)) goto l15;
goto l26;
l28:x[jvj+26]=s[x[jvj+28]] ;z[jvj+26]=(x[jvj+26]<=sepcte) ? x[jvj+26] : z[jvj+28];
pile[v[22]]=jvj+25; pile[WZ1]=jvj+26; 
(*f[68])( );     /*PLUE0(jvj+25,jvj+26)*/
x[jvj+28]=t[x[jvj+28]];
l27:if((x[jvj+28]>0)) goto l28;
x[jvj+34]=x[jvj+24] ;z[jvj+34]=z[jvj+24];
l29:if((x[jvj+34]>0)) goto l30;
x[E]=x[jvj+25] ;z[E]=z[jvj+25];
l42:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=3; pile[v[22]+2]=DX; v[102]=0;return;
l30:x[jvj+27]=s[x[jvj+34]] ;z[jvj+27]=(x[jvj+27]<=sepcte) ? x[jvj+27] : z[jvj+34];
pile[v[22]]=jvj+25; pile[WZ1]=jvj+27; 
(*f[68])( );     /*PLUE0(jvj+25,jvj+27)*/
x[jvj+34]=t[x[jvj+34]];
goto l29;
l32:if(x[jvj+24]!=incon) goto l33;
l35:if(x[jvj+3]!=incon) goto l36;
l37:if(x[jvj+24]!=incon) goto l38;
goto l40;
l33:if(DX!=incon) goto l34;
goto l35;
l34:V33=bh[v[1]][DX];
if((V33!=43)) goto l35;
pile[v[22]]=FF; pile[WZ1]=jvj+28; 
(*f[434])( );if(v[102]) goto l35;     /*EXPPB1(FF,jvj+28)*/
x[jvj+25]=0 ;z[jvj+25]=0;
goto l27;
l36:if(x[jvj+3]!=324&&x[jvj+3]!=301&&x[jvj+3]!=104&&x[jvj+3]!=528&&x[jvj+3]!=981) goto l37;
x[jvj+13]=0 ;z[jvj+13]=0;
pile[v[22]]=457; pile[WZ1]=324; pile[WZ2]=jvj+10; 
(*f[33])( );     /*FNDE0(457,324,jvj+10)*/
goto l8;
l38:x[E]=x[jvj+24] ;z[E]=z[jvj+24];
goto l41;
l43:V1=134;
goto l2;
l45:V59=c[0][V57];
