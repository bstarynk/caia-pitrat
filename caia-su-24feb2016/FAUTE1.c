...
{int V3=0,V6=0,V1=0,V2=0,V4=0,V5=0,V8=0,V7=0,V9=0,V10=0;
int BL,BK,S,N;
int WZ1,WZ2,WZ3;

BL=pile[v[22]]; BK=pile[v[22]+1]; S=pile[v[22]+2]; N=pile[v[22]+3]; v[22]+=4; 
...
(*f[37])( );     /*SRA0(0,S,V9)*/
V9=pile[WZ2]; 
pile[v[22]]=41; pile[WZ1]=N; pile[WZ2]=V9; 
(*f[39])( );     /*SDX0(41,N,V9,V10)*/
V10=pile[WZ3]; 
pile[v[22]]=V10; 
(*f[40])( );     /*SLG0(V10)*/
v[22]-=4; return;
