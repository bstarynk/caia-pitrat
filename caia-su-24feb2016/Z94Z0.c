...
if((x[jvj+1]!=979)) goto l1;
pile[v[22]]=jvj+2; pile[WZ1]=159; pile[WZ2]=BXXX; 
(*f[36])( );     /*PLUSC0(jvj+2,159,BXXX)*/
...
(*f[2178])( );     /*Z94Z1(jvj+4,jvj+2)*/
l4:x[jvj+8]=t[x[jvj+8]];
goto l2;
l7:x[jvj+7]=s[x[jvj+10]] ;z[jvj+7]=(x[jvj+7]<=sepcte) ? x[jvj+7] : z[jvj+10];
pile[v[22]]=jvj+7; pile[WZ1]=jvj+2; 
(*f[2178])( );     /*Z94Z1(jvj+7,jvj+2)*/
x[jvj+10]=t[x[jvj+10]];
goto l6;
l8:pile[v[22]]=159; pile[WZ1]=jvj+2; pile[WZ2]=BRRR; 
(*f[33])( );     /*FNDE0(159,jvj+2,BRRR)*/
