...
{int RES=0,V17=0,V6=0,V12=0,V10=0,V14=0,V11=0,V9=0;
int Z,RN;
int WZ1,WZ2;
int jvj;
jvj=v[0];
...
RES=(-9999999);
l15:pile[v[22]]=0; pile[WZ1]=204; pile[WZ2]=jvj+13; 
...
(*f[32])( );if(v[102]) goto l14;     /*FNDO0(274,Z,jvj+14)*/
