...
{int V1=0,II=0,V2=0,P=0,V11=0,J=0,V12=0,T=0,TT=0,HH=0,V3=0,V5=0,V9=0,V7=0,V16=0,V=0,V15=0,V17=0,V18=0,V20=0,V19=0;
int N,I;
int R;
...
l11:pile[v[22]]=130; pile[WZ1]=77; 
(*f[26])( );if(v[102]) goto l14;     /*FNDC0(130,77,HH)*/
HH=pile[WZ2]; 
...
goto l11;
l12:if((x[N]!=66)) goto l18;
pile[v[22]]=J; 
(*f[107])( );     /*CRC0(J,V3)*/
V3=pile[WZ1]; 
V5=bh[v[1]][V3];
if(V5!=32&&V5!=44&&V5!=93&&V5!=41) goto l21;
l18:V7=J+1;
pile[v[22]]=jvj+3; pile[WZ1]=V7; pile[WZ2]=J; pile[WZ3]=T; pile[WZ4]=TT; pile[WZ5]=jvj+4; pile[v[22]+6]=HH; pile[v[22]+7]=jvj+1; 
(*f[252])( );if(v[102]) goto l21;     /*SMB0(jvj+3,V7,J,T,TT,jvj+4,HH,jvj+1)*/
x[jvj+7]=incon;
pile[v[22]]=101; pile[WZ1]=jvj+1; pile[WZ2]=jvj+2; 
(*f[32])( );if(v[102]) goto l13;     /*FNDO0(101,jvj+1,jvj+2)*/
x[jvj+7]=x[jvj+2] ;z[jvj+7]=z[jvj+2];
l19:x[R]=x[jvj+7] ;z[R]=z[jvj+7];
pile[v[22]]=163; pile[WZ1]=jvj+1; 
(*f[44])( );if(v[102]) goto l20;     /*FNDC1(163,jvj+1,V9)*/
V9=pile[WZ2]; 
if((V9!=HH)) goto l20;
pile[v[22]]=77; pile[WZ1]=130; pile[WZ2]=(-1); 
(*f[186])( );     /*BTC0(77,130,(-1))*/
l20:if((x[jvj+4]!=397)) goto l22;
if((P!=38)) goto l22;
x[jvj+5]=vo[20];z[jvj+5]=vz[20];
V15=x[R];
pile[v[22]]=jvj+5; pile[WZ1]=667; pile[WZ2]=V15; 
(*f[43])( );     /*CHGC2(jvj+5,667,V15)*/
pile[v[22]]=II; pile[WZ1]=(-80); pile[WZ2]=397; pile[WZ3]=jvj+6; 
(*f[78])( );if(v[102]) goto l22;     /*SMA0(II,(-80),397,jvj+6)*/
pile[v[22]]=0; pile[WZ1]=(-8396); 
(*f[37])( );     /*SRA0(0,(-8396),V16)*/
V16=pile[WZ2]; 
V17=V16-1;
V18=0;
l23:if((V18<=V17)) goto l24;
pile[v[22]]=63; 
(*f[346])( );     /*LK1(63)*/
pile[v[22]]=0; 
(*f[258])( );     /*SMV1(0,V)*/
...
l13:x[jvj+7]=x[jvj+1] ;z[jvj+7]=z[jvj+1];
goto l19;
l15:if(T!=incon) goto l16;
goto l21;
l16:if(TT!=incon) goto l17;
goto l21;
l17:if(HH!=incon) goto l12;
goto l21;
l24:V20=c[0][V18];
V19=V20;
putchar(V19);
