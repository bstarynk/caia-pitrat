...
{int VA=0,V27=0,V11=0,V10=0,V25=0;
int R;
...
(*f[32])( );if(v[102]) goto l13;     /*FNDO0(111,R,jvj+14)*/
pile[v[22]]=101; pile[WZ1]=jvj+14; pile[WZ2]=jvj+15; 
(*f[32])( );if(v[102]) goto l13;     /*FNDO0(101,jvj+14,jvj+15)*/
if((x[jvj+15]!=25)) goto l13;
pile[v[22]]=869; pile[WZ1]=R; pile[WZ2]=jvj+16; 
(*f[32])( );if(v[102]) goto l13;     /*FNDO0(869,R,jvj+16)*/
if((x[jvj+16]!=769)) goto l13;
pile[v[22]]=870; 
(*f[26])( );if(v[102]) goto l13;     /*FNDC0(870,R,V11)*/
V11=pile[WZ2]; 
...
goto l4;
l2:VA=s[V27];
for(a=x[jvj+4];a>0;a=t[a]) if(s[a]==VA) goto l3;
l10:x[jvj+13]=t[x[jvj+13]];
l9:if((x[jvj+13]<=0)) goto l13;
x[jvj+3]=s[x[jvj+13]] ;z[jvj+3]=(x[jvj+3]<=sepcte) ? x[jvj+3] : z[jvj+13];
pile[v[22]]=869; pile[WZ1]=jvj+3; pile[WZ2]=jvj+17; 
(*f[32])( );if(v[102]) goto l10;     /*FNDO0(869,jvj+3,jvj+17)*/
if((x[jvj+17]!=769)) goto l10;
pile[v[22]]=870; 
(*f[26])( );if(v[102]) goto l10;     /*FNDC0(870,jvj+3,V10)*/
V10=pile[WZ2]; 
if((V10<V11)) goto l10;
pile[v[22]]=868; pile[WZ2]=jvj+18; 
(*f[32])( );if(v[102]) goto l10;     /*FNDO0(868,jvj+3,jvj+18)*/
if((x[jvj+18]==408)) goto l10;
pile[v[22]]=1300; pile[WZ2]=jvj+19; 
(*f[33])( );     /*FNDE0(1300,jvj+3,jvj+19)*/
for(a=x[jvj+19];a>0;a=t[a]) if(s[a]==636) goto l10;
...
(*f[32])( );if(v[102]) goto l12;     /*FNDO0(jvj+21,R,jvj+22)*/
...
pile[v[22]]=R; pile[WZ1]=jvj+24; pile[WZ3]=jvj+25; 
(*f[45])( );if(v[102]) goto l12;     /*FNDZ0(R,jvj+24,V25,jvj+25)*/
V25=pile[WZ2]; 
pile[v[22]]=101; pile[WZ1]=R; pile[WZ2]=110; pile[WZ3]=(-601); pile[WZ4]=jvj+30; 
(*f[270])( );     /*QUADRI7(101,R,110,(-601),jvj+30)*/
pile[WZ1]=jvj+3; pile[WZ3]=(-631); pile[WZ4]=jvj+31; 
(*f[270])( );     /*QUADRI7(101,jvj+3,110,(-631),jvj+31)*/
