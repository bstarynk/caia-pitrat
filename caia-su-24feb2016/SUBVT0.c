...
VA=pile[v[22]]; VB=pile[v[22]+1]; R=pile[v[22]+2]; v[22]+=3; 
...
l2:pile[v[22]]=100; pile[WZ1]=R; pile[WZ2]=jvj+3; 
...
l9:pile[v[22]]=VA; pile[WZ1]=VB; pile[WZ2]=jvj+8; 
(*f[2101])( );     /*SUBVT0(VA,VB,jvj+8)*/
x[jvj+11]=t[x[jvj+11]];
goto l7;
