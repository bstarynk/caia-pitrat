...
(*f[26])( );if(v[102]) goto l8;     /*FNDC0(870,RR,V5)*/
V5=pile[WZ2]; 
...
if((x[jvj+13]!=55)) goto l7;
pile[v[22]]=1232; pile[WZ1]=jvj+11; pile[WZ2]=jvj+14; 
(*f[33])( );     /*FNDE0(1232,jvj+11,jvj+14)*/
for(i=x[jvj+14],V3=0;i>0;i=t[i],V3++)  ;
if((V3<=1)) goto l7;
if((V5>V3)) goto l7;
pile[v[22]]=107; pile[WZ2]=jvj+15; 
(*f[33])( );     /*FNDE0(107,jvj+11,jvj+15)*/
pile[v[22]]=101; pile[WZ2]=110; pile[WZ3]=(-601); pile[WZ4]=jvj+20; 
(*f[270])( );     /*QUADRI7(101,jvj+11,110,(-601),jvj+20)*/
