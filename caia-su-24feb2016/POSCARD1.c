...
{int V4=0,I=0,F=0,V13=0,V11=0,V16=0,V15=0,V24=0,V22=0,N=0,M=0,V30=0,V25=0,V26=0,V28=0,V27=0,V35=0,V34=0;
int A;
int MN,MX;
int WZ1,WZ2;
int jvj;
...
MX=V25;
MN=V34;
l27:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=3; pile[v[22]+1]=MN; pile[v[22]+2]=MX; v[102]=0;return;
...
goto l1;
l5:x[jvj+7]=s[x[jvj+23]] ;z[jvj+7]=(x[jvj+7]<=sepcte) ? x[jvj+7] : z[jvj+23];
...
goto l15;
l8:x[jvj+9]=s[x[jvj+24]] ;z[jvj+9]=(x[jvj+9]<=sepcte) ? x[jvj+9] : z[jvj+24];
...
V15++;
goto l12;
l16:x[jvj+12]=s[x[jvj+25]] ;z[jvj+12]=(x[jvj+12]<=sepcte) ? x[jvj+12] : z[jvj+25];
...
goto l24;
l26:MN=MX=incon;
l25:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=3; v[102]=1;return;
}
