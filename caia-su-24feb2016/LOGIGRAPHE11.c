...
{int V48=0,V14=0,V49=0,V50=0,V51=0,V52=0,V47=0,J=0,V54=0,V53=0,A=0,V36=0,B=0,V26=0,V25=0,V24=0,V38=0,V37=0,C=0,V29=0,V28=0,V27=0,V41=0,V40=0,V39=0,D=0,V32=0,V31=0,V30=0,V45=0,V44=0,V43=0,V42=0,E=0,V35=0,V34=0,V33=0,V22=0,I=0,V4=0,V5=0,NU=0,V6=0,NV=0,V7=0,NW=0,V8=0,NX=0,V9=0,NY=0,V21=0,V20=0,V19=0,V18=0,V17=0,V16=0;
int H,V;
int NNNE;
...
J=0;
goto l8;
l22:pile[v[22]]=I; pile[WZ1]=(-8615); 
(*f[3979])( );if(v[102]) goto l21;     /*LONGUEUR0(I,(-8615),V4)*/
V4=pile[WZ2]; 
if((V4!=5)) goto l21;
pile[v[22]]=1; pile[WZ1]=I; pile[WZ2]=(-8615); 
(*f[203])( );if(v[102]) goto l21;     /*FTAB0(1,I,(-8615),V5)*/
V5=pile[WZ3]; 
NU=V5;
pile[v[22]]=2; 
(*f[203])( );if(v[102]) goto l21;     /*FTAB0(2,I,(-8615),V6)*/
V6=pile[WZ3]; 
NV=V6;
pile[v[22]]=3; 
(*f[203])( );if(v[102]) goto l21;     /*FTAB0(3,I,(-8615),V7)*/
V7=pile[WZ3]; 
NW=V7;
pile[v[22]]=4; 
(*f[203])( );if(v[102]) goto l21;     /*FTAB0(4,I,(-8615),V8)*/
V8=pile[WZ3]; 
NX=V8;
pile[v[22]]=5; 
(*f[203])( );if(v[102]) goto l21;     /*FTAB0(5,I,(-8615),V9)*/
V9=pile[WZ3]; 
NY=V9;
V21=NX+NY;
V20=NW+V21;
