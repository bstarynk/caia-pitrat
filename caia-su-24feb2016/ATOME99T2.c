...
{int V31=0,V54=0,V6=0,V62=0,V14=0,V52=0,V3=0,V65=0;
int RR;
...
(*f[32])( );if(v[102]) goto l22;     /*FNDO0(111,RR,jvj+11)*/
...
if((x[jvj+20]!=486)) goto l10;
pile[v[22]]=107; pile[WZ1]=jvj+18; pile[WZ2]=jvj+21; 
(*f[33])( );     /*FNDE0(107,jvj+18,jvj+21)*/
for(i=x[jvj+21],V31=0;i>0;i=t[i],V31++)  ;
if((V31!=2)) goto l10;
pile[v[22]]=268; pile[WZ1]=jvj+17; pile[WZ2]=jvj+22; 
(*f[32])( );if(v[102]) goto l10;     /*FNDO0(268,jvj+17,jvj+22)*/
pile[v[22]]=RR; pile[WZ1]=jvj+22; pile[WZ3]=jvj+23; 
(*f[45])( );if(v[102]) goto l10;     /*FNDZ0(RR,jvj+22,V54,jvj+23)*/
V54=pile[WZ2]; 
x[jvj+45]=x[jvj+21] ;z[jvj+45]=z[jvj+21];
...
pile[v[22]]=jvj+14; pile[WZ1]=jvj+24; pile[WZ2]=jvj+27; 
(*f[32])( );if(v[102]) goto l16;     /*FNDO0(jvj+14,jvj+24,jvj+27)*/
...
for(i=x[jvj+30],V14=0;i>0;i=t[i],V14++)  ;
if((V14!=2)) goto l16;
pile[v[22]]=jvj+24; pile[WZ1]=jvj+15; pile[WZ3]=jvj+31; 
(*f[45])( );if(v[102]) goto l16;     /*FNDZ0(jvj+24,jvj+15,V52,jvj+31)*/
V52=pile[WZ2]; 
...
V3=s[V65];
if((x[jvj+44]==V3)) goto l21;
pile[v[22]]=101; pile[WZ1]=jvj+24; pile[WZ2]=110; pile[WZ3]=(-601); pile[WZ4]=jvj+39; 
(*f[270])( );     /*QUADRI7(101,jvj+24,110,(-601),jvj+39)*/
