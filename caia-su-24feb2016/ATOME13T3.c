...
(*f[1948])( );if(v[102]) goto l4;     /*FNDOND0(498,A,jvj+5)*/
pile[v[22]]=481; pile[WZ1]=jvj+5; pile[WZ2]=jvj+6; 
(*f[33])( );     /*FNDE0(481,jvj+5,jvj+6)*/
for(a=x[jvj+6];a>0;a=t[a]) if(s[a]==x[A]) goto l1;
l4:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=1; return;
l1:pile[v[22]]=750; pile[WZ1]=jvj+5; 
(*f[1975])( );if(v[102]) goto l4;     /*FNDCND0(750,jvj+5,V3)*/
V3=pile[WZ2]; 
if((V1!=V3)) goto l4;
...
pile[v[22]]=jvj+11; pile[WZ1]=3279; pile[WZ2]=246; pile[WZ3]=jvj+12; 
(*f[189])( );     /*TRI4(jvj+11,3279,246,jvj+12)*/
