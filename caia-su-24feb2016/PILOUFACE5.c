...
x[jvj+2]=0 ;z[jvj+2]=0;
K=1;
l2:pile[v[22]]=K; pile[WZ1]=(-630); 
(*f[201])( );if(v[102]) goto l1;     /*FCOEFF0(K,(-630),V5)*/
V5=pile[WZ2]; 
if((V5==0)) goto l1;
pile[v[22]]=100; pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-1544); pile[WZ4]=jvj+7; 
(*f[270])( );     /*QUADRI7(100,21,140,(-1544),jvj+7)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=K; pile[WZ4]=jvj+9; 
(*f[192])( );     /*QUADRI4(100,41,130,K,jvj+9)*/
...
pile[v[22]]=100; pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=4; pile[WZ4]=jvj+12; 
(*f[192])( );     /*QUADRI4(100,41,130,4,jvj+12)*/
