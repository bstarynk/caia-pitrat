...
V11=pile[WZ2]; 
pile[v[22]]=1331; pile[WZ1]=D; pile[WZ2]=jvj+8; 
(*f[33])( );     /*FNDE0(1331,D,jvj+8)*/
...
(*f[1975])( );if(v[102]) goto l1;     /*FNDCND0(164,D,V10)*/
V10=pile[WZ2]; 
V9=V10-1;
V1=V9;
...
pile[v[22]]=jvj+13; pile[WZ1]=3483; pile[WZ2]=246; pile[WZ3]=jvj+14; 
(*f[189])( );     /*TRI4(jvj+13,3483,246,jvj+14)*/
pile[v[22]]=jvj+14; pile[WZ1]=20119; pile[WZ2]=218; pile[WZ3]=jvj+15; 
(*f[58])( );     /*TRI3(jvj+14,20119,218,jvj+15)*/
...
pile[v[22]]=jvj+10; pile[WZ1]=164; pile[WZ2]=jvj+11; pile[WZ3]=M; 
(*f[2056])( );     /*VAUT0(jvj+10,164,jvj+11,M)*/
l3:x[jvj+8]=t[x[jvj+8]];
goto l2;
l1:pile[v[22]]=164; pile[WZ1]=D; 
(*f[1975])( );if(v[102]) goto l3;     /*FNDCND0(164,D,V7)*/
V7=pile[WZ2]; 
V1=V7;
goto l4;
