...
{int V10=0,V11=0,V8=0,V9=0,V12=0,V13=0,V15=0,V17=0,V35=0,V37=0;
int RR;
...
x[jvj+12]=t[x[jvj+12]];
goto l2;
l4:x[jvj+8]=s[x[jvj+38]] ;z[jvj+8]=(x[jvj+8]<=sepcte) ? x[jvj+8] : z[jvj+38];
if((x[jvj+8]==x[RR])) goto l5;
pile[v[22]]=1417; pile[WZ1]=jvj+8; pile[WZ2]=jvj+9; 
(*f[33])( );     /*FNDE0(1417,jvj+8,jvj+9)*/
for(a=x[jvj+9];a>0;a=t[a]) if(s[a]==528) goto l6;
x[jvj+10]=vo[14];z[jvj+10]=vz[14];
pile[v[22]]=1545; pile[WZ1]=jvj+10; pile[WZ2]=jvj+11; 
(*f[33])( );     /*FNDE0(1545,jvj+10,jvj+11)*/
for(a=x[jvj+11];a>0;a=t[a]) if(s[a]==528) goto l6;
l5:x[jvj+38]=t[x[jvj+38]];
goto l3;
l6:pile[v[22]]=jvj+15; pile[WZ1]=jvj+8; 
(*f[68])( );     /*PLUE0(jvj+15,jvj+8)*/
goto l5;
l9:pile[v[22]]=1294; pile[WZ1]=jvj+3; pile[WZ2]=jvj+26; 
(*f[33])( );     /*FNDE0(1294,jvj+3,jvj+26)*/
for(a=x[jvj+26];a>0;a=t[a]) if(s[a]==1327) goto l11;
...
(*f[32])( );if(v[102]) goto l8;     /*FNDO0(111,jvj+3,jvj+20)*/
pile[v[22]]=101; pile[WZ1]=jvj+20; pile[WZ2]=jvj+21; 
(*f[32])( );if(v[102]) goto l8;     /*FNDO0(101,jvj+20,jvj+21)*/
if((x[jvj+21]!=25)) goto l8;
pile[v[22]]=1358; pile[WZ1]=jvj+3; pile[WZ2]=jvj+22; 
(*f[32])( );if(v[102]) goto l8;     /*FNDO0(1358,jvj+3,jvj+22)*/
if((x[jvj+22]!=68)) goto l8;
pile[v[22]]=1006; pile[WZ2]=jvj+23; 
(*f[33])( );     /*FNDE0(1006,jvj+3,jvj+23)*/
for(a=x[jvj+23];a>0;a=t[a]) if(s[a]==V15) goto l8;
pile[v[22]]=102; pile[WZ2]=jvj+24; 
(*f[32])( );if(v[102]) goto l8;     /*FNDO0(102,jvj+3,jvj+24)*/
pile[v[22]]=103; pile[WZ2]=jvj+25; 
(*f[32])( );if(v[102]) goto l8;     /*FNDO0(103,jvj+3,jvj+25)*/
pile[v[22]]=929; 
(*f[1975])( );if(v[102]) goto l8;     /*FNDCND0(929,jvj+3,V17)*/
V17=pile[WZ2]; 
for(a=x[jvj+19];a>0;a=t[a]) if(s[a]==V17) goto l8;
pile[v[22]]=1370; 
(*f[26])( );if(v[102]) goto l1;     /*FNDC0(1370,jvj+3,V10)*/
V10=pile[WZ2]; 
pile[WZ1]=RR; 
(*f[26])( );if(v[102]) goto l1;     /*FNDC0(1370,RR,V11)*/
V11=pile[WZ2]; 
if((V10>V11)) goto l1;
...
if((V8==V9)) goto l9;
l1:pile[v[22]]=jvj+3; pile[WZ1]=jvj+6; 
...
l10:if((x[jvj+27]<=0)) goto l8;
x[jvj+28]=s[x[jvj+27]] ;z[jvj+28]=(x[jvj+28]<=sepcte) ? x[jvj+28] : z[jvj+27];
pile[v[22]]=RR; pile[WZ1]=jvj+28; pile[WZ3]=jvj+29; 
(*f[45])( );if(v[102]) goto l12;     /*FNDZ0(RR,jvj+28,V35,jvj+29)*/
V35=pile[WZ2]; 
pile[v[22]]=268; pile[WZ2]=jvj+30; 
(*f[32])( );if(v[102]) goto l12;     /*FNDO0(268,jvj+28,jvj+30)*/
pile[v[22]]=RR; pile[WZ1]=jvj+30; pile[WZ3]=jvj+31; 
(*f[45])( );if(v[102]) goto l12;     /*FNDZ0(RR,jvj+30,V37,jvj+31)*/
V37=pile[WZ2]; 
pile[v[22]]=101; pile[WZ1]=jvj+3; pile[WZ2]=110; pile[WZ3]=(-601); pile[WZ4]=jvj+36; 
(*f[270])( );     /*QUADRI7(101,jvj+3,110,(-601),jvj+36)*/
