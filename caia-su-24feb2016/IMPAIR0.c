...
{int V7=0,V6=0,V29=0,V32=0,V55=0,V57=0,I=0,V1=0,V47=0,V46=0,V49=0,V48=0,V36=0,V35=0,V37=0;
int A;
int R;
int WZ1,WZ2;
int jvj;
...
if((x[jvj+18]==52)) goto l21;
if((x[jvj+18]==596)) goto l22;
if((x[jvj+18]!=486)) goto l24;
pile[v[22]]=107; pile[WZ1]=A; pile[WZ2]=jvj+26; 
(*f[33])( );     /*FNDE0(107,A,jvj+26)*/
l3:if((x[jvj+26]<=0)) goto l17;
x[jvj+2]=s[x[jvj+26]] ;z[jvj+2]=(x[jvj+2]<=sepcte) ? x[jvj+2] : z[jvj+26];
pile[v[22]]=jvj+2; pile[WZ1]=jvj+3; 
(*f[997])( );if(v[102]) goto l24;     /*IMPAIR0(jvj+2,jvj+3)*/
...
for(i=x[jvj+13],V57=0;i>0;i=t[i],V57++)  ;
if((V57!=1)) goto l16;
for(a=x[jvj+13];a>0;a=t[a]) if(s[a]==0) goto l17;
...
goto l5;
l21:pile[v[22]]=102; pile[WZ1]=A; pile[WZ2]=jvj+20; 
(*f[32])( );if(v[102]) goto l24;     /*FNDO0(102,A,jvj+20)*/
pile[v[22]]=jvj+20; pile[WZ1]=jvj+21; 
(*f[997])( );if(v[102]) goto l24;     /*IMPAIR0(jvj+20,jvj+21)*/
...
(*f[32])( );if(v[102]) goto l24;     /*FNDO0(102,A,jvj+24)*/
pile[v[22]]=jvj+24; pile[WZ1]=jvj+25; 
(*f[997])( );if(v[102]) goto l24;     /*IMPAIR0(jvj+24,jvj+25)*/
