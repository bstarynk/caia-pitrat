...
{int V1=0,V30=0,TT=0,T=0,V9=0,V16=0,V11=0,NN=0,V20=0,V21=0,MM=0,V22=0,V19=0,V28=0,V27=0,V26=0,V25=0;
int D;
int N;
int WZ1,WZ2;
int jvj;
...
(*f[26])( );if(v[102]) goto l24;     /*FNDC0(117,jvj+11,V30)*/
V30=pile[WZ2]; 
TT=V30;
l24:pile[v[22]]=0; pile[WZ1]=117; pile[WZ2]=jvj+6; 
...
(*f[26])( );if(v[102]) goto l23;     /*FNDC0(117,jvj+6,V1)*/
V1=pile[WZ2]; 
T=V1;
...
(*f[26])( );if(v[102]) goto l23;     /*FNDC0(117,jvj+16,V9)*/
V9=pile[WZ2]; 
V11=incon;
if((v[244]!=0)) goto l10;
if((T>=5)) goto l10;
...
V11=V16;
l11:NN=V11;
if(TT!=incon) goto l12;
l23:v[0]=jvj; v[22]-=2; v[102]=1;return;
...
if((MM<=0)) goto l18;
V22=MM;
l18:if((v[244]<=0)) goto l19;
V22=2;
l19:x[jvj+19]=vo[12];z[jvj+19]=vz[12];
pile[v[22]]=1102; pile[WZ1]=jvj+19; 
(*f[26])( );if(v[102]) goto l20;     /*FNDC0(1102,jvj+19,V19)*/
V19=pile[WZ2]; 
V22=V19;
l22:V28=V21*V22;
V27=V20*V28;
...
V25=V26/D;
N=V25;
v[0]=jvj; v[22]-=2; pile[v[22]+1]=N; v[102]=0;return;
l13:V20=5;
goto l15;
l14:V20=4;
goto l15;
