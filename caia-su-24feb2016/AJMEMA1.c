...
A=pile[v[22]]; B=pile[v[22]+1]; C=pile[v[22]+2]; v[22]+=3; 
...
l2:x[jvj+4]=s[x[jvj+6]] ;z[jvj+4]=(x[jvj+4]<=sepcte) ? x[jvj+4] : z[jvj+6];
pile[v[22]]=459; pile[WZ1]=jvj+4; pile[WZ2]=jvj+7; 
(*f[32])( );if(v[102]) goto l3;     /*FNDO0(459,jvj+4,jvj+7)*/
if((x[jvj+7]!=x[B])) goto l3;
if((x[C]==250)) goto l5;
pile[v[22]]=475; pile[WZ2]=jvj+5; 
(*f[32])( );if(v[102]) goto l3;     /*FNDO0(475,jvj+4,jvj+5)*/
