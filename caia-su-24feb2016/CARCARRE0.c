...
x[jvj+2]=0 ;z[jvj+2]=0;
V5=N-1;
pile[v[22]]=V5; pile[WZ1]=10; 
(*f[1006])( );if(v[102]) goto l1;     /*POWER0(V5,10,V3)*/
V3=pile[WZ2]; 
pile[v[22]]=28; pile[WZ1]=2; pile[WZ2]=V3; 
(*f[1005])( );if(v[102]) goto l1;     /*RACN0(28,2,V3,V2)*/
V2=pile[WZ3]; 
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V2; pile[WZ4]=jvj+6; 
(*f[192])( );     /*QUADRI4(100,41,130,V2,jvj+6)*/
...
l1:x[NNNE]=x[jvj+2] ;z[NNNE]=z[jvj+2];
