...
{int I=0,V5=0,J=0,V6=0;
int NNNE;
int WZ1,WZ2,WZ3,WZ4,WZ5;
int jvj;
jvj=v[0];
v[0]+=28;
x[jvj+1]=26105;z[jvj+1]=(-100);
if(v[0]>99700) (*f[6])( );
if(v[90]==2418&&v[97]==0) {
...
(*f[3979])( );if(v[102]) goto l4;     /*LONGUEUR0(I,(-7362),V5)*/
V5=pile[WZ2]; 
J=1;
l2:if((J>V5)) goto l4;
pile[v[22]]=J; pile[WZ1]=I; pile[WZ2]=(-7362); 
(*f[203])( );if(v[102]) goto l3;     /*FTAB0(J,I,(-7362),V6)*/
V6=pile[WZ3]; 
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=4; pile[WZ4]=jvj+9; 
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=3; pile[WZ4]=jvj+20; 
