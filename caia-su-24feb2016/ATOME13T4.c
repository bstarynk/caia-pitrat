...
(*f[1948])( );if(v[102]) goto l3;     /*FNDOND0(498,A,jvj+5)*/
pile[v[22]]=750; pile[WZ1]=jvj+5; 
(*f[1975])( );if(v[102]) goto l3;     /*FNDCND0(750,jvj+5,V3)*/
V3=pile[WZ2]; 
if((V1!=V3)) goto l3;
pile[v[22]]=489; pile[WZ1]=A; pile[WZ2]=jvj+6; 
(*f[1969])( );     /*FNDEND0(489,A,jvj+6)*/
l1:if((x[jvj+3]<=0)) goto l3;
x[jvj+8]=s[x[jvj+3]] ;z[jvj+8]=(x[jvj+8]<=sepcte) ? x[jvj+8] : z[jvj+3];
for(a=x[jvj+6];a>0;a=t[a]) if(s[a]==x[jvj+8]) goto l2;
...
pile[v[22]]=jvj+10; pile[WZ1]=3429; pile[WZ2]=246; pile[WZ3]=jvj+11; 
(*f[189])( );     /*TRI4(jvj+10,3429,246,jvj+11)*/
pile[v[22]]=158; pile[WZ1]=1; pile[WZ2]=218; pile[WZ3]=20013; pile[WZ4]=jvj+11; pile[WZ5]=jvj+7; 
(*f[269])( );     /*QUADRI6(158,1,218,20013,jvj+11,jvj+7)*/
pile[v[22]]=jvj+7; pile[WZ1]=159; pile[WZ2]=jvj+12; 
(*f[36])( );     /*PLUSC0(jvj+7,159,jvj+12)*/
pile[WZ2]=jvj+13; 
(*f[36])( );     /*PLUSC0(jvj+7,159,jvj+13)*/
pile[WZ1]=489; pile[WZ2]=jvj+8; pile[WZ3]=A; 
(*f[1753])( );     /*LIER1(jvj+7,489,jvj+8,A)*/
