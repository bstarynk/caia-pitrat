...
{int J=0,V13=0,I=0,V16=0,V18=0,K=0;
int N;
int NNNE;
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V16; pile[WZ4]=jvj+21; 
(*f[192])( );     /*QUADRI4(100,41,130,V16,jvj+21)*/
...
pile[WZ1]=20; pile[WZ2]=101; pile[WZ3]=486; pile[WZ4]=jvj+22; 
...
pile[v[22]]=jvj+24; pile[WZ1]=22; pile[WZ2]=100; pile[WZ3]=jvj+18; 
(*f[58])( );     /*TRI3(jvj+24,22,100,jvj+18)*/
pile[v[22]]=100; pile[WZ2]=111; pile[WZ3]=jvj+16; pile[WZ4]=jvj+6; 
...
goto l5;
l4:if((J==I)) goto l3;
pile[v[22]]=100; pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-624); pile[WZ4]=jvj+13; 
(*f[270])( );     /*QUADRI7(100,21,140,(-624),jvj+13)*/
...
pile[v[22]]=100; pile[WZ1]=484; pile[WZ2]=102; pile[WZ3]=jvj+15; pile[WZ4]=jvj+14; pile[WZ5]=jvj+3; 
(*f[269])( );     /*QUADRI6(100,484,102,jvj+15,jvj+14,jvj+3)*/
pile[v[22]]=jvj+2; pile[WZ1]=jvj+3; 
(*f[522])( );     /*PLUB2(jvj+2,jvj+3)*/
l3:J++;
goto l2;
l8:pile[v[22]]=100; pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-624); pile[WZ4]=jvj+25; 
(*f[270])( );     /*QUADRI7(100,21,140,(-624),jvj+25)*/
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=K; pile[WZ4]=jvj+27; 
(*f[192])( );     /*QUADRI4(100,41,130,K,jvj+27)*/
pile[v[22]]=jvj+25; pile[WZ1]=111; pile[WZ2]=jvj+26; 
(*f[54])( );     /*TRI1(jvj+25,111,jvj+26)*/
pile[v[22]]=100; pile[WZ1]=484; pile[WZ2]=102; pile[WZ3]=jvj+27; pile[WZ4]=jvj+26; pile[WZ5]=jvj+8; 
(*f[269])( );     /*QUADRI6(100,484,102,jvj+27,jvj+26,jvj+8)*/
