...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=14; pile[WZ4]=jvj+21; 
(*f[192])( );     /*QUADRI4(100,41,130,14,jvj+21)*/
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V4; pile[WZ4]=jvj+24; 
(*f[192])( );     /*QUADRI4(100,41,130,V4,jvj+24)*/
