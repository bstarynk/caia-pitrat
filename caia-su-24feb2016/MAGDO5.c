...
(*f[201])( );if(v[102]) goto l2;     /*FCOEFF0(I,(-612),V2)*/
V2=pile[WZ2]; 
pile[WZ1]=(-595); 
(*f[201])( );if(v[102]) goto l2;     /*FCOEFF0(I,(-595),V3)*/
V3=pile[WZ2]; 
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=V2; pile[WZ4]=jvj+11; 
(*f[192])( );     /*QUADRI4(100,41,130,V2,jvj+11)*/
