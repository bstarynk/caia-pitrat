...
{int V1=0;
int ZZG,ZZBL,ZZN,NS1,N1,OS1,O1;
int RES;
...
ZZG=pile[v[22]]; ZZBL=pile[v[22]+1]; ZZN=pile[v[22]+2]; NS1=pile[v[22]+3]; N1=pile[v[22]+4]; OS1=pile[v[22]+5]; O1=pile[v[22]+6]; RES=pile[v[22]+7]; v[22]+=8; 
...
pile[v[22]]=130; pile[WZ1]=N1; pile[WZ2]=140; pile[WZ3]=NS1; pile[WZ4]=jvj+10; pile[WZ5]=jvj+3; 
(*f[197])( );     /*QUADRI5(130,N1,140,NS1,jvj+10,jvj+3)*/
