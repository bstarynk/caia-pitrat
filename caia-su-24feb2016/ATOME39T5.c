...
if((V4!=2)) goto l4;
pile[v[22]]=1274; 
(*f[26])( );if(v[102]) goto l1;     /*FNDC0(1274,R,V2)*/
V2=pile[WZ2]; 
if((V2!=0)) goto l4;
l1:pile[v[22]]=868; pile[WZ1]=R; pile[WZ2]=jvj+3; 
(*f[32])( );if(v[102]) goto l4;     /*FNDO0(868,R,jvj+3)*/
if((x[jvj+3]==55)) goto l4;
...
(*f[1948])( );if(v[102]) goto l3;     /*FNDOND0(498,jvj+5,jvj+7)*/
pile[v[22]]=473; pile[WZ1]=jvj+7; 
(*f[1975])( );if(v[102]) goto l3;     /*FNDCND0(473,jvj+7,V6)*/
V6=pile[WZ2]; 
if((V6!=1)) goto l3;
pile[v[22]]=509; pile[WZ1]=jvj+5; pile[WZ2]=jvj+8; 
(*f[1969])( );     /*FNDEND0(509,jvj+5,jvj+8)*/
for(a=x[jvj+8];a>0;a=t[a]) if(s[a]==x[R]) goto l5;
l3:x[jvj+4]=t[x[jvj+4]];
goto l2;
l4:x[jvj+1]=incon; x[jvj+2]=incon; v[0]=jvj; v[22]-=1; return;
l5:pile[v[22]]=101; pile[WZ1]=R; pile[WZ2]=110; pile[WZ3]=(-601); pile[WZ4]=jvj+13; 
(*f[270])( );     /*QUADRI7(101,R,110,(-601),jvj+13)*/
pile[WZ1]=jvj+5; pile[WZ3]=(-2829); pile[WZ4]=jvj+14; 
(*f[270])( );     /*QUADRI7(101,jvj+5,110,(-2829),jvj+14)*/
...
pile[v[22]]=jvj+11; pile[WZ1]=3076; pile[WZ2]=246; pile[WZ3]=jvj+12; 
(*f[189])( );     /*TRI4(jvj+11,3076,246,jvj+12)*/
pile[v[22]]=158; pile[WZ1]=289; pile[WZ2]=218; pile[WZ3]=20039; pile[WZ4]=jvj+12; pile[WZ5]=jvj+9; 
(*f[269])( );     /*QUADRI6(158,289,218,20039,jvj+12,jvj+9)*/
