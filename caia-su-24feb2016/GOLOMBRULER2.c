...
{int J=0,V6=0,V7=0,V5=0,V4=0,L=0,V3=0;
int M;
int NNNE;
...
pile[WZ1]=41; pile[WZ2]=130; pile[WZ3]=L; pile[WZ4]=jvj+17; 
(*f[192])( );     /*QUADRI4(100,41,130,L,jvj+17)*/
...
pile[v[22]]=100; pile[WZ1]=21; pile[WZ2]=140; pile[WZ3]=(-1544); pile[WZ4]=jvj+18; 
