...
(*f[32])( );if(v[102]) goto l5;     /*FNDO0(869,R,jvj+5)*/
if((x[jvj+5]!=769)) goto l5;
pile[v[22]]=1274; 
(*f[26])( );if(v[102]) goto l4;     /*FNDC0(1274,R,V4)*/
V4=pile[WZ2]; 
if((V4!=0)) goto l5;
l4:pile[v[22]]=870; pile[WZ1]=R; 
(*f[26])( );if(v[102]) goto l5;     /*FNDC0(870,R,H)*/
H=pile[WZ2]; 
x[jvj+7]=incon;
if((H<3)) goto l5;
if((H<=4)) goto l1;
...
l6:pile[v[22]]=101; pile[WZ1]=R; pile[WZ2]=110; pile[WZ3]=(-601); pile[WZ4]=jvj+12; 
...
pile[v[22]]=jvj+9; pile[WZ1]=3162; pile[WZ2]=246; pile[WZ3]=jvj+10; 
(*f[189])( );     /*TRI4(jvj+9,3162,246,jvj+10)*/
