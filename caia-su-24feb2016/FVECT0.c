...
(*f[26])( );if(v[102]) goto l4;     /*FNDC0(130,jvj+6,V7)*/
V7=pile[WZ2]; 
if((V7!=B)) goto l4;
...
x[jvj+8]=x[jvj+10] ;z[jvj+8]=z[jvj+10];
pile[v[22]]=130; pile[WZ1]=jvj+8; 
(*f[26])( );if(v[102]) goto l5;     /*FNDC0(130,jvj+8,R)*/
R=pile[WZ2]; 
l7:v[0]=jvj; v[22]-=3; pile[v[22]+2]=R; v[102]=0;return;
l2:x[jvj+2]=t[x[jvj+2]];
goto l1;
l4:x[jvj+9]=t[x[jvj+9]];
goto l3;
l5:pile[v[22]]=162; pile[WZ1]=jvj+8; 
(*f[219])( );if(v[102]) goto l6;     /*FNDC2(162,jvj+8,V10)*/
V10=pile[WZ2]; 
V9=V10;
R=V9;
goto l7;
