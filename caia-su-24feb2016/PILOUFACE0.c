...
{int V13=0,V12=0,V14=0,V6=0,V17=0,V16=0,V18=0,V9=0,J=0;
int NNNE;
...
l4:pile[v[22]]=V12; pile[WZ1]=(-630); 
(*f[201])( );if(v[102]) goto l3;     /*FCOEFF0(V12,(-630),V6)*/
V6=pile[WZ2]; 
if((V6<=1)) goto l3;
...
l3:V12++;
goto l2;
l7:pile[v[22]]=V16; pile[WZ1]=(-630); 
(*f[201])( );if(v[102]) goto l6;     /*FCOEFF0(V16,(-630),V9)*/
V9=pile[WZ2]; 
if((V9!=1)) goto l6;
